...
if !(Equal CurrSubaction JumpSquat)
  ...
  var2 = var5 //+ (XSpeed * (var13 + 3)) + TopNX
  // var17 -= TopNX
  // var2 -= TopNX
  Abs var17
  Abs var2
  ...
  if Equal AirGroundState 1 && CurrAction <= 9 && Equal IsOnStage 1
    ...
    elif Rnd <= 0.02 && var20 >= 24625 && var20 <= 24631 && XDistLE 80 100 && OFramesHitstun < 1
...
label JumpIfInRange
  ...
  if MeteoChance && Equal IsOnStage 0 && YSpeed < 0.01 && var17 > 35 && var17 < 50
    Button X
  endif
  ...
  if var17 > 35 && var17 < 50 && Equal AirGroundState 2 && CanJump && Equal IsOnStage 1 && YSpeed < 0.1
    Button X
  endif
Return
