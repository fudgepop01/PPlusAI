...
// these work together to only dashdance if not in a tech-chase or combo situation
  ...
  elif Equal var21 33026 || Equal var21 33028
  ...
  if Equal CurrAction 10 || Equal CurrAction 22
    Return
  elif InAir && YDistBackEdge > -5 && YDistBackEdge < 0
    if XDistBackEdge < -10
      Button R
      if ODistLE 30
        Stick -1 (-1)
  ...
  label _ddSubr
  SetFrame 0
  if Equal Direction OPos && Rnd < 0.5
    Button X
  endif
  var0 = var0 - 1
  if (var0 > 0)
...
if Equal var16 3 && var20 < 24640
  ...
  var17 = var5
  if var0 <= 15 && CurrAction < 3 && CurrAction > 4
    ClearStick
    if var5 < 0
      AbsStick 0.6
    else
  ...
  if Equal CurrAction 1 && LevelValue > 21 && 15 < var0
    ClearStick
  endif
else
  // otherwise...
...
label JumpIfInRange
  ...
  if var17 > 25 && var17 < 70 && Equal CurrSubaction JumpSquat
    Button X
  endif
  if var17 > 15 && var17 < 65 && Equal AirGroundState 2 && CanJump && Equal IsOnStage 1
    Button X
...
if var1 <= var17
  ...
  if var20 >= 24641 && var20 <= 24655
    if Equal AirGroundState 1 && CurrAction <= 9
      ...
      Return
    elif CanJump && Equal var2 2 && var4 < -80
      var19 = 0
      Call AIHub
    elif !CanJump && Equal var2 2 && var4 < -60
      var19 = 0
      Call AIHub
  elif !(CanJump) && NumJumps > 0 && var4 < -40
      var19 = 0
      Call AIHub
    else
      var2 = 1
