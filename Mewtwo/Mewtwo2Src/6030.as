...
if Equal movePart 0
  if CalledAs Jab123
    ...
    move_hitFrame = fsmash_hitFrame + fsmash_startup
    move_lastHitFrame = fsmash_lastHitFrame + fsmash_startup
    move_IASA = fsmash_IASA + fsmash_startup
    ...
    move_hitFrame = usmash_hitFrame + usmash_startup
    move_lastHitFrame = usmash_lastHitFrame + usmash_startup
    move_IASA = usmash_IASA + usmash_startup
    ...
    move_hitFrame = dsmash_hitFrame + dsmash_startup
    move_lastHitFrame = dsmash_lastHitFrame + dsmash_startup
    move_IASA = dsmash_IASA + dsmash_startup
