...
// jab123; 0
label jab123
  SetVarAttackData -2.34 -0.4 8.44 3.57 3 1 21 3 0 8 50
  var22 = 361
  Return
// jab123_2; 1
label jab123_2
  SetVarAttackData 7.79 -1.02 3.85 3.37 8 1 26 2 0 8 50
  var22 = 70
  Return
// jab123_3; 2
label jab123_3
  SetVarAttackData 5.49 -0.86 6.27 4.79 16 3 41 4 0 40 100
  var22 = 361
  Return
// dashattack; 3
label dashattack
  SetVarAttackData 9.89 2.03 21.47 6.35 8 17 39 4 0 80 90
  var22 = 100
  Return
// ftilt; 4
label ftilt
  SetVarAttackData 0.97 -0.77 7.76 4.23 7 4 27 11 0 10 100
  var22 = 34
  Return
// utilt; 5
label utilt
  SetVarAttackData -4.24 -5.43 6.03 7.24 5 4 24 7 0 55 110
  var22 = 96
  Return
// dtilt; 6
label dtilt
  SetVarAttackData -0.92 2.48 6.89 3.71 3 1 13 3 0 10 135
  var22 = 83
  Return
// fsmash; 7
label fsmash
  SetVarAttackData 3.06 -0.22 7.85 3.13 17 1 50 20 0 50 70
  var22 = 361
  Return
// fsmash_strong; 8
label fsmash_strong
  SetVarAttackData 18.17 0.12 3.32 3.33 17 1 50 24 0 50 75
  var22 = 361
  Return
// usmash; 9
label usmash
  SetVarAttackData -9 0.5 9.75 5.75 13 18 48 12 0 40 100
  var22 = 85
  Return
// dsmash; 10
label dsmash
  SetVarAttackData -7 2 10.5 3.25 12 26 50 12 0 70 67
  var22 = 361
  Return
// nspecial; 11
label nspecial
  SetVarAttackData -20 4 20 15 76 10 87 -12 0 100 64
  var22 = 70
  Return
// nspecialair; 12
label nspecialair
...
// uspecial; 13
label uspecial
  SetVarAttackData -50 30 50 50 20 60 100 -14 0 60 60
  var22 = 80
  Return
// uspecialair; 14
label uspecialair
...
// uspecial_pkt2; 15
label uspecial_pkt2
  SetVarAttackData -20 20 20 20 80 40 170 -25 0 60 80
  var22 = 361
  Return
// uspecialair_pkt2; 16
...
// dspecial; 17
label dspecial
  SetVarAttackData -8.5 2 8.5 8.5 1 9 22 6 0 27 90
  var22 = 55
  Return
// dspecialair; 18
label dspecialair
...
// sspecial; 19
label sspecial
  SetVarAttackData 0 0 40 8 25 19 49 -8 0 15 0
  var22 = 97
  Return
// sspecialair; 20
label sspecialair
  SetVarAttackData 0 25 15 15 20 24 54 -8 0 15 0
  var22 = 97
  Return
// grab; 21
label grab
  SetVarAttackData -0.3 -1.2 5.55 4 7 0 32 0 0 0 0
  var22 = 0
  Return
// fthrow; 22
label fthrow
  SetVarAttackData -0.3 -1.2 5.55 4 7 16.5 54 11 0 120 10
  var22 = 45
  Return
// dthrow; 23
label dthrow
  SetVarAttackData -0.3 -1.2 5.55 4 7 18 54 4 0 80 68
  var22 = 100
  Return
// bthrow; 24
label bthrow
  SetVarAttackData -0.3 -1.2 5.55 4 7 16.5 54 11 0 15 135
  var22 = 135
  Return
// uthrow; 25
label uthrow
  SetVarAttackData -0.3 -1.2 5.55 4 7 21 57 10 0 105 40
  var22 = 90
  Return
// nair; 26
label nair
  SetVarAttackData -5.17 2.54 7.09 7.53 4 19 35 11 0 25 100
  var22 = 361
  Return
// fair; 27
label fair
  SetVarAttackData 2.74 1.98 6.64 6.64 8 13 39 3 0 24 108
  var22 = 361
  Return
// bair; 28
label bair
  SetVarAttackData -11.82 3.03 7.15 5.21 10 8 35 16 0 16 109
  var22 = -361
  Return
// uair; 29
label uair
  SetVarAttackData -8.96 -0.19 9.72 7.47 8 3 41 13 0 13 118
  var22 = 85
  Return
// dair; 30
label dair
  SetVarAttackData -4.89 5.65 5.34 5.38 5 8 37 14 0 40 90
  var22 = 270
  Return
endif
Return
...
if Equal var20 28
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 3 || Equal var20 4 || Equal var20 6 || Equal var20 7 || Equal var20 8 || Equal var20 19 || Equal var20 20 || Equal var20 21 || Equal var20 22 || Equal var20 23 || Equal var20 24 || Equal var20 25 || Equal var20 27
  var22 = 1
else
  var22 = 0
endif
  ...
  // chr get_moveDirY
if Equal var20 20 || Equal var20 30
  var22 = -1
elif !(True)
  var22 = 1
else
