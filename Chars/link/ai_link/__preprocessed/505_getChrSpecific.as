...
// jab123; 0
label jab123
  SetVarAttackData 2.16 -3.32 10.99 6.46 6 2 19 5 0 16 37
  var22 = 361
  Return
// jab1232; 1
label jab1232
  SetVarAttackData 4.57 -1.74 9.95 5.89 5 2 16 3 0 40 20
  var22 = 78
  Return
// jab1233; 2
label jab1233
  SetVarAttackData 2.36 -5.25 11.81 4.41 6 4 31 6 0 40 50
  var22 = 30
  Return
// dashattack; 3
label dashattack
  SetVarAttackData 5.75 1.56 15.64 8.32 7 5 39 14 0 25 100
  var22 = 65
  Return
// ftilt; 4
label ftilt
  SetVarAttackData -11.19 3.09 17.25 13.72 14 3 36 14 0 15 90
  var22 = 35
  Return
// utilt; 5
label utilt
  SetVarAttackData -20.78 0.42 18.15 15.39 9 6 30 9 0 30 124
  var22 = 85
  Return
// dtilt; 6
label dtilt
  SetVarAttackData 3.07 2.04 10.44 5.64 10 3 29 11 0 90 50
  var22 = 280
  Return
// fsmash; 7
label fsmash
  SetVarAttackData 6.19 -2.93 13.49 10.71 15 3 49 16 0 25 93
  var22 = 361
  Return
// fsmash2; 8
label fsmash2
  SetVarAttackData 7.92 -5.49 12.58 4.99 29 4 68 20 0 30 100
  var22 = 65
  Return
// usmash; 9
label usmash
  SetVarAttackData -18.44 -1.26 17.54 16.36 11 30 61 10 0 70 90
  var22 = 90
  Return
// dsmash; 10
label dsmash
  SetVarAttackData 3.07 2.28 11.72 4.69 4 2 38 17 0 26 95
  var22 = 75
  Return
// dsmash_back; 11
label dsmash_back
  SetVarAttackData -25.37 1.83 11.15 4.99 16 2 38 17 0 20 90
  var22 = 75
  Return
// nspecial; 12
label nspecial
  SetVarAttackData 0 -40 200 120 18 22 48 -5 0 8 50
  var22 = 30
  Return
// nspecialair; 13
label nspecialair
...
// uspecial; 14
label uspecial
  SetVarAttackData -19.42 -2.02 21.41 7.04 8 6 81 15 0 32 95
  var22 = 361
  Return
// uspecial_late; 15
label uspecial_late
  SetVarAttackData -20.78 -2.02 22.09 7.04 8 39 81 5 0 60 100
  var22 = 360
  Return
// uspecialair; 16
label uspecialair
  SetVarAttackData -17.92 -6.84 19.02 24.51 8 43 140 6 0 40 123
  var22 = 45
  Return
// dspecial; 17
label dspecial
  SetVarAttackData 20 50 150 150 49 11 75 -11 0 0 0
  var22 = 0
  Return
// dspecialair; 18
label dspecialair
...
// sspecial; 19
label sspecial
  SetVarAttackData -2 10 60 30 25 26 58 -11 0 55 42
  var22 = 70
  Return
// sspecialair; 20
label sspecialair
...
// grab; 21
label grab
  SetVarAttackData -3.14 -4.05 6.45 4.21 11 7 64 0 0 0 0
  var22 = 0
  Return
// fthrow; 22
label fthrow
  SetVarAttackData -3.14 -4.05 6.45 4.21 11 12 35 4 0 35 110
  var22 = 55
  Return
// dthrow; 23
label dthrow
  SetVarAttackData -3.14 -4.05 6.45 4.21 11 27 53 4 0 85 40
  var22 = 85
  Return
// bthrow; 24
label bthrow
  SetVarAttackData -3.14 -4.05 6.45 4.21 11 12 35 4 0 40 110
  var22 = 50
  Return
// uthrow; 25
label uthrow
  SetVarAttackData -3.14 -4.05 6.45 4.21 11 28 50 8 0 30 125
  var22 = 90
  Return
// nair; 26
label nair
  SetVarAttackData -6.27 -2.19 10.19 6.48 4 2 35 12 0 15 100
  var22 = 361
  Return
// nair_late; 27
label nair_late
  SetVarAttackData -6.09 -2.19 10.11 6.46 7 24 35 7 0 10 100
  var22 = 361
  Return
// fair; 28
label fair
  SetVarAttackData 0.12 -3.78 10.86 5.83 14 2 51 14 0 20 105
  var22 = 361
  Return
// fair_hit2; 29
label fair_hit2
  SetVarAttackData -1.13 -9.01 9.46 5.28 28 3 51 10 0 46 60
  var22 = 80
  Return
// bair; 30
label bair
  SetVarAttackData -14.89 -3.76 9.02 5.36 6 3 26 7 1 25 100
  var22 = -361
  Return
// bair_strong; 31
label bair_strong
  SetVarAttackData -14.71 -3.93 9.04 5.31 16 5 26 7 0 15 100
  var22 = 140
  Return
// uair; 32
label uair
  SetVarAttackData -4.19 -14.2 4.41 8.88 5 2 56 16 0 25 85
  var22 = 80
  Return
// uair_weak; 33
label uair_weak
  SetVarAttackData -4.17 -14.51 4.59 8.78 8 41 56 12 0 25 85
  var22 = 80
  Return
// dair; 34
label dair
  SetVarAttackData -4.09 -0.19 4.69 5.77 13 2 79 22 0 50 80
  var22 = 65
  Return
// dair_late; 35
label dair_late
  SetVarAttackData -4.09 -0.19 4.69 5.77 16 48 79 19 0 40 80
  var22 = 65
  Return
endif
Return
...
//   {RECOVERY_ADDITIONS}
  ...
  var22 = 0
if  Equal var20 13 || Equal var20 16 || Equal var20 18 || Equal var20 20 || var20 >= 26 && var20 <= 35
    var22 = 1
  endif
  ...
  // chr get_moveDir
if Equal var20 5 || Equal var20 9 || Equal var20 11 || Equal var20 30 || Equal var20 31
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 3 || Equal var20 4 || Equal var20 6 || Equal var20 7 || Equal var20 8 || Equal var20 10 || Equal var20 12 || Equal var20 13 || Equal var20 17 || Equal var20 18 || Equal var20 19 || Equal var20 20 || Equal var20 27 || Equal var20 28 || Equal var20 29
  var22 = 1
else
  var22 = 0
endif
...
if !(True)
  var22 = -1
elif Equal var20 12 || Equal var20 13
  var22 = 1
else
  var22 = 0
endif
