...
if Equal var11 0
  ...
  if !(XDistLE 15)
    DynamicDiceClear 0
DynamicDiceAdd 1 13 1
DynamicDiceAdd 1 12 1
DynamicDiceAdd 1 20 2
DynamicDiceAdd 1 19 2
DynamicDiceAdd 1 18 2
    if !(XDistLE 40)
DynamicDiceAdd 1 17 2
    endif
  endif
elif Equal var11 9
...
LOGSTR 1718840576 1634953216 838860800 0 0 // fsmash2
elif Equal var20 9
LOGSTR 1431530752 1634953216 0 0 0 // USmash
elif Equal var20 10
LOGSTR 1146318080 1634953216 0 0 0 // DSmash
elif Equal var20 11
LOGSTR 1685286144 1634953216 1600282880 1667956736 0 // dsmash_back
elif Equal var20 12
...
LOGSTR 1970499584 1701013760 1634492160 1818326016 1694498816 // uspecial_late
elif Equal var20 16
...
LOGSTR 1717659904 1918855168 1769222656 0 0 // fair_hit2
elif Equal var20 30
LOGSTR 1111582976 1912602624 0 0 0 // BAir
elif Equal var20 31
LOGSTR 1650551040 1918857984 1953656576 1852243968 0 // bair_strong
elif Equal var20 32
LOGSTR 1430350080 1912602624 0 0 0 // UAir
elif Equal var20 33
LOGSTR 1969318144 1918859008 1700883200 0 0 // uair_weak
elif Equal var20 34
