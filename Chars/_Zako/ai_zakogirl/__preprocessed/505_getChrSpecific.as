...
// jab123; 0
label jab123
  SetVarAttackData -2 -5 9 5.5 10 3 40 4 0 10 100
  var22 = 361
  Return
// dashattack; 1
label dashattack
  SetVarAttackData 8 -4 11.5 5 5 8 38 12 0 50 70
  var22 = 70
  Return
// ftilt; 2
label ftilt
  SetVarAttackData 4 -8 10.5 5 10 3 50 12 0 50 88
  var22 = 70
  Return
// utilt; 3
label utilt
  SetVarAttackData -13 -13 12 9 11 11 55 9 0 65 105
  var22 = 70
  Return
// dtilt; 4
label dtilt
  SetVarAttackData 0 3 10.5 5.5 4 4 55 8 0 20 80
  var22 = 361
  Return
// fsmash; 5
label fsmash
  SetVarAttackData 0 -4 9 5 5 4 51 15 0 30 100
  var22 = 361
  Return
// usmash; 6
label usmash
  SetVarAttackData -12 -12 12 9.5 6 20 58 12 0 20 100
  var22 = 80
  Return
// dsmash; 7
label dsmash
  SetVarAttackData -19 -3 19.5 5.5 2 12 41 12 0 20 100
  var22 = 361
  Return
// nair; 8
label nair
  SetVarAttackData -15 -8 15.5 8 5 15 50 8 0 20 100
  var22 = 361
  Return
// fair; 9
label fair
  SetVarAttackData -4 -3 12 6.5 7 5 50 13 0 30 100
  var22 = 361
  Return
// bair; 10
label bair
  SetVarAttackData -22 -5 12.5 5.5 4 5 50 13 0 30 100
  var22 = 361
  Return
// uair; 11
label uair
  SetVarAttackData -3 -6 4 8 13 2 55 13 0 30 110
  var22 = 90
  Return
// dair; 12
label dair
  SetVarAttackData -6 5 7 9.5 13 5 45 8 0 15 100
  var22 = 275
  Return
endif
Return
...
if Equal var20 10
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 4 || Equal var20 5 || Equal var20 9
  var22 = 1
else
  var22 = 0
endif
...
if !(True)
  var22 = -1
elif Equal var20 3 || Equal var20 6
  var22 = 1
else
  var22 = 0
endif
