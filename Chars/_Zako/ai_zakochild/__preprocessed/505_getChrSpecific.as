...
// jab123; 0
label jab123
  SetVarAttackData 5 -4 9 4.5 1 2 16 3 1 11 100
  var22 = 361
  Return
// jab123_2; 1
label jab123_2
  SetVarAttackData 4 -4 9 4 1 2 18 2 1 10 100
  var22 = 361
  Return
// jab123_3; 2
label jab123_3
  SetVarAttackData 3 -7 10 6.5 5 5 40 4 0 30 90
  var22 = 361
  Return
// dashattack; 3
label dashattack
  SetVarAttackData 7 2 18 4 5 20 54 9 0 70 50
  var22 = 110
  Return
// ftilt; 4
label ftilt
  SetVarAttackData 8 -5 9 5 4 3 33 10 0 6 100
  var22 = 361
  Return
// utilt; 5
label utilt
  SetVarAttackData -2 -3 9 14 4 7 31 7 0 28 130
  var22 = 96
  Return
// dtilt; 6
label dtilt
  SetVarAttackData 4 0 8.5 4.5 4 3 35 7 0 20 80
  var22 = 80
  Return
// fsmash; 7
label fsmash
  SetVarAttackData 12 -5 9.5 5 9 5 58 15 0 25 100
  var22 = 361
  Return
// usmash; 8
label usmash
  SetVarAttackData -19 -5 18 12.5 2 6 41 14 0 32 97
  var22 = 83
  Return
// dsmash; 9
label dsmash
  SetVarAttackData -16 2 16 5 2 10 39 15 0 30 90
  var22 = 361
  Return
// nair; 10
label nair
  SetVarAttackData -7 0 9 6.5 2 28 46 12 0 20 100
  var22 = 361
  Return
// fair; 11
label fair
  SetVarAttackData -2 0 10.5 12.5 16 7 76 13 0 20 100
  var22 = 60
  Return
// bair; 12
label bair
  SetVarAttackData 3 0 -9 6 5 7 46 11 0 10 100
  var22 = 361
  Return
// uair; 13
label uair
  SetVarAttackData -13 -8 12.5 11.5 3 6 34 11 0 0 100
  var22 = 55
  Return
// dair; 14
label dair
  SetVarAttackData -11 6 11 11.5 4 21 45 7 0 80 80
  var22 = 75
  Return
endif
Return
...
if Equal var20 12
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 3 || Equal var20 4 || Equal var20 5 || Equal var20 6 || Equal var20 7 || Equal var20 11
  var22 = 1
else
  var22 = 0
endif
