...
if  var20 >= 12 && var20 <= 13 || Equal var20 15 || Equal var20 17 || var20 >= 23 && var20 <= 29
  ...
  if OTopNY >= TopNY
    if YDistFloor < 2 && YDistFloor > 0
      ...
      var23 = TopNY + 24.16 //- var1
      var17 -= 12.08
      if var23 > var17 && NumJumps > 0 && OTopNY > TopNY
        var14 = var23 + 4
        // goalY += move_centerY
      elif var21 >= 16.7 && YDistBackEdge > 16.16
        var14 = var23 + 4
        // goalY += move_centerY
        var13 = TopNX
      endif
...
if Equal var20 12 || Equal var20 13 || Equal var20 15 || Equal var20 17
  elif True
if  var20 >= 12 && var20 <= 13 || Equal var20 15 || Equal var20 17 || var20 >= 23 && var20 <= 29
...
if  var20 >= 0 && var20 <= 2 || var20 >= 4 && var20 <= 7 || var20 >= 9 && var20 <= 11 || Equal var20 14
    var23 = TopNX + 27 * OPos
    var22 = var17 - var23
    Abs var22
