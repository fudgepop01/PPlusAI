...
// LOGSTR 1870161920 1769235456 1769174016 0 0
// LOGVAL var22
// PRINTLN
...
//       //= XReciever
//     elif OAnimFrame > 45 && OCurrAction <= 1 && var23 < 0.3
//       var21 = 16
//       XGoto CalcAttackGoal
//       //= XReciever
//     endif
...
var17 = var22
  ...
  // if Equal var21 10.1 && XDistLE var22
  //   var21 = 16.3
  //   Return
  // endif
...
var17 = var22
  ...
  if var22 <= 1 && OAnimFrame > var17
    ...
    // Abs var22
    // if CHANCE_MUL_LE PT_CIRCLECAMPCHANCE 0.005 && var22 < 35
    //   var21 = 7
    //   Return
    // endif
    ...
    // if CHANCE_MUL_LE PT_AGGRESSION 0.4 && YDistFloor > -1 && YDistFloor < 15 && !(XDistLE var22) && XDistLE var23
  ...
  XGoto GetChrSpecific
  //= XReciever
  if var22 > 0 && {var21 < 16.4 || {Equal OIsOnStage 1 && var21 >= 16.7}}
    var21 = 16.4
  endif
...
if Equal var20 10 || Equal var20 11 || Equal var20 12 || Equal var20 13 || Equal var20 14
  ...
  if var21 >= 16.7
    ...
    // predictAverage var22 man_OAvgEndlag
    // LOGSTR 1635149568 543518208 1684799488 0 0
    // LOGVAL var22
    // PRINTLN
    ...
    if LevelValue >= 60 && OCurrAction <= 32 && var22 <= 1 && var21 < 16.5
      ...
      if XDistLE var23 var22
        ...
        var23 = var22 * 1.5
        if var22 >= 0.13
          // LOGSTR 1634166528 1919885312 2002872576 1946157056 0
          // LOGVAL var22
          // predictAverage var22 man_OAvgEndlag
