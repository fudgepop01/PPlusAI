...
// PredictOMov var23 7
// var23 *= 0.2
if {CurrAction >= 26 && CurrAction <= 29} || {Equal CurrSubaction JumpSquat || CalledFrom Shield} || {{YDistFloor > 5 && YSpeed > -0.25 && CurrAction <= 32} || OYDistFloor > 45} || var22 > 5 || {YDistFloor > 8 && XDistLE 15} || {OCurrAction >= 66 && OCurrAction <= 100 && var22 > 20} || {CurrAction >= 115 && CurrAction <= 123}
else
  var12 = 0
endif
...
if Equal var20 10 || Equal var20 11 || Equal var20 12 || Equal var20 13 || Equal var20 14
  ...
  if var23 < var7 && var21 < 16.7 && !(Equal var21 12)
    ...
    if {{Equal var16 2 || Equal var21 10.1} && {XDistLE var23}} || {var10 < 0 && XDistLE var23}
      Return
    endif
