...
if  var20 >= 15 && var20 <= 20
  ...
  if XDistLE 60 || OFramesHitstun > 0
    ...
    // LOGSTR_NL 1886352128 1952999680 1953723392 1970143232 0
    // LOGVAL_NL var17
    if var17 > 200
      var22 = 0
...
var17 = var22
  ...
  //= XReciever
        if Equal var22 0 && !(Equal var21 12)
          ...
          if {var17 > 10 && var23 >= 10} || {Equal OCurrAction 77 && OAnimFrame > 25} || Equal var21 16.5 || Equal var21 10.2
            ...
            // LOGSTR_NL 1684366848 1701733376 1768843008 0 0
            if OCurrAction >= 3 && OCurrAction <= 15 && OAnimFrame > 5
              GetCommitPredictChance var17
              if var17 >= 0.15
                // LOGSTR_NL 2002873344 1814065152 1919512320 0 0
              ...
              if OCurrAction < 66 || OCurrAction >= 72 || OAnimFrame > 15
                ...
                predictAverage var22 10
                // LOGSTR 1751741440 1147761408 1946157056 0 0
                // LOGVAL var22
                var22 += 35
                var17 = OPos * var22
                ...
                if var23 > 0 && var23 < var22 && var17 > 0
                  ...
                  if var17 > var22 && Rnd < 0.7
                    // LOGSTR_NL 1684366848 1315926528 1828716544 0 0
                    CallI DefendHub
                  endif
                  if Equal AirGroundState 1
                    // LOGSTR_NL 1684366848 1198681600 1677721600 0 0
                    PredictOMov var22 14
  ...
  //= XReciever
var17 = var22
            // LOGSTR 1329950208 1682702336 0 0 0
            // LOGVAL var17
            // PRINTLN
