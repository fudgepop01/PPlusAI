...
// jab123; 0
label jab123
  SetVarAttackData 0 -3.5 8.5 3.5 2 3 14 3 0 10 80
  var22 = 80
  Return
// jab123_2; 1
label jab123_2
  SetVarAttackData 1.56 -5.69 8.03 4.72 6 4 14 4 1 35 100
  var22 = 72
  Return
// jab123_3; 2
label jab123_3
  SetVarAttackData 0.79 -0.63 9.77 11.03 7 3 14 5 0 35 110
  var22 = 35
  Return
// dashattack; 3
label dashattack
  SetVarAttackData 19.99 -5.67 10.1 5.53 16 3 51 12 0 43 87
  var22 = 40
  Return
// dashattack_late; 4
label dashattack_late
  SetVarAttackData 23.88 -3.54 8.64 6.2 20 3 51 7 0 30 65
  var22 = 24
  Return
// ftilt; 5
label ftilt
  SetVarAttackData 6.39 -4.43 8.76 4.39 8 3 31 10 0 10 90
  var22 = 361
  Return
// utilt; 6
label utilt
  SetVarAttackData -0.39 0.03 7.85 12.43 8 4 24 9 0 34 111
  var22 = 85
  Return
// dtilt; 7
label dtilt
  SetVarAttackData 3.27 1.92 6.85 4.74 6 3 24 10 0 60 60
  var22 = 80
  Return
// fsmash; 8
label fsmash
  SetVarAttackData 15.9 -2.82 10.42 3.92 24 5 52 19 0 40 80
  var22 = 40
  Return
// usmash; 9
label usmash
  SetVarAttackData -6.89 -2.53 10.7 15.56 15 8 49 17 0 40 100
  var22 = 85
  Return
// dsmash; 10
label dsmash
  SetVarAttackData -5.23 -2.16 5.21 12.92 6 20 31 12 0 40 80
  var22 = 90
  Return
// nspecial; 11
label nspecial
  SetVarAttackData -9.83 9.08 12.56 22.88 27 10 69 20 0 80 81
  var22 = 85
  Return
// nspecialair; 12
label nspecialair
  SetVarAttackData -7 30 12 15 21 2 55 5 0 80 100
  var22 = 290
  Return
// nspecialair_dig; 13
...
// sspecial; 14
label sspecial
  SetVarAttackData 1.3 37.18 11.41 18.76 45 7 53 16 0 60 30
  var22 = 295
  Return
// sspecialair; 15
label sspecialair
  SetVarAttackData 1.3 37.18 11.41 18.76 21 7 29 16 0 60 30
  var22 = 295
  Return
// grab; 16
label grab
  SetVarAttackData 1.4 -3.4 6.17 3.86 7 0 32 0 0 0 0
  var22 = 0
  Return
// fthrow; 17
label fthrow
  SetVarAttackData 1.4 -3.4 6.17 3.86 7 14.5 38 4 0 65 65
  var22 = 45
  Return
// dthrow; 18
label dthrow
  SetVarAttackData 1.4 -3.4 6.17 3.86 7 30 62 6 0 80 38
  var22 = 66
  Return
// bthrow; 19
label bthrow
  SetVarAttackData 1.4 -3.4 6.17 3.86 7 31 74 10 0 74 79
  var22 = 143
  Return
// uthrow; 20
label uthrow
  SetVarAttackData 1.4 -3.4 6.17 3.86 7 24.5 61 8 0 80 70
  var22 = 85
  Return
// nair; 21
label nair
  SetVarAttackData -4.96 1.43 7.72 4.95 6 3 35 12 0 20 100
  var22 = 361
  Return
// nair_weak; 22
label nair_weak
  SetVarAttackData -4.96 1.35 7.71 4.79 10 17 35 8 0 15 100
  var22 = 361
  Return
// fair; 23
label fair
  SetVarAttackData -3.19 -7.57 10.4 8.16 13 2 44 15 0 35 80
  var22 = 40
  Return
// fair_meteor; 24
label fair_meteor
  SetVarAttackData -0.08 9.85 8.85 13.21 16 1 44 15 0 70 60
  var22 = 270
  Return
// bair; 25
label bair
  SetVarAttackData -15.63 2.59 3.79 3.89 12 2 32 15 0 21 101
  var22 = -361
  Return
// bair_weak; 26
label bair_weak
  SetVarAttackData -15.06 1.82 4.37 3.99 15 6 32 8 0 10 85
  var22 = -361
  Return
// uair; 27
label uair
  SetVarAttackData -7.91 1.56 9.3 10.42 7 3 32 11 0 30 100
  var22 = 85
  Return
// dair; 28
label dair
  SetVarAttackData -3.2 10.66 5.19 8.63 14 4 36 11 0 71 59
  var22 = 270
  Return
endif
Return
...
//   {RECOVERY_ADDITIONS}
  ...
  var22 = 0
if  var20 >= 12 && var20 <= 13 || Equal var20 15 || var20 >= 21 && var20 <= 28
    var22 = 1
  endif
  ...
  // chr get_moveDir
if Equal var20 10 || Equal var20 25 || Equal var20 26
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 3 || Equal var20 4 || Equal var20 5 || Equal var20 6 || Equal var20 7 || Equal var20 8 || Equal var20 12 || Equal var20 14 || Equal var20 15 || Equal var20 16 || Equal var20 17 || Equal var20 18 || Equal var20 19 || Equal var20 20 || Equal var20 23 || Equal var20 24
  var22 = 1
else
  var22 = 0
endif
  ...
  // chr get_moveDirY
if Equal var20 12 || Equal var20 14 || Equal var20 15 || Equal var20 25 || Equal var20 28
  var22 = -1
elif !(True)
  var22 = 1
else
