...
//   {TURBO_ROUTINES}
  ...
  if Equal CurrAction 275 && ActionTimer >= 6
    DynamicDiceClear 0
...
var11 = var22
  ...
  if var21 >= 16.7
if Equal var20 11 || Equal var20 12 || Equal var20 13 || Equal var20 15
      var20 = -1
    endif
  endif
  Return
...
elif Equal var20 25 || Equal var20 26
...
var11 = var22
  var22 = STACK_POP
  if Equal var11 1
elif Equal var20 16 || Equal var20 17 || Equal var20 18 || Equal var20 19 || Equal var20 20
        var22 = 1
        var10 *= -1
      elif OYDistFloor < 0
