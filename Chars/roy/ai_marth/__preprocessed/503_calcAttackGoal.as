...
DynamicDiceAdd 0 5 0.25
DynamicDiceAdd 0 6 0.25
...
DynamicDiceAdd 0 14 0.3333333333333333
DynamicDiceAdd 0 15 0.3333333333333333
...
DynamicDiceAdd 0 34 0.3333333333333333
DynamicDiceAdd 0 35 0.3333333333333333
DynamicDiceAdd 0 36 0.3333333333333333
endif
...
if Equal var20 26 || Equal var20 27
...
elif Equal var20 28 || Equal var20 29
      GetAttribute var22 304 0
elif Equal var20 34 || Equal var20 35 || Equal var20 36
      GetAttribute var22 316 0
elif Equal var20 30 || Equal var20 31
      GetAttribute var22 308 0
elif Equal var20 32 || Equal var20 33
    ...
    if !(Equal var22 0) 
      ...
      if Equal AirGroundState 2 && XDistLE var23
        var22 *= 0.5
        if YDistFloor > 0
          var23 = FastFallSpeed / YDistFloor
          var22 += var23
        endif
      ...
      // if immediateTempVar <= move_IASA && !(Equal currGoal cg_attack_wall) && currGoal >= cg_attack
...
if Equal var20 21 || Equal var20 22 || Equal var20 23 || Equal var20 24 || Equal var20 25
  ...
  var23 = var22
  Goto getOEndlag
  LOGSTR 1668246784 1651449856 1667787520 0 0
  LOGVAL var23
  ...
  if var23 < var7 && var21 < 16.7 && !(Equal var21 12)
    ...
    var17 *= 0.5
    var23 += var17
    // if XDistLE anotherTempVar && {Equal scriptVariant sv_campAttack || Equal currGoal cg_bait_attack} 
    //   Return
    // elif move_damage < 0 && XDistLE anotherTempVar
    //   Return
    // endif
