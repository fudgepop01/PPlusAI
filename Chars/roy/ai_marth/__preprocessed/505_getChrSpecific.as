...
// jab123; 0
label jab123
  SetVarAttackData 1.4 -2.13 11.65 7.33 4 3 25 8 0 30 66
  var22 = 361
  Return
// dashattack; 1
label dashattack
  SetVarAttackData 23.47 -2.74 8.82 5.56 13 4 39 14 0 70 47
  var22 = 110
  Return
// dashattack_weak; 2
label dashattack_weak
  SetVarAttackData 39.42 -5.39 3.15 2.73 13 4 39 10 0 70 60
  var22 = 100
  Return
// ftilt; 3
label ftilt
  SetVarAttackData 5.55 -2.26 12.86 5.36 8 4 37 13 0 60 70
  var22 = 361
  Return
// ftilt_weak; 4
label ftilt_weak
  SetVarAttackData 26.56 -3.01 4.86 3.67 9 3 37 9 0 40 80
  var22 = 60
  Return
// utilt; 5
label utilt
  SetVarAttackData -15.05 -0.89 10.36 16.37 6 4 33 12 0 35 100
  var22 = 110
  Return
// utilt_weak_start; 6
label utilt_weak_start
  SetVarAttackData -15.05 -0.89 9.49 16.37 6 4 33 9 0 35 67
  var22 = 100
  Return
// utilt_weak_end; 7
label utilt_weak_end
  SetVarAttackData -3.12 -4.55 12.33 14.54 11 3 33 9 0 35 67
  var22 = 90
  Return
// utilt_end; 8
label utilt_end
  SetVarAttackData -3.12 -4.55 12.33 14.54 11 3 33 12 0 35 100
  var22 = 85
  Return
// dtilt; 9
label dtilt
  SetVarAttackData 3.71 1.57 8.55 5.69 8 2 19 10 0 90 40
  var22 = 80
  Return
// dtilt_weak; 10
label dtilt_weak
  SetVarAttackData 18.6 1.89 3.58 3.87 8 2 19 6 0 70 40
  var22 = 80
  Return
// fsmash; 11
label fsmash
  SetVarAttackData 4.02 3.47 10.64 13.47 12 3 53 20 0 80 65
  var22 = 361
  Return
// fsmash_weak; 12
label fsmash_weak
  SetVarAttackData 7.93 3.18 10.7 15.58 12 3 53 13 0 80 20
  var22 = 361
  Return
// usmash; 13
label usmash
  SetVarAttackData -8.32 -2.5 7.16 15.88 15 9 45 12 0 73 80
  var22 = 90
  Return
// dsmash; 14
label dsmash
  SetVarAttackData -8.69 -1.13 11.87 6.52 7 3 61 18 0 42 85
  var22 = 75
  Return
// dsmash_weak; 15
label dsmash_weak
  SetVarAttackData 12.32 0.84 3.52 3.52 7 3 61 14 0 15 95
  var22 = 361
  Return
// dsmash_hit2; 16
label dsmash_hit2
  SetVarAttackData -15.16 -0.83 13.79 5.87 11 7 61 14 0 42 80
  var22 = 105
  Return
// nspecial; 17
label nspecial
  SetVarAttackData 1.27 4.03 11.36 15.82 17 5 46 9 0 40 110
  var22 = 361
  Return
// nspecialair; 18
label nspecialair
  SetVarAttackData -1.28 9.5 12.09 18.37 17 5 46 9 0 40 110
  var22 = 361
  Return
// sspecial; 19
label sspecial
  SetVarAttackData -1.42 -5.66 8.53 8.11 6 2 29 5 0 50 25
  var22 = 60
  Return
// sspecialair; 20
label sspecialair
...
// grab; 21
label grab
  SetVarAttackData 3.69 -4.11 7.06 4.33 7 0 32 0 0 0 0
  var22 = 0
  Return
// fthrow; 22
label fthrow
  SetVarAttackData 3.69 -4.11 7.06 4.33 7 10 33 5 0 70 45
  var22 = 50
  Return
// dthrow; 23
label dthrow
  SetVarAttackData 3.69 -4.11 7.06 4.33 7 10 44 6 0 65 60
  var22 = 60
  Return
// bthrow; 24
label bthrow
  SetVarAttackData 3.69 -4.11 7.06 4.33 7 9 46 5 0 70 70
  var22 = 135
  Return
// uthrow; 25
label uthrow
  SetVarAttackData 3.69 -4.11 7.06 4.33 7 9 46 5 0 60 130
  var22 = 83
  Return
// nair; 26
label nair
  SetVarAttackData -19.9 -1.89 19.71 8.5 13 12 48 10 0 50 80
  var22 = 361
  Return
// nair_weak; 27
label nair_weak
  SetVarAttackData -19.67 -1.44 19.72 9.03 6 5 48 4 0 30 40
  var22 = 100
  Return
// fair; 28
label fair
  SetVarAttackData -0.53 2.78 8.63 11.01 5 3 32 12 0 40 50
  var22 = 50
  Return
// fair_weak; 29
label fair_weak
  SetVarAttackData -0.53 2.78 11.14 12.68 5 3 32 9 0 30 65
  var22 = 45
  Return
// bair; 30
label bair
  SetVarAttackData -12.88 -2.87 7.62 6.23 7 3 40 16 0 20 100
  var22 = 130
  Return
// bair_weak; 31
label bair_weak
  SetVarAttackData -12.88 -2.87 7.62 6.23 7 3 40 11 0 20 70
  var22 = 140
  Return
// uair; 32
label uair
  SetVarAttackData -14.58 -7.54 13.47 8.96 5 5 48 12 0 45 40
  var22 = 80
  Return
// uair_weak; 33
label uair_weak
  SetVarAttackData -18.83 -3.52 16.89 12.91 5 5 48 8 0 30 40
  var22 = 80
  Return
// dair; 34
label dair
  SetVarAttackData -18.07 10.61 16.78 10.87 7 3 50 9 0 30 60
  var22 = 37
  Return
// dair_spike; 35
label dair_spike
  SetVarAttackData -7.12 -0.68 6.22 5.27 7 3 50 18 0 40 60
  var22 = 281
  Return
// dair_combo; 36
label dair_combo
  SetVarAttackData -13.75 5.84 12.32 8.49 7 3 50 12 0 30 60
  var22 = 90
  Return
endif
Return
...
//   {RECOVERY_ADDITIONS}
  ...
  var22 = 0
if  Equal var20 18 || Equal var20 20 || var20 >= 26 && var20 <= 36
    var22 = 1
  endif
  ...
  // chr get_moveDir
if Equal var20 5 || Equal var20 6 || Equal var20 30 || Equal var20 31
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 3 || Equal var20 4 || Equal var20 7 || Equal var20 8 || Equal var20 9 || Equal var20 10 || Equal var20 11 || Equal var20 12 || Equal var20 14 || Equal var20 15 || Equal var20 19 || Equal var20 20 || Equal var20 21 || Equal var20 22 || Equal var20 23 || Equal var20 24 || Equal var20 25 || Equal var20 28 || Equal var20 29
  var22 = 1
else
  var22 = 0
endif
  ...
  // chr get_moveDirY
if Equal var20 34 || Equal var20 36
  var22 = -1
elif !(True)
  var22 = 1
else
