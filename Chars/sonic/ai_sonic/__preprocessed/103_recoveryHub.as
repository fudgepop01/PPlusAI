...
var17 = 0
if Equal CurrAction 16 || Equal CurrAction 14 || Equal CurrAction 478
  var17 = 1
  Goto handleSFall
elif Equal CurrAction 276 || Equal CurrAction 285 || Equal CurrAction 291
  var17 = 1
  Goto handleUSpecial
elif Equal CurrAction 274 || Equal CurrAction 280 || Equal CurrAction 281 || Equal CurrAction 282 || Equal CurrAction 283
  var17 = 1
  Goto handleNSpecial
elif Equal CurrAction 275 || Equal CurrAction 286 || Equal CurrAction 287
  var17 = 1
  Goto handleSSpecial
elif Equal CurrAction 277 || Equal CurrAction 286 || Equal CurrAction 288 || Equal CurrAction 290 || Equal CurrAction 292
  var17 = 1
  Goto handleDSpecial
...
if YDistFloor > -1 
  ...
  if YDistBackEdge < 33.35 && var2 <= 15 && NumJumps > 0
    Button X
    Goto handleJumpToStage
    Return
  endif
  if var6 <= 0.45 && YDistBackEdge < 40 && Equal var4 0
    var4 = 1
    Button B
    ClearStick
    AbsStick 0 (0.7)
  ...
  if var2 <= 70 && YDistBackEdge > 74 && Equal var4 0
    var4 = 1
    Button B
    ClearStick
    AbsStick 0 (0.7)
  ...
  elif YDistBackEdge > 97.35 || var17 < 18
