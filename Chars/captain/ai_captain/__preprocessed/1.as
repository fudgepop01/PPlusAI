...
if MeteoChance
  ...
  if CanJump && YDistBackEdge > 60
    Call RecoveryHub
  elif !(CanJump) && YDistBackEdge > 48
    Call RecoveryHub
  endif
endif
if !(True)
...
if Equal var16 3 && var20 < 24640
  ...
  if Equal CurrAction 1 && LevelValue > 21 && 20 < var0
    ClearStick
  endif

  if var0 <= 20 && !(Equal CurrSubaction JumpSquat)
    Goto JumpIfInRange
  endif
...
if var1 <= var17
  ...
  if var20 >= 24641 && var20 <= 24655 || Equal var2 (-1)
    ...
    if Equal AirGroundState 1 && CurrAction <= 23
      ...
      var16 = 0
      Call AIHub
    elif !CanJump && Equal var2 2 && var4 < -48
      var19 = 0
      var16 = 0
      Call AIHub
