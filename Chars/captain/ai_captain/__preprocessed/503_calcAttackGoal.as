...
DynamicDiceAdd 1 10 0.25
DynamicDiceAdd 1 11 0.25
DynamicDiceAdd 1 12 0.25
DynamicDiceAdd 1 13 0.25
else
DynamicDiceClear 0
...
DynamicDiceAdd 0 10 0.2
DynamicDiceAdd 0 11 0.2
...
if Equal var20 9 || Equal var20 10 || Equal var20 11 || Equal var20 12 || Equal var20 13
...
label check_hub
  ...
  if YDistFloor < 20 && !(Equal YDistFloor -1) 
    var22 = 0
if Equal var20 14 || Equal var20 15
      GetAttribute var22 300 0
elif Equal var20 16 || Equal var20 17
      GetAttribute var22 304 0
elif Equal var20 21 || Equal var20 22
      GetAttribute var22 316 0
elif Equal var20 18
      GetAttribute var22 308 0
elif Equal var20 19 || Equal var20 20
...
var11 = var22
  var22 = STACK_POP
  if Equal var11 1
elif Equal var20 9 || Equal var20 10 || Equal var20 11 || Equal var20 12 || Equal var20 13
        var22 = 1
        var10 *= -1
      elif OYDistFloor < 0
