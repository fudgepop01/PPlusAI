...
// dashattack; 0
label dashattack
  SetVarAttackData 9.31 -2.79 10.78 6.41 7 9 37 10 0 22 90
  var22 = 361
  Return
// ftilt; 1
label ftilt
  SetVarAttackData 2.35 -8.15 9.53 4.39 9 2 29 11 0 10 100
  var22 = 361
  Return
// utilt; 2
label utilt
  SetVarAttackData -0.24 3.79 10.77 15.57 17 5 37 13 0 50 80
  var22 = 361
  Return
// dtilt; 3
label dtilt
  SetVarAttackData 0.59 1.61 11.23 5.23 10 5 34 12 0 25 75
  var22 = 70
  Return
// fsmash; 4
label fsmash
  SetVarAttackData 5.73 -5.3 10.91 4.24 19 2 60 20 0 24 100
  var22 = 361
  Return
// usmash; 5
label usmash
  SetVarAttackData -2.55 -2.89 8.37 13.9 22 7 40 13 0 30 126
  var22 = 90
  Return
// dsmash; 6
label dsmash
  SetVarAttackData 4.7 -6.99 7.9 4.79 20 3 44 18 0 30 100
  var22 = 361
  Return
// dsmash_late; 7
label dsmash_late
  SetVarAttackData -19.56 -3.95 7.05 4.37 30 2 44 16 0 20 100
  var22 = 361
  Return
// sspecial; 8
label sspecial
  SetVarAttackData -1.56 -1.41 11.08 9.11 4 4 60 7 0 78 80
  var22 = 90
  Return
// grab; 9
label grab
  SetVarAttackData -0.91 -5.94 5.82 3.91 7 0 32 0 0 0 0
  var22 = 0
  Return
// fthrow; 10
label fthrow
  SetVarAttackData -0.91 -5.94 5.82 3.91 7 9 34 4 0 45 105
  var22 = 45
  Return
// dthrow; 11
label dthrow
  SetVarAttackData -0.91 -5.94 5.82 3.91 7 12.5 41 7 0 75 34
  var22 = 65
  Return
// bthrow; 12
label bthrow
  SetVarAttackData -0.91 -5.94 5.82 3.91 7 9.5 43 4 0 30 130
  var22 = 45
  Return
// uthrow; 13
label uthrow
  SetVarAttackData -0.91 -5.94 5.82 3.91 7 10 45 3 0 70 105
  var22 = 85
  Return
// nair; 14
label nair
  SetVarAttackData -3.17 -0.82 9.96 6.11 7 5 44 6 1 40 100
  var22 = 74
  Return
// nair_hit2; 15
label nair_hit2
  SetVarAttackData -3.17 -0.82 9.96 8.49 7 22 44 7 0 40 100
  var22 = 361
  Return
// fair; 16
label fair
  SetVarAttackData 0.39 -0.84 5.95 5.77 14 2 35 18 0 24 100
  var22 = 32
  Return
// fair_weak; 17
label fair_weak
  SetVarAttackData 1.09 -0.77 5.65 5.78 17 13 35 6 0 35 80
  var22 = 361
  Return
// bair; 18
label bair
  SetVarAttackData -16.52 -1.13 7.83 6.24 10 3 28 14 0 0 100
  var22 = -361
  Return
// uair; 19
label uair
  SetVarAttackData -5.5 -2.37 11.48 12.13 6 4 29 12 0 10 100
  var22 = 361
  Return
// uair_tipman; 20
label uair_tipman
  SetVarAttackData -16.75 -6.93 10.32 9.85 11 2 29 10 0 8 80
  var22 = 150
  Return
// dair; 21
label dair
  SetVarAttackData -5.76 10.97 6.75 12.8 16 4 37 16 0 40 100
  var22 = 270
  Return
// dair_spike; 22
label dair_spike
  SetVarAttackData -5.4 -3.01 5.49 5.81 16 4 37 16 0 40 100
  var22 = 290
  Return
endif
Return
...
if  var20 >= 14 && var20 <= 22
  ...
  // chr get_moveDir
if Equal var20 7 || Equal var20 18 || Equal var20 20
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 3 || Equal var20 4 || Equal var20 5 || Equal var20 6 || Equal var20 8 || Equal var20 9 || Equal var20 10 || Equal var20 11 || Equal var20 12 || Equal var20 13 || Equal var20 14 || Equal var20 15 || Equal var20 16 || Equal var20 17 || Equal var20 19
  var22 = 1
else
  var22 = 0
endif
    ...
    if !(True)
      label shuffle_AI
        ...
        if Rnd < var22
          ...
          ADJUST_PERSONALITY 10 1.9 Rnd
          ADJUST_PERSONALITY 4 1.4 Rnd
          ADJUST_PERSONALITY 5 0.8 Rnd
          if Rnd < 0.25
