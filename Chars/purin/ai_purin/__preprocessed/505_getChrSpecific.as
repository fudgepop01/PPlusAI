...
// jab123; 0
label jab123
  SetVarAttackData 2.95 -1.13 5.21 3.6 5 1 15 3 0 8 50
  var22 = 44
  Return
// jab123_2; 1
label jab123_2
  SetVarAttackData 3.45 -0.44 5.26 3.59 6 1 15 3 0 30 90
  var22 = 361
  Return
// dashattack; 2
label dashattack
  SetVarAttackData 9.57 -3.56 7.24 4.81 4 4 38 12 0 16 100
  var22 = 361
  Return
// dashattack_weak; 3
label dashattack_weak
  SetVarAttackData 9.57 -2.86 11 5.16 4 10 38 8 0 8 100
  var22 = 361
  Return
// ftilt; 4
label ftilt
  SetVarAttackData 0.46 -0.28 6.92 3.73 6 3 27 10 0 24 100
  var22 = 361
  Return
// utilt; 5
label utilt
  SetVarAttackData -12.21 5.23 8.87 12.39 8 6 25 9 0 40 120
  var22 = 96
  Return
// dtilt; 6
label dtilt
  SetVarAttackData 1.82 0.25 7.24 4.27 7 2 26 10 0 40 30
  var22 = 20
  Return
// fsmash; 7
label fsmash
  SetVarAttackData 7.47 -0.64 6.85 5.14 13 3 45 17 0 10 118
  var22 = 361
  Return
// fsmash_weak; 8
label fsmash_weak
  SetVarAttackData 7.47 -0.64 7.75 5.14 13 8 45 13 0 6 105
  var22 = 361
  Return
// usmash; 9
label usmash
  SetVarAttackData -11.8 -2.01 10.85 9.39 8 3 45 15 0 20 110
  var22 = 90
  Return
// dsmash; 10
label dsmash
  SetVarAttackData -12.26 3.22 12.46 4.82 10 1 48 12 0 34 66
  var22 = 360
  Return
// dspecial; 11
label dspecial
  SetVarAttackData -1.82 -3.15 1.95 1.95 1 0 251 28 0 78 120
  var22 = 361
  Return
// dspecialair; 12
label dspecialair
  SetVarAttackData -1.27 -3.14 1.95 1.95 1 0 251 28 0 78 120
  var22 = 361
  Return
// sspecial; 13
label sspecial
  SetVarAttackData 2.03 -0.17 9.85 4.06 12 15 47 13 0 52 75
  var22 = 120
  Return
// sspecialair; 14
label sspecialair
  SetVarAttackData 0.15 0.53 5.92 4.41 12 15 47 13 0 52 75
  var22 = 120
  Return
// grab; 15
label grab
  SetVarAttackData 1.64 -0.86 6.28 3.91 7 0 32 0 0 0 0
  var22 = 0
  Return
// fthrow; 16
label fthrow
  SetVarAttackData 1.64 -0.86 6.28 3.91 7 8 37 7 0 40 110
  var22 = 361
  Return
// dthrow; 17
label dthrow
  SetVarAttackData 1.64 -0.86 6.28 3.91 7 34.5 86 2 0 100 45
  var22 = 80
  Return
// bthrow; 18
label bthrow
  SetVarAttackData 1.64 -0.86 6.28 3.91 7 15.5 51 10 0 90 25
  var22 = 135
  Return
// uthrow; 19
label uthrow
  SetVarAttackData 1.64 -0.86 6.28 3.91 7 7 43 11 0 130 25
  var22 = 90
  Return
// nair; 20
label nair
  SetVarAttackData -4.58 2.16 8.56 5.64 6 1 49 12 0 10 70
  var22 = 361
  Return
// nair_weak; 21
label nair_weak
  SetVarAttackData -4.58 2.16 8.56 5.64 6 22 49 9 0 10 80
  var22 = 361
  Return
// fair; 22
label fair
  SetVarAttackData -2.85 2.85 8.08 5.06 7 1 34 12 0 10 100
  var22 = 361
  Return
// fair_weak; 23
label fair_weak
  SetVarAttackData -2.85 2.85 8.08 5.07 7 15 34 7 0 10 80
  var22 = 361
  Return
// bair; 24
label bair
  SetVarAttackData -19.14 1.04 9.8 4.59 9 3 30 12 0 10 100
  var22 = 361
  Return
// uair; 25
label uair
  SetVarAttackData -9.7 -4.91 8.98 6.35 9 3 37 12 0 30 100
  var22 = 90
  Return
// dair; 26
label dair
  SetVarAttackData -2.42 7.28 5.32 5.79 5 22 51 2 0 20 100
  var22 = 270
  Return
endif
Return
...
if  Equal var20 12 || Equal var20 14 || var20 >= 20 && var20 <= 26
  ...
  // chr get_moveDir
if Equal var20 5 || Equal var20 24
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 3 || Equal var20 4 || Equal var20 6 || Equal var20 7 || Equal var20 8 || Equal var20 13 || Equal var20 14 || Equal var20 15 || Equal var20 16 || Equal var20 17 || Equal var20 18 || Equal var20 19 || Equal var20 22 || Equal var20 23
  var22 = 1
else
  var22 = 0
endif
      ...
      label shuffle_AI
        ...
        if Rnd < var22
          ...
          if Rnd < 0.25
            ...
            ADJUST_PERSONALITY 7 1.5 Rnd
          endif
          if Rnd < 0.25
            ADJUST_PERSONALITY 6 -1 PT_DJUMPINESS
            ADJUST_PERSONALITY 6 2.4000000000000004 Rnd
          endif
          if Rnd < 0.25
