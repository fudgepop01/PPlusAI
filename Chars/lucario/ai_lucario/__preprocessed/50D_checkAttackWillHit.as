...
if  Equal var20 14 || var20 >= 18 && var20 <= 19 || var20 >= 25 && var20 <= 31
  ...
  if OTopNY >= TopNY
    if YDistFloor < 2 && YDistFloor > 0
      ...
      var23 = TopNY + 34.69 //- var1
      var17 -= 17.345
      if var23 > var17 && NumJumps > 0 && OTopNY > TopNY
        var14 = var23 + 4
        // goalY += move_centerY
      elif var21 >= 16.7 && YDistBackEdge > 26.689999999999998
        var14 = var23 + 4
        // goalY += move_centerY
        var13 = TopNX
      endif
...
if  var20 >= 0 && var20 <= 2 || var20 >= 5 && var20 <= 8 || var20 >= 11 && var20 <= 13 || Equal var20 15
    var23 = TopNX + 24 * OPos
    var22 = var17 - var23
    Abs var22
    ...
    if Equal CurrAction 3 && LevelValue >= 31
      ...
      var23 = TopNX + TotalXSpeed * (AnimFrame - 10 + 2)
      var22 = var17 - var23
      Abs var22
