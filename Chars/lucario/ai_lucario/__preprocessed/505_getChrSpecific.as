...
if Equal var22 19.1
  if var20 >= 0 && var20 < 32
    ...
    if !(True)
      ...
      Return
      label _usmashstartStr
      LOGSTR 1970498816 1634953216 1937006848 1920204800 0
      Return
      label _dsmashStr
      ...
      Return
      label _sspecial_auraStr
      LOGSTR 1936945152 1701013760 1634492160 1635086848 1627389952
      Return
      label _sspecialairStr
      LOGSTR 1936945152 1701013760 1634492672 1769078784 0
      Return
      label _sspecialair_auraStr
      LOGSTR 1936945152 1701013760 1634492672 1769103104 1635086848
      Return
      label _grabStr
      ...
      Return
      label _nair_superlateStr
      LOGSTR 1851877632 1918857984 1970300160 1919705344 1952776192
      Return
      label _fairStr
...
// jab123; 0
label jab123
  SetVarAttackData 0.43 -3.6 7.37 4.13 6 1 18 3 1 30 100
  var22 = 60
  Return
// jab1232; 1
label jab1232
  SetVarAttackData 3.13 -3.59 7.72 4.14 8 1 22 2 1 36 100
  var22 = 50
  Return
// jab1233; 2
label jab1233
  SetVarAttackData 2.3 -6.9 8.18 5.57 8 3 31 5 0 30 120
  var22 = 55
  Return
// dashattack; 3
label dashattack
  SetVarAttackData 3.04 -4.04 8.49 4.25 6 0 27 10 0 45 55
  var22 = 55
  Return
// dashattack_late; 4
label dashattack_late
  SetVarAttackData 4.67 -3.68 13.45 4.34 7 8 27 7 0 30 55
  var22 = 75
  Return
// ftilt; 5
label ftilt
  SetVarAttackData 8.48 -5.4 7.76 4.33 10 4 26 10 0 40 35
  var22 = 37
  Return
// utilt; 6
label utilt
  SetVarAttackData -14.81 2.18 14.81 14.6 5 9 26 7 0 35 90
  var22 = 85
  Return
// dtilt; 7
label dtilt
  SetVarAttackData 1.25 1.81 8.61 4.6 5 3 25 6 0 35 100
  var22 = 80
  Return
// fsmash; 8
label fsmash
  SetVarAttackData 6 -1.5 10.75 6.5 20 4 41 14 0 20 100
  var22 = 361
  Return
// usmash; 9
label usmash
  SetVarAttackData -1.87 0.3 7.98 19.82 11 13 26 6 0 45 175
  var22 = 83
  Return
// usmashstart; 10
label usmashstart
  SetVarAttackData -0.9 0.3 7.49 8.65 11 1 26 6 1 40 100
  var22 = 112
  Return
// dsmash; 11
label dsmash
  SetVarAttackData -18 -1 17 5 13 5 34 14 0 25 100
  var22 = 361
  Return
// nspecial; 12
label nspecial
  SetVarAttackData 0 5 100 10 18 22 48 -1 0 -1 0
  var22 = 0
  Return
// asc; 13
label asc
...
// dspecial; 15
label dspecial
  SetVarAttackData 1 1 1 1 999 0 9999 0 0 -1 0
  var22 = 0
  Return
// sspecial; 16
label sspecial
  SetVarAttackData 3.13 -4.47 6.17 4.18 12 2 58 3 0 40 212
  var22 = 65
  Return
// sspecial_aura; 17
label sspecial_aura
  SetVarAttackData 3.13 -4.47 6.17 4.18 12 2 58 5 0 65 219
  var22 = 65
  Return
// sspecialair; 18
label sspecialair
  SetVarAttackData 3.13 -4.47 6.17 4.18 12 2 58 3 0 10 212
  var22 = 280
  Return
// sspecialair_aura; 19
label sspecialair_aura
  SetVarAttackData 3.13 -4.47 6.17 4.18 12 2 58 5 0 10 183
  var22 = 300
  Return
// grab; 20
label grab
  SetVarAttackData 0.37 -4.34 5.52 3.91 7 0 30 0 0 0 0
  var22 = 0
  Return
// fthrow; 21
label fthrow
  SetVarAttackData 0.37 -4.34 5.52 3.91 7 9 29 10 0 20 90
  var22 = 45
  Return
// dthrow; 22
label dthrow
  SetVarAttackData 0.37 -4.34 5.52 3.91 7 13.5 54 7 0 80 44
  var22 = 70
  Return
// bthrow; 23
label bthrow
  SetVarAttackData 0.37 -4.34 5.52 3.91 7 10 35 10 0 35 75
  var22 = 135
  Return
// uthrow; 24
label uthrow
  SetVarAttackData 0.37 -4.34 5.52 3.91 7 11.5 34 5 0 60 105
  var22 = 105
  Return
// nair; 25
label nair
  SetVarAttackData -11.23 -1.35 11.45 4.57 9 6 30 15 0 20 100
  var22 = 361
  Return
// nair_late; 26
label nair_late
  SetVarAttackData -11.23 -0.5 10.89 4.57 16 12 30 12 0 15 100
  var22 = 50
  Return
// nair_superlate; 27
label nair_superlate
  SetVarAttackData -10.24 -0.74 10.2 4.23 29 12 30 9 0 10 100
  var22 = 60
  Return
// fair; 28
label fair
  SetVarAttackData -0.47 4.91 8.2 8.89 4 8 25 12 0 40 70
  var22 = 60
  Return
// bair; 29
label bair
  SetVarAttackData -15.73 0.26 6.93 5.29 10 3 31 15 0 30 100
  var22 = -361
  Return
// uair; 30
label uair
  SetVarAttackData -3.6 -5.08 7 7.38 7 3 28 12 0 40 100
  var22 = 90
  Return
// dair; 31
label dair
  SetVarAttackData -4.5 8.3 5.25 8.35 4 8 28 8 0 50 110
  var22 = 361
  Return
endif
Return
...
//   {RECOVERY_ADDITIONS}
  ...
  var22 = 0
if  Equal var20 14 || var20 >= 18 && var20 <= 19 || var20 >= 25 && var20 <= 31
    var22 = 1
  endif
  ...
  // chr get_moveDir
if Equal var20 11 || Equal var20 26 || Equal var20 27 || Equal var20 29
  var22 = -1
