...
label _SSpecial_impl
  if Equal var19 2 && Equal XDistBackEdge XDistFrontEdge && Equal var4 20
    Button A
  elif Equal var19 1 && Equal var4 20 
    Button A
  endif
Return
...
label _USpecial_impl
  ...
  var1 /= var2
  AbsStick var0 var1
  if Equal HitboxConnected 1 || Equal var4 38
    label
    Button A
