...
// elif OAttacking && Rnd < 0.6 && XDistLE 20
  ...
  if Equal CurrAction 10
    ...
    if Equal CurrAction 1 && !(Equal CurrAction 7)
      ClearStick
    elif !(XDistLE 45) && !(Equal OPos Direction) && CurrAction <= 3 && NumFrames > 3
      SetFrame 0
      Stick (-1)
      var0 -= 1
    elif NumFrames >= var1 && Equal CurrAction 3
      Goto _ddSubr
    elif AnimFrame >= 10 && Equal CurrAction 3
      Goto _ddSubr
...
if MeteoChance
  ...
  // if CanJump && YDistBackEdge > 85
  //   var16 = 0
  //   Call RecoveryHub
  // elif !(CanJump) && YDistBackEdge > 70
  //   var16 = 0
  //   Call RecoveryHub
  // endif
endif
...
if !(Equal var17 -1) && var17 < 20 && Rnd < 0.15 && !(Equal var16 6) && var20 > 24638
  if XDistLE 25 && Rnd < 0.3 || !(XDistLE 25)
    ...
    Return
    label
    if InAir && YDistBackEdge > -3 && !(Equal YSpeed 0) && YSpeed < 3.1
      Button R
...
if Equal var2 2 && Equal var16 3
  ...
  var22 = OTopNY + 30
  if CanJump && YDistFrontEdge < -85
    var19 = 0
    var16 = 0
    Call AIHub
  elif !CanJump && YDistFrontEdge < -70 && YSpeed < 0.1
    var19 = 0
    var16 = 0
    Call AIHub
  elif CanJump && YDistFrontEdge > 85 || YDistFrontEdge > 20 && TopNY < var22
    var19 = 0
    var16 = 0
    Call RecoveryHub
  endif
...
if Equal var16 3 && var20 < 24640
elif XDistLE 10 && var20 < 24640 && Equal AirGroundState 2
  Goto makeIdle
  var2 = 1
  ...
  if Equal CurrAction 1 && LevelValue > 21 && !(XDistLE 10)
    ClearStick
  endif

  if XDistLE 10 || var0 <= var11 
  ...
  if XDistLE 10 && !(Equal CurrSubaction JumpSquat) && var20 >= 24641
    Goto JumpIfInRange
  endif
