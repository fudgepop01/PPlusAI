...
//   {TURBO_ROUTINES}
  ...
  if HasCurry && Equal HitboxConnected 1
  elif True
  GetRaBit var22 32 0
  if var22 < 1
    GetRaBit var22 33 0
...
if Equal var20 20 || Equal var20 21 || Equal var20 22 || Equal var20 23 || Equal var20 24
...
if Equal var20 9 || Equal var20 10
        Return
elif !(True)
        Return
      endif
...
label check_hub
  ...
  if YDistFloor < 20 && !(Equal YDistFloor -1) 
    var22 = 0
if Equal var20 25 || Equal var20 26 || Equal var20 27
...
var11 = var22
  var22 = STACK_POP
  if Equal var11 1
elif Equal var20 20 || Equal var20 21 || Equal var20 22 || Equal var20 23 || Equal var20 24
        var22 = 1
        var10 *= -1
      elif OYDistFloor < 0
