...
if Equal CanCancelAttack 1
  if {{Equal CurrAction 16} || {Equal CurrAction 276} || {Equal CurrAction 274} || {Equal CurrAction 275} || {Equal CurrAction 277 || Equal CurrAction 281}}
    Seek postMoveCheck
    Jump
  endif
endif
...
if CurrAction >= 98 && CurrAction <= 108 && AnimFrame < 8
  ...
  Goto handleSSpecial
  var17 = 1
elif Equal CurrAction 277 || Equal CurrAction 281
  Goto handleDSpecial
  var17 = 1
...
var22 = -75
DrawDebugRectOutline var17 -75 88 30 0 255 0 170
if var2 > 2 && var2 < 90 && var1 < 90 && var3 > 60
      DynamicDiceAdd 0 20 0.1
    endif
  endif
...
var22 = -90
DrawDebugRectOutline var17 -90 300 150 0 0 255 170
if var2 > 0 && var2 < 300 && var1 < 165 && var3 > 15
...
var22 = -85
DrawDebugRectOutline var17 -85 90 10 255 255 0 170
if var2 > 0 && var2 < 90 && var1 < 90 && var1 > 80
        DynamicDiceAdd 0 20 50
      endif
    endif
  endif
  var23 = TopNY - BBoundary
  if var23 > 20 && var1 < 130
  else
    DynamicDiceClear 0
    DynamicDiceAdd 0 0 1
    if NumJumps > 0
