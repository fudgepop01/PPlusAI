...
if Equal var22 19.1
  if var20 >= 0 && var20 < 28
    ...
    if !(True)
      ...
      Return
      label _ftilt_lateStr
      LOGSTR 1718905088 1819565824 1818326016 1694498816 0
      Return
      label _utiltStr
      ...
      Return
      label _fsmash_lateStr
      LOGSTR 1718840576 1634953216 1600938240 1952776192 0
      Return
      label _usmashStr
...
// jab123; 0
label jab123
  SetVarAttackData 2 -0.87 7.29 4.69 4 2 15 3 1 20 100
  var22 = 83
  Return
// dashattack; 1
label dashattack
  SetVarAttackData 6.15 3.09 11.81 5.08 3 25 34 10 0 60 50
  var22 = 50
  Return
// dashattack_late; 2
label dashattack_late
  SetVarAttackData 6.15 3.09 11.81 5.08 7 21 34 9 0 60 50
  var22 = 120
  Return
// ftilt; 3
label ftilt
  SetVarAttackData 0.79 0.01 9.43 5.5 10 3 39 13 0 10 100
  var22 = 361
  Return
// ftilt_late; 4
label ftilt_late
  SetVarAttackData 0.79 0.01 9.43 5.5 10 18 39 8 0 10 100
  var22 = 65
  Return
// utilt; 5
label utilt
  SetVarAttackData -11.09 -5.5 10.92 8.07 7 17 31 12 0 30 110
  var22 = 100
  Return
// dtilt; 6
label dtilt
  SetVarAttackData 8.99 2.29 6.25 4.61 6 7 25 10 0 80 60
  var22 = 361
  Return
// fsmash; 7
label fsmash
  SetVarAttackData 3.59 -2.48 8.52 4.69 14 1 41 16 0 35 108
  var22 = 361
  Return
// fsmash_late; 8
label fsmash_late
  SetVarAttackData 3.59 -2.48 8.52 4.69 16 12 41 10 0 40 100
  var22 = 55
  Return
// usmash; 9
label usmash
  SetVarAttackData -11.34 -3.07 11.57 5.91 25 2 52 20 0 40 95
  var22 = 83
  Return
// dsmash; 10
label dsmash
  SetVarAttackData -16.23 1.88 16.23 5.47 8 4 28 17 0 52 132
  var22 = 280
  Return
// nspecialair; 11
label nspecialair
  SetVarAttackData 3.28 0.83 50 22 8 42 8 -5 0 20 50
  var22 = 70
  Return
// uspecial; 12
label uspecial
  SetVarAttackData -4.69 1.5 7.39 32.58 3 17 29 6 0 60 80
  var22 = 80
  Return
// grab; 13
label grab
  SetVarAttackData -0.14 -1.49 6.6 5.08 7 0 32 0 0 0 0
  var22 = 0
  Return
// fthrow; 14
label fthrow
  SetVarAttackData -0.14 -1.49 6.6 5.08 7 45 59 8 0 100 40
  var22 = 68
  Return
// dthrow; 15
label dthrow
  SetVarAttackData -0.14 -1.49 6.6 5.08 7 45 54 10 0 90 0
  var22 = 270
  Return
// bthrow; 16
label bthrow
...
// uthrow; 17
label uthrow
  SetVarAttackData -0.14 -1.49 6.6 5.08 7 45 59 8 0 65 80
  var22 = 88
  Return
// nair; 18
label nair
  SetVarAttackData -11.72 -0.63 11.72 11.72 20 9 43 15 0 20 104
  var22 = 361
  Return
// fair; 19
label fair
  SetVarAttackData -13 -2.06 7.47 7.85 9 0 46 16 0 10 100
  var22 = 50
  Return
// fair_mid; 20
label fair_mid
  SetVarAttackData -13 1.87 16 9.81 10 2 46 16 0 10 100
  var22 = 361
  Return
// fair_late; 21
label fair_late
  SetVarAttackData 1.69 1.87 8.66 6.25 13 19 46 7 0 10 90
  var22 = 361
  Return
// bair; 22
label bair
  SetVarAttackData -19.85 2.3 8.29 4.69 10 11 41 3 0 48 72
  var22 = 112
  Return
// bair_late; 23
label bair_late
  SetVarAttackData -19.85 2.3 8.29 4.69 22 0 41 4 0 60 60
  var22 = 112
  Return
// uair; 24
label uair
  SetVarAttackData -4.68 -8.43 5.08 6.3 3 5 17 9 0 45 95
  var22 = 80
  Return
// dair; 25
label dair
  SetVarAttackData -4.28 9.46 5.08 6.49 12 0 41 15 0 20 100
  var22 = 270
  Return
// dair_mid; 26
label dair_mid
  SetVarAttackData -4.28 9.46 5.08 6.49 13 14 41 14 0 20 100
  var22 = 60
  Return
// dair_late; 27
label dair_late
  SetVarAttackData -4.28 9.46 5.08 6.49 28 10 41 8 0 20 100
  var22 = 60
  Return
endif
Return
...
//   {RECOVERY_ADDITIONS}
  ...
  var22 = 0
if  Equal var20 11 || var20 >= 18 && var20 <= 27
    var22 = 1
  endif
  ...
  // chr get_moveDir
if Equal var20 19 || Equal var20 22 || Equal var20 23
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 3 || Equal var20 4 || Equal var20 6 || Equal var20 7 || Equal var20 8 || Equal var20 11 || Equal var20 13 || Equal var20 14 || Equal var20 15 || Equal var20 16 || Equal var20 17 || Equal var20 21
  var22 = 1
else
  var22 = 0
endif
  ...
  // chr get_moveDirY
if Equal var20 22 || Equal var20 23 || Equal var20 25 || Equal var20 26 || Equal var20 27
  var22 = -1
elif !(True)
  var22 = 1
else
