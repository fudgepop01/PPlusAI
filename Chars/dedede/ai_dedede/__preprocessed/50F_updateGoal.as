...
if var21 >= 7 && var21 < 8
  ...
  if var22 <= 10
    ...
    if Equal var22 1
      ...
      if Equal AirGroundState 1 && Rnd < 0.07
        var9 += 12 
        if Rnd < 0.07 && Rnd < 0.07
          var9 += 5
        endif
  ...
  if Equal var21 10
    ...
    if Equal var22 1
      ...
      elif ODistLE var17 && Rnd < 0.07 && Rnd < 0.07
        if Rnd < 0.07
          var16 = 1
          var16 += 0.1
        elif Rnd < 0.07
...
LOGSTR 1145137408 1912602624 0 0 0
  ...
  var22 += 35
  if !(ODistLE var22) && Rnd < 0.25 && Rnd < 0.25 && OFramesHitstun <= 0
    var21 = 7
    Return
  endif
