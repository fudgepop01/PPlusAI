...
// jab123; 0
label jab123
  SetVarAttackData 6.68 -0.25 10.26 6 8 2 24 6 1 25 100
  var22 = 361
  Return
// dashattack; 1
label dashattack
  SetVarAttackData 15.12 1.81 11.08 7.61 26 3 66 16 0 35 95
  var22 = 35
  Return
// ftilt; 2
label ftilt
  SetVarAttackData 5.94 -1.08 16.97 6.04 12 3 45 12 0 20 80
  var22 = 361
  Return
// utilt; 3
label utilt
  SetVarAttackData -16.02 -4.59 15.24 14.93 7 10 33 12 0 30 120
  var22 = 96
  Return
// dtilt; 4
label dtilt
  SetVarAttackData 4.86 1.79 10.24 5.03 6 2 32 10 0 20 100
  var22 = 361
  Return
// fsmash; 5
label fsmash
  SetVarAttackData -0.29 8.85 25.33 22.01 40 3 79 24 0 55 90
  var22 = 361
  Return
// usmash; 6
label usmash
  SetVarAttackData -23.09 0.16 23.59 18.9 18 6 57 20 0 40 83
  var22 = 80
  Return
// dsmash; 7
label dsmash
  SetVarAttackData -0.4 -0.78 13.57 6.5 15 3 47 18 0 50 79
  var22 = 130
  Return
// dsmash_hit2; 8
label dsmash_hit2
  SetVarAttackData -27.15 0.5 13.44 6.79 19 5 47 15 0 50 82
  var22 = 125
  Return
// nspecial; 9
label nspecial
  SetVarAttackData -5 0 9 9 17 2 21 8 0 10 100
  var22 = 90
  Return
// nspecialair; 10
label nspecialair
  SetVarAttackData -5 0 9 9 17 2 80 8 0 10 100
  var22 = 90
  Return
// dspecial; 11
label dspecial
  SetVarAttackData -4.01 -5.36 15.4 10.93 8 2 57 11 0 40 80
  var22 = 35
  Return
// sspecial; 12
label sspecial
  SetVarAttackData 0 10 80 30 17 34 58 -7 0 22 130
  var22 = 70
  Return
// grab; 13
label grab
  SetVarAttackData 3.54 -0.09 8.69 4.41 7 1 32 0 0 0 0
  var22 = 0
  Return
// fthrow; 14
label fthrow
  SetVarAttackData 3.54 -0.09 8.69 4.41 7 10 38 8 0 80 75
  var22 = 45
  Return
// dthrow; 15
label dthrow
  SetVarAttackData 3.54 -0.09 8.69 4.41 7 14.5 35 4 0 50 40
  var22 = 32
  Return
// bthrow; 16
label bthrow
  SetVarAttackData 3.54 -0.09 8.69 4.41 7 12.5 43 9 0 60 94
  var22 = 135
  Return
// uthrow; 17
label uthrow
  SetVarAttackData 3.54 -0.09 8.69 4.41 7 12.5 41 5 0 60 72
  var22 = 90
  Return
// nair; 18
label nair
  SetVarAttackData -11.06 3.06 11.06 11.06 6 1 36 12 0 30 85
  var22 = 75
  Return
// nair_weak; 19
label nair_weak
  SetVarAttackData -11.06 3.06 11.06 11.06 8 20 36 7 0 30 95
  var22 = 75
  Return
// fair; 20
label fair
  SetVarAttackData 1.01 3.37 12.87 16.58 13 5 39 15 0 15 100
  var22 = 361
  Return
// bair; 21
label bair
  SetVarAttackData -20.58 0.45 8.48 5.68 6 2 32 13 0 20 100
  var22 = 361
  Return
// bair_weak; 22
label bair_weak
  SetVarAttackData -19.79 0.77 8.09 5.9 9 12 32 9 0 20 100
  var22 = 361
  Return
// uair; 23
label uair
  SetVarAttackData -9.1 -11.06 9.19 13.22 10 14 44 12 0 40 85
  var22 = 70
  Return
// dair; 24
label dair
  SetVarAttackData -7.11 16.17 7.39 13.07 9 17 37 3 0 70 105
  var22 = 70
  Return
endif
Return
...
//   {RECOVERY_ADDITIONS}
  ...
  var22 = 0
if  Equal var20 10 || Equal var20 12 || var20 >= 18 && var20 <= 24
    var22 = 1
  endif
  ...
  // chr get_moveDir
if Equal var20 8 || Equal var20 21 || Equal var20 22
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 4 || Equal var20 5 || Equal var20 7 || Equal var20 11 || Equal var20 12 || Equal var20 13 || Equal var20 14 || Equal var20 15 || Equal var20 16 || Equal var20 17 || Equal var20 20
  var22 = 1
else
  var22 = 0
endif
      ...
      label shuffle_AI
        ...
        if Rnd < var22
          ...
          if Rnd < 0.25
            ...
            ADJUST_PERSONALITY 8 0.15000000000000002 Rnd
          endif
        endif
      Return
    endif
