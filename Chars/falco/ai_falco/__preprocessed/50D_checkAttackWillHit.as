...
if  Equal var20 11 || Equal var20 14 || Equal var20 16 || var20 >= 22 && var20 <= 29
  ...
  if OTopNY >= TopNY
    if YDistFloor < 2 && YDistFloor > 0
      ...
      var23 = TopNY + 43.68 //- var1
      var17 -= 21.84
      if var23 > var17 && NumJumps > 0 && OTopNY > TopNY
        var14 = var23 + 4
        // goalY += move_centerY
      elif var21 >= 16.7 && YDistBackEdge > 35.68
        var14 = var23 + 4
        // goalY += move_centerY
        var13 = TopNX
      endif
...
if  Equal var20 11 || Equal var20 14 || Equal var20 16 || var20 >= 22 && var20 <= 29
  ...
  var23 = TopNX
if Equal var20 11 || Equal var20 14 || Equal var20 16
  elif True
...
if  Equal var20 0 || var20 >= 3 && var20 <= 6 || var20 >= 9 && var20 <= 10 || Equal var20 13
    var23 = TopNX + 30 * OPos
    var22 = var17 - var23
    Abs var22
