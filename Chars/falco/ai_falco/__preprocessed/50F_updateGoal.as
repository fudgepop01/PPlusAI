...
if var21 >= 7 && var21 < 8
  ...
  if var22 <= 13
    ...
    if Equal var22 1
      ...
      if Equal AirGroundState 1 && Rnd < 0.4
        ...
        if Rnd < 0.04 && Rnd < 0.04 && NumJumps > 0
          var9 += 38
        else
          var9 += 1
  ...
  if Equal var22 1
    ...
    if ODistLE var17 && Equal AirGroundState 1 && Equal var21 10.5
      if Rnd < 0.017499999999999998 || Rnd < 0.1575
        var15 = -1
        if Rnd < 0.225
          var16 = 2
          Call Wavedash
    ...
    if ODistLE var22 && !(Equal var1 -1)
      ...
      elif NumJumps > 0 && Rnd < 0.04 && Rnd < 0.04 && OYDistBackEdge > -20
        var16 = 1
        if Rnd < 0.5
          var16 = 3
        endif
...
LOGSTR 1145137408 1912602624 0 0 0
  ...
  // otherwise carry on as normal
    ...
    if OAnimFrame <= 9 || Equal CurrAction 10 || Equal OCurrAction 73 || OFramesHitstun > 1 || Equal HitboxConnected 1
      ...
      if var22 > var23
        if OCurrAction >= 66 && OCurrAction <= 89
        elif !(SamePlane) && Rnd < 0.8 && Rnd < 0.2 && Equal var2 1 && OFramesHitstun <= 0
          var21 = 10
          Return
        endif
