...
if var21 >= 7 && var21 < 8
  ...
  if var22 <= 10
    ...
    if Equal var22 1
      ...
      if Equal AirGroundState 1 && Rnd < 0.15
        var9 += 13 
        if Rnd < 0.15 && Rnd < 0.15
          var9 += 5
        endif
      elif Equal AirGroundState 2 && YDistBackEdge < -5
        if Rnd < 0.03 && NumJumps > 0
          var9 += 38
        else
          var9 += 1
  ...
  if Equal var21 10
    ...
    if Equal var22 1
      ...
      if !(Equal var21 16.2)
        ...
        var22 += 15
        var23 = var22 - 5
        if XDistLE var22 && !(XDistLE var23) && Rnd < 0.3
          if Rnd < 0.85
            var21 = 10.1
            XGoto CalcAttackGoal
            XReciever
      ...
      elif ODistLE var17 && Rnd < 0.15 && Rnd < 0.15
        if Rnd < 0.15
          var16 = 1
          var16 += 0.1
        elif Rnd < 0.15
...
LOGSTR 1145137408 1912602624 0 0 0
  ...
  var22 += 35
  if !(ODistLE var22) && Rnd < 0.15 && Rnd < 0.15 && OFramesHitstun <= 0
    var21 = 7
    Return
  endif
  ...
  // otherwise carry on as normal
    ...
    if var22 > var23
      if !(SamePlane) && Rnd < 0.8 && Rnd < 0.2 && Equal var0 1 && OFramesHitstun <= 0
        var21 = 10
        Return
      endif
