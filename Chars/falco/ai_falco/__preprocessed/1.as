...
// elif OAttacking && Rnd < 0.6 && XDistLE 20
  ...
  if Equal CurrAction 10
    ...
    if Equal CurrAction 1 && !(Equal CurrAction 7)
      ClearStick
    elif !(XDistLE 60) && !(Equal OPos Direction) && CurrAction <= 3 && NumFrames > 3
      SetFrame 0
      Stick (-1)
  ...
  if Equal var6 -9999.9999 
    ...
    if var17 <= var11 && var20 >= 24641 && var20 <= 25000 || XDistLE 15 && var20 >= 24641 && var20 <= 25000      
      if MeteoChance
        ...
        if !(Equal CurrSubaction JumpSquat) && var6 <= 100
          Button X
        elif var6 <= 100 && OAttacking
          Button X
        endif
        Goto JumpIfInRange
      else
    ...
    elif var6 <= 100 && OAttacking && OCurrActionFreq >= 3
      Button X
      Goto JumpIfInRange
    // elif Rnd < 0.3 && var6 <= 100 
    //   Button X
    //   Goto JumpIfInRange
    endif
  // elif CanJump && Rnd <= 0.01 && var20 >= 24641 && var20 <= 24655 && Equal IsOnStage 1 && TopNY > OTopNY && !(Equal var16 7)
  //   Call mix_doubleJump
  // elif CanJump && Rnd <= 0.01 && Equal var20 32776 && TopNY > OTopNY && !(Equal var16 7)
  //   Call mix_doubleJump
...
if Equal var2 2 && Equal var16 3
  ...
  if CanJump && YDistFrontEdge < -90
    ...
    var16 = 0
    Call AIHub
  elif CanJump && YDistFrontEdge > 90 || YDistFrontEdge > 40 && TopNY < var22
    var19 = 0
    var16 = 0
    Call RecoveryHub
  endif
...
if !(Equal var6 -9999.9999)
  ...
  // endif
  // var17 += OHurtboxSize
  // if MeteoChance && Equal IsOnStage 0 && YSpeed < 0.01 && var17 > 30 && var17 < 45
  //   Button X
  // endif
  if var17 > 7 && var17 < 100 && Equal AirGroundState 1 && CurrAction <= 9
    Button X
  endif
  if var17 > 45 && var17 < 100 && Equal CurrSubaction JumpSquat
    Button X
  elif var17 > 7 && var17 < 100 && Equal CurrSubaction JumpSquat && OAttacking
    Button X
  endif
