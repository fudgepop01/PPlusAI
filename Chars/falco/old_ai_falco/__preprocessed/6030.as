...
ClearStick
  ...
  if CalledAs NSpecial
    ...
    label CNS
      ...
      var17 = YSpeed * -1
      if YDistBackEdge > -20
        CalcYChange var17 13 var17 Gravity MaxFallSpeed FastFallSpeed 1
      else
        CalcYChange var17 13 var17 Gravity MaxFallSpeed FastFallSpeed 0
      endif
      var10 = -7 + var17 - OHurtboxSize / 2
      if Equal AirGroundState 1
        Call AIHub
      endif
      var11 = 15
