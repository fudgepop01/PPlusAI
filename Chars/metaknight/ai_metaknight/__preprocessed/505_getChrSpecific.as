...
// jab123; 0
label jab123
  SetVarAttackData -17.07 0 17.07 7.75 8 14 39 3 0 40 100
  var22 = 361
  Return
// dashattack; 1
label dashattack
  SetVarAttackData 10.02 -3.73 7.76 3.73 4 3 39 8 0 40 88
  var22 = 60
  Return
// dashattack_weak; 2
label dashattack_weak
  SetVarAttackData 16.81 0.97 11.23 6.08 8 6 39 3 0 20 88
  var22 = 80
  Return
// ftilt; 3
label ftilt
  SetVarAttackData 4.29 -1.52 9.98 4.5 3 1 25 4 0 0 100
  var22 = 70
  Return
// ftilt2; 4
label ftilt2
  SetVarAttackData 0.48 -1.52 10.51 4.5 10 1 37 3 0 0 100
  var22 = 70
  Return
// ftilt3; 5
label ftilt3
  SetVarAttackData 3.7 -1 10.13 10.5 18 1 51 5 0 50 113
  var22 = 65
  Return
// utilt; 6
label utilt
  SetVarAttackData -7.71 -7.78 8.02 12.31 8 10 28 7 0 35 145
  var22 = 85
  Return
// dtilt; 7
label dtilt
  SetVarAttackData 4.89 0.8 10.96 4.8 6 1 19 5 0 20 116
  var22 = 37
  Return
// fsmash; 8
label fsmash
  SetVarAttackData 3.5 1.91 9.64 7.93 25 1 51 16 0 30 110
  var22 = 361
  Return
// usmash; 9
label usmash
  SetVarAttackData -17.03 -1.54 16.28 13.76 9 11 48 5 0 40 185
  var22 = 70
  Return
// dsmash; 10
label dsmash
  SetVarAttackData 1.49 1.69 10.54 4.51 6 1 47 13 0 50 80
  var22 = 361
  Return
// dsmash_hit2; 11
label dsmash_hit2
  SetVarAttackData -22.57 1.69 10.72 4.51 15 1 47 13 0 50 93
  var22 = 361
  Return
// uspecial; 12
label uspecial
  SetVarAttackData 8.12 5.59 5.88 16.99 8 1 133 9 0 85 90
  var22 = 75
  Return
// uspecialair; 13
label uspecialair
...
// dspecial; 14
label dspecial
  SetVarAttackData -40 40 40 40 26 1 77 14 0 35 114
  var22 = 361
  Return
// dspecialair; 15
label dspecialair
...
// grab; 16
label grab
  SetVarAttackData 1.5 -2.5 6.25 4 7 0 32 0 0 0 0
  var22 = 0
  Return
// fthrow; 17
label fthrow
  SetVarAttackData 1.5 -2.5 6.25 4 7 5.5 29 3 0 50 140
  var22 = 65
  Return
// dthrow; 18
label dthrow
  SetVarAttackData 1.5 -2.5 6.25 4 7 28 71 1 0 20 220
  var22 = 52
  Return
// bthrow; 19
label bthrow
  SetVarAttackData 1.5 -2.5 6.25 4 7 11.5 36 3 0 60 140
  var22 = 45
  Return
// uthrow; 20
label uthrow
  SetVarAttackData 1.5 -2.5 6.25 4 7 25 72 10 0 69 70
  var22 = 90
  Return
// nair; 21
label nair
  SetVarAttackData -7 6.6 9.18 12.36 3 3 42 12 0 30 100
  var22 = 361
  Return
// nair_med; 22
label nair_med
  SetVarAttackData -12.23 6.6 12.17 11.29 7 8 42 9 0 15 100
  var22 = 361
  Return
// nair_weak; 23
label nair_weak
  SetVarAttackData -9.63 4.32 9.64 9.86 16 12 42 4 0 10 100
  var22 = 361
  Return
// fair; 24
label fair
  SetVarAttackData 0.01 1.4 7.57 6.57 6 8 33 4 0 30 130
  var22 = 361
  Return
// bair; 25
label bair
  SetVarAttackData -14 5 7.5 12.5 10 1 35 14 0 30 100
  var22 = -361
  Return
// uair; 26
label uair
  SetVarAttackData -17.8 -6 15.4 8.25 5 1 22 8 0 40 105
  var22 = 78
  Return
// dair; 27
label dair
  SetVarAttackData -7.5 10.5 10.25 6.5 12 1 41 14 0 30 80
  var22 = 35
  Return
endif
Return
...
//   {RECOVERY_ADDITIONS}
  ...
  var22 = 0
if  Equal var20 13 || Equal var20 15 || var20 >= 21 && var20 <= 27
    var22 = 1
  endif
  ...
  // chr get_moveDir
if Equal var20 11 || Equal var20 25
  var22 = -1
elif Equal var20 1 || Equal var20 2 || Equal var20 3 || Equal var20 4 || Equal var20 5 || Equal var20 7 || Equal var20 8 || Equal var20 10 || Equal var20 12 || Equal var20 13 || Equal var20 16 || Equal var20 17 || Equal var20 18 || Equal var20 19 || Equal var20 20 || Equal var20 24
  var22 = 1
else
  var22 = 0
endif
    ...
    if !(True)
      label shuffle_AI
        ...
        if Rnd < var22
          ...
          ADJUST_PERSONALITY 10 1 Rnd
          ADJUST_PERSONALITY 4 1.6 Rnd
          ADJUST_PERSONALITY 5 0.24 Rnd
          if Rnd < 0.25
          ...
          if Rnd < 0.25
            ...
            ADJUST_PERSONALITY 6 0.21000000000000002 Rnd
          endif
          if Rnd < 0.25
            ADJUST_PERSONALITY 8 -1 PT_PLATCHANCE
            ADJUST_PERSONALITY 8 0.24 Rnd
          endif
        endif
      Return
    endif
