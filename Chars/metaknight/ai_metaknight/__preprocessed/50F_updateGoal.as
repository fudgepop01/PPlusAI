...
if var21 >= 7 && var21 < 8
  ...
  if var22 <= 13
    ...
    if Equal var22 1
      ...
      if Equal AirGroundState 1 && Rnd < 0.4
        var9 += 11 
        if Rnd < 0.4 && Rnd < 0.4
          var9 += 5
        endif
      elif Equal AirGroundState 2 && YDistBackEdge < -5
        if Rnd < 0.2 && Rnd < 0.2 && NumJumps > 0
          var9 += 25
        else
          var9 += 1
  ...
  if Equal var22 1
    ...
    if !(Equal var21 10.2) && !(Equal var21 10.5)
      ...
      if Equal var22 1 && Rnd < var23
        ...
        var22 = 1
        Return
      elif Equal var22 2 && Rnd < var23 && Rnd < 0.8
        var22 = 1
      else
        var22 = 0
      endif
      ...
      var22 += 45
      var23 = var22 - 20
      if XDistLE var22 && !(XDistLE var23) && Rnd < 0.2 && Equal var3 0
        if Rnd < 0.4
          if Rnd < 0.375
            var21 = 16.3
          else  
    ...
    if !(Equal var1 1)
      ...
      if Rnd < 0.8 && Rnd < 0.6000000000000001
      else
        var17 = var17 + 15 * Rnd + 10
      endif
    endif
    ...
    if ODistLE var17 && Equal AirGroundState 1 && Equal var21 10.5
      if Rnd < 0.22749999999999998 || Rnd < 0.1925
        var15 = -1
        if Rnd < 0.275
          var16 = 2
          Call Wavedash
    ...
    if ODistLE var22 && !(Equal var1 -1)
      ...
      if Equal AirGroundState 1
        ...
        DynamicDiceAdd 4
        DynamicDiceAdd 7
        if Equal var1 1 && Rnd < 0.48
          DynamicDiceAdd 6
          DynamicDiceAdd 6
          if Rnd < 0.36000000000000004
            var16 = 1
            var16 += 0.1
            if Rnd < 0.48
              var21 = 16
        ...
        if Rnd > 0.6000000000000001
          LOGSTR_NL 1398030592 1381244928 1463896320 1409286144 0
          var21 = 10.4
        endif
        if Rnd < 0.8450000000000001
          var16 = 2
          Call DashScr
        elif Rnd < 0.7150000000000001
          var16 = 2
          Call Wavedash
        endif
        if Equal var22 1
        ...
        if var17 > -40 && Rnd < 0.17
          Call BoardPlatform
        endif
      elif NumJumps > 0 && Rnd < 0.2 && Rnd < 0.2 && OYDistBackEdge > -20
        var16 = 1
        if Rnd < 0.5
          var16 = 3
        endif
    ...
    elif ODistLE var17 && Rnd < 0.4 && Equal OAirGroundState 1 && Equal var1 1
...
LOGSTR 1145137408 1912602624 0 0 0
  ...
  elif Equal var2 1 && Equal var1 0 && Rnd > 0.4 && Equal AirGroundState 1 && !(Equal var21 16.5)
    var21 = 10.5
    Return
  endif
  ...
  var22 += 30
  if !(ODistLE var22) && Rnd < 0.12 && Rnd < 0.12 && OFramesHitstun <= 0 && !(Equal var21 16.5)
    var21 = 7
    Return
  endif
  ...
  // otherwise carry on as normal
    ...
    if OAnimFrame <= 9 || Equal CurrAction 10 || Equal OCurrAction 73 || OFramesHitstun > 1 || Equal HitboxConnected 1
      ...
      elif Equal var23 -1 && Rnd > 0.8 && Rnd > 0.8
        var21 = 10.5
        Return
      endif
      ...
      if var22 > var23
        if OCurrAction >= 66 && OCurrAction <= 89
        elif !(SamePlane) && Rnd < 0.75 && Rnd < 0.2 && Equal var2 1 && OFramesHitstun <= 0
          var21 = 10
          Return
        endif
...
var23 = var0 * 1.25
var22 += var23 + 10
if var0 >= 10 && ODistLE var22 && OFramesHitstun <= 0 && Rnd < 0.8
