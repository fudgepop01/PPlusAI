...
if  Equal var20 13 || Equal var20 15 || var20 >= 21 && var20 <= 27
  ...
  if OTopNY >= TopNY
    if YDistFloor < 2 && YDistFloor > 0
      ...
      var23 = TopNY + 8.28 //- var1
      var17 -= 4.14
      if var23 > var17 && NumJumps > 0 && OTopNY > TopNY
        var14 = var23 + 4
        // goalY += move_centerY
      elif var21 >= 16.7 && YDistBackEdge > 0.27999999999999936
        var14 = var23 + 4
        // goalY += move_centerY
        var13 = TopNX
      endif
...
if  Equal var20 13 || Equal var20 15 || var20 >= 21 && var20 <= 27
  ...
  var23 = TopNX
if Equal var20 13 || Equal var20 15
  elif True
...
if  Equal var20 0 || var20 >= 3 && var20 <= 8 || var20 >= 10 && var20 <= 11 || Equal var20 14
    var23 = TopNX + 24 * OPos
    var22 = var17 - var23
    Abs var22
