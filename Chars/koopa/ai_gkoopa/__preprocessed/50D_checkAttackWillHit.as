...
if  var20 >= 13 && var20 <= 14 || var20 >= 24 && var20 <= 30
  ...
  if OTopNY >= TopNY
    if Equal AirGroundState 1 || YDistFloor < 2 && YDistFloor > 0
      ...
      var23 = TopNY + 53.36 //- var1
      var17 -= 26.68
      if var23 > var17 && NumJumps > 0 && OTopNY > TopNY
        var14 = var23 + 4
        // goalY += move_centerY
      elif var21 >= 16.7 && YDistBackEdge > 45.36
        var14 = var23 + 4
        // goalY += move_centerY
        var13 = TopNX
      endif
...
if  var20 >= 13 && var20 <= 14 || var20 >= 24 && var20 <= 30
  ...
  var23 = TopNX
if Equal var20 13 || Equal var20 14
elif !(True)
  elif True
...
elif Equal var20 13 || Equal var20 14
  elif True
if  var20 >= 13 && var20 <= 14 || var20 >= 24 && var20 <= 30
...
if  var20 >= 0 && var20 <= 1 || var20 >= 3 && var20 <= 8 || var20 >= 11 && var20 <= 12
    var23 = TopNX + 34 * OPos
    var22 = var17 - var23
    Abs var22
