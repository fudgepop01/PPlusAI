...
if Equal CurrAction 16
  ...
  Goto handleNSpecial
  Return
elif Equal CurrAction 284 || Equal CurrAction 285
  Goto handleSSpecial
  Return
...
if YDistBackEdge < 0
  ...
  if YDistBackEdge < 49.36 && var2 <= 15 && NumJumps > 0
    Button X
    Goto handleJumpToStage
    Return
  endif
  if Equal var4 1 || var5 <= 0.4 && NumJumps > 0
    if YDistBackEdge > 47.36 && Rnd < 0.5
      Button X
      Goto handleJumpToStage
      Return
    endif
  endif
  if YDistBackEdge > 58.36 || var17 < 18
  ...
  if var2 <= 100 && YDistBackEdge > 35 && Equal var4 0
    var4 = 1
    Button B
    ClearStick
    AbsStick 0 (0.7)
