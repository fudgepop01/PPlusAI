...
if  Equal var20 14 || Equal var20 17 || var20 >= 23 && var20 <= 24 || var20 >= 30 && var20 <= 36
  ...
  if OTopNY >= TopNY
    if YDistFloor < 2 && YDistFloor > 0
      ...
      var23 = TopNY + 36.48 //- var1
      var17 -= 18.24
      if var23 > var17 && NumJumps > 0 && OTopNY > TopNY
        var14 = var23 + 4
        // goalY += move_centerY
      elif var21 >= 16.7 && YDistBackEdge > 28.479999999999997
        var14 = var23 + 4
        // goalY += move_centerY
        var13 = TopNX
      endif
...
if  var20 >= 0 && var20 <= 1 || var20 >= 3 && var20 <= 9 || var20 >= 12 && var20 <= 13 || Equal var20 16
    var23 = TopNX + 33 * OPos
    var22 = var17 - var23
    Abs var22
