...
if Equal var20 3 || Equal var20 4
  Seek execDA
  Jump
elif Equal var20 17 || Equal var20 18 || Equal var20 19 || Equal var20 20 || Equal var20 21
  MOD var22 GameTimer 3
...
label jab123_2
Goto PFC
  if Equal CurrSubaction 72 && AnimFrame >= 5 && Rnd <= 0.8
    Button A
  endif
Goto common_checks
Seek jab123_2
...
Goto PFC
  if Equal CurrSubaction 72 && AnimFrame >= 5 && Rnd <= 0.8
    Button A
  elif Equal CurrSubaction 73 && AnimFrame >= 5 && Rnd <= 0.6
    Button A
  endif
Goto common_checks
Seek jab123_3
...
label ftilt_2
Goto PFC
  if Equal CurrSubaction 80 && AnimFrame >= 3 && Rnd <= 0.8
    Button A
  endif
Goto common_checks
Seek ftilt_2
...
label fsmash_2
Goto PFC
  if Equal CurrSubaction 88 && AnimFrame >= 17 && Rnd <= 0.8
    Button A
  endif
Goto common_checks
Seek fsmash_2
...
label usmash
Goto PFC
  if Equal CurrAction 48 || Equal CurrAction 50
    var23 = OTopNX - TopNX
    var23 /= 31.900
    AbsStick var23
  endif
...
if AnimFrame >= 2 && AnimFrame <= 7 && !(Equal Direction OPos)
  ...
  if Equal CurrAction 274 && AnimFrame > 20
    PredictOMov var23 14
    if var23 > 0.12 && XDistLE 35
      Button R|B
    elif XDistLE 45
      var23 = OTopNY - TopNY
      if var23 > 15
