...
if YDistBackEdge < 0
  ...
  if var2 <= 15 && YDistBackEdge > 35 && Equal var4 0 && Equal var16 0 && Equal var22 -1 
    var4 = 1
    Button B
    ClearStick
    AbsStick 0 (0.7)
  ...
  if YDistBackEdge < -20 && var2 > 15 && var10 < 0.8
    Button B
    ClearStick
    Stick 1 0
    Return
  ...
  if YDistBackEdge > -40 && YDistBackEdge < -10 && var8 < 0.8 
    Button B
    ClearStick
    Stick 0 (-0.7)
    Return
