...
DynamicDiceAdd 1 17 0.3333333333333333
DynamicDiceAdd 1 18 0.3333333333333333
DynamicDiceAdd 1 19 0.3333333333333333
else
DynamicDiceClear 0
...
if Equal var20 16 || Equal var20 17 || Equal var20 18 || Equal var20 19
...
if Equal var20 8
        Return
elif Equal var20 10 || Equal var20 11
        Return
      endif
    endif
...
elif Equal var20 24 || Equal var20 25
...
var11 = var22
  var22 = STACK_POP
  if Equal var11 1
elif Equal var20 16 || Equal var20 17 || Equal var20 18 || Equal var20 19
        var22 = 1
        var10 *= -1
      elif OYDistFloor < 0
