...
// jab123; 0
label jab123
  SetVarAttackData 3.06 -0.32 5.33 3.44 2 1 15 3 1 20 100
  var22 = 70
  Return
// jab123_2; 1
label jab123_2
  SetVarAttackData 1.19 -2.7 8.42 3.88 4 4 24 2 1 20 100
  var22 = 65
  Return
// jab123_3; 2
label jab123_3
  SetVarAttackData 1.72 1.62 9.57 13.47 4 2 25 6 0 40 80
  var22 = 361
  Return
// dashattack; 3
label dashattack
  SetVarAttackData 2.66 -0.78 8.08 5.49 5 3 41 9 0 40 100
  var22 = 361
  Return
// dashattack_weak; 4
label dashattack_weak
  SetVarAttackData 2.66 -0.78 17.13 5.87 5 17 41 7 0 25 100
  var22 = 60
  Return
// ftilt; 5
label ftilt
  SetVarAttackData -1.64 -0.67 10.23 4.14 4 2 19 8 0 10 120
  var22 = 361
  Return
// utilt; 6
label utilt
  SetVarAttackData -6.37 -5.22 7.24 9.88 5 3 17 6 0 25 100
  var22 = 86
  Return
// dtilt; 7
label dtilt
  SetVarAttackData 0.02 1.05 8.11 3.73 5 7 21 7 0 43 112
  var22 = 75
  Return
// fsmash; 8
label fsmash
  SetVarAttackData -0.39 -1.3 12.5 6.03 13 3 49 16 0 25 104
  var22 = 361
  Return
// usmash; 9
label usmash
  SetVarAttackData -13.14 1.06 13.14 21.36 15 4 64 14 0 75 95
  var22 = 95
  Return
// dsmash; 10
label dsmash
  SetVarAttackData -16.7 0.5 16.9 4.33 17 19 52 6 0 55 125
  var22 = 110
  Return
// nspecialair; 11
label nspecialair
  SetVarAttackData 6.626 2.948 35.254 9.997 18 8 34 -2 0 0 100
  var22 = 20
  Return
// uspecial; 12
label uspecial
  SetVarAttackData 23.1 -54.27 10.85 11.64 30 2 52 9 0 60 103
  var22 = 83
  Return
// uspecialair; 13
label uspecialair
  SetVarAttackData 23.26 -57.15 10.82 11.64 35 2 117 9 0 60 103
  var22 = 83
  Return
// dspecial; 14
label dspecial
  SetVarAttackData 4.16 -0.33 15.51 4.43 11 14 37 3 1 80 100
  var22 = 360
  Return
// dspecialair; 15
label dspecialair
  SetVarAttackData 3.49 3.37 10.35 10.34 11 11 51 3 0 20 100
  var22 = 35
  Return
// sspecial; 16
label sspecial
  SetVarAttackData -2.73 -0.59 2.72 2.75 5 2 44 15 0 40 110
  var22 = 80
  Return
// sspecialair; 17
label sspecialair
...
// grab; 18
label grab
  SetVarAttackData 2.61 -2.6 5.65 3.7 7 0 32 0 0 0 0
  var22 = 0
  Return
// fthrow; 19
label fthrow
  SetVarAttackData 2.61 -2.6 5.65 3.7 7 10 31 4 0 76 42
  var22 = 55
  Return
// dthrow; 20
label dthrow
  SetVarAttackData 2.61 -2.6 5.65 3.7 7 12.5 50 12 0 60 100
  var22 = 55
  Return
// bthrow; 21
label bthrow
  SetVarAttackData 2.61 -2.6 5.65 3.7 7 11 43 5 0 60 100
  var22 = 135
  Return
// uthrow; 22
label uthrow
  SetVarAttackData 2.61 -2.6 5.65 3.7 7 9.5 58 5 0 64 80
  var22 = 75
  Return
// nair; 23
label nair
  SetVarAttackData -6.91 3.18 6.49 6.86 5 14 31 11 0 0 100
  var22 = 30
  Return
// fair; 24
label fair
  SetVarAttackData -0.78 -0.3 5.91 4.96 5 1 33 13 0 35 100
  var22 = 361
  Return
// fair_weak; 25
label fair_weak
  SetVarAttackData -0.78 -0.3 5.91 4.96 5 6 33 7 0 35 100
  var22 = 361
  Return
// bair; 26
label bair
  SetVarAttackData -13.75 1.17 7.23 4.94 5 3 38 12 0 16 100
  var22 = 361
  Return
// bair_weak; 27
label bair_weak
  SetVarAttackData -13.75 1.17 7.23 4.94 5 17 38 8 0 16 100
  var22 = 361
  Return
// uair; 28
label uair
  SetVarAttackData -8.01 -3.6 9.75 8.39 5 3 24 11 0 40 100
  var22 = 77
  Return
// uair_weak; 29
label uair_weak
  SetVarAttackData -9.88 -3.6 10.68 8.39 5 7 24 6 0 50 60
  var22 = 90
  Return
// dair; 30
label dair
  SetVarAttackData -4.48 6.47 6.29 7.4 25 2 38 5 0 45 100
  var22 = 67
  Return
endif
Return
...
//   {RECOVERY_ADDITIONS}
  ...
  var22 = 0
if  Equal var20 11 || Equal var20 13 || Equal var20 15 || Equal var20 17 || var20 >= 23 && var20 <= 30
    var22 = 1
  endif
...
if Equal var20 26 || Equal var20 27
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 3 || Equal var20 4 || Equal var20 5 || Equal var20 7 || Equal var20 8 || Equal var20 11 || Equal var20 12 || Equal var20 13 || Equal var20 14 || Equal var20 15 || Equal var20 18 || Equal var20 19 || Equal var20 20 || Equal var20 21 || Equal var20 22 || Equal var20 24 || Equal var20 25
  var22 = 1
else
  var22 = 0
endif
    ...
    if !(True)
      label shuffle_AI
        ...
        if Rnd < var22
          ...
          ADJUST_PERSONALITY 0 4.800000000000001 Rnd
          ADJUST_PERSONALITY 3 2.02 Rnd
          ADJUST_PERSONALITY 10 0.4 Rnd
          ...
          if Rnd < 0.25
            ...
            ADJUST_PERSONALITY 2 1.4 Rnd
          endif
          if Rnd < 0.25
            ADJUST_PERSONALITY 7 -1 PT_JUMPINESS
            ADJUST_PERSONALITY 7 0.6000000000000001 Rnd
          endif
          if Rnd < 0.25
