...
if Equal CanCancelAttack 1
  if {{Equal CurrAction 16} || {Equal CurrAction 276 || Equal CurrAction 297 || Equal CurrAction 299} || {Equal CurrAction 274 || Equal CurrAction 279 || Equal CurrAction 280} || {Equal CurrAction 275 || Equal CurrAction 281} || {Equal CurrAction 277 || Equal CurrAction 300}}
    Seek postMoveCheck
    Jump
  endif
endif
...
var22 = 50
DrawDebugRectOutline var17 50 120 100 0 255 0 170
if var2 > 30 && var2 < 150 && var1 < 0 && var3 > -100
...
var22 = -60
DrawDebugRectOutline var17 -60 41 20 0 0 255 170
if var2 > 10 && var2 < 51 && var1 < 70 && var3 > 50
...
var22 = -60
DrawDebugRectOutline var17 -60 51 20 255 255 0 170
if var2 > 0 && var2 < 51 && var1 < 70 && var1 > 50
      DynamicDiceAdd 0 20 50
    endif
    if NumJumps > 0
var23 = Width * -0.5
...
var22 = -110
DrawDebugRectOutline var17 -110 51 80 255 0 255 170
if var2 > 0 && var2 < 51 && var1 < 150 && var1 > 70
        DynamicDiceAdd 0 10 50
      endif
    endif
  endif
  var23 = TopNY - BBoundary
  if var23 > 20 && var1 < 110
  else
    DynamicDiceClear 0
