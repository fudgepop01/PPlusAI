...
// jab123; 0
label jab123
  SetVarAttackData 3.46 -3 6.83 3.98 2 1 17 4 0 0 100
  var22 = 70
  Return
// dashattack; 1
label dashattack
  SetVarAttackData 9.63 -0.29 10.3 5.4 4 13 35 7 0 35 90
  var22 = 72
  Return
// ftilt; 2
label ftilt
  SetVarAttackData -0.84 -3.69 8.9 3.76 5 3 26 9 0 0 100
  var22 = 361
  Return
// utilt; 3
label utilt
  SetVarAttackData -10.86 1.44 10.16 9.97 5 6 24 12 0 18 140
  var22 = 110
  Return
// dtilt; 4
label dtilt
  SetVarAttackData 7.74 1.43 6.46 3.51 7 2 27 10 0 25 125
  var22 = 80
  Return
// fsmash; 5
label fsmash
  SetVarAttackData 12.37 -3.48 8.75 6.92 9 4 36 15 0 10 105
  var22 = 361
  Return
// usmash; 6
label usmash
  SetVarAttackData 2.22 -0.72 6.04 9.82 5 2 39 17 0 26 108
  var22 = 80
  Return
// dsmash; 7
label dsmash
  SetVarAttackData -13.68 3.73 12.51 5.35 7 4 46 15 0 20 65
  var22 = 25
  Return
// nspecialair; 8
label nspecialair
  SetVarAttackData 0 5 200 10 10 20 31 -3 0 0 0
  var22 = 0
  Return
// dspecial; 9
label dspecial
  SetVarAttackData -8 1.5 8 8 1 0 5 5 1 80 100
  var22 = 1
  Return
// dspecialair; 10
label dspecialair
  SetVarAttackData -8 1.5 8 8 1 0 5 5 0 55 35
  var22 = 20
  Return
// grab; 11
label grab
  SetVarAttackData 1.77 -2.84 5.2 3.91 7 0 32 0 0 0 0
  var22 = 0
  Return
// fthrow; 12
label fthrow
  SetVarAttackData 1.77 -2.84 5.2 3.91 7 8.5 35 3 0 35 130
  var22 = 45
  Return
// dthrow; 13
label dthrow
  SetVarAttackData 1.77 -2.84 5.2 3.91 7 19.5 45 1 0 150 40
  var22 = 270
  Return
// bthrow; 14
label bthrow
  SetVarAttackData 1.77 -2.84 5.2 3.91 7 7.5 40 2 0 80 85
  var22 = 56
  Return
// uthrow; 15
label uthrow
  SetVarAttackData 1.77 -2.84 5.2 3.91 7 6.5 40 2 0 75 110
  var22 = 90
  Return
// nair; 16
label nair
  SetVarAttackData -3.77 -0.08 6.62 4.45 4 3 41 12 0 10 100
  var22 = 361
  Return
// nair_weak; 17
label nair_weak
  SetVarAttackData -3.75 -0.03 6.66 4.77 8 23 41 9 0 0 100
  var22 = 361
  Return
// fair; 18
label fair
  SetVarAttackData -0.95 -3.34 7.98 5.59 6 2 52 7 0 10 100
  var22 = 361
  Return
// bair; 19
label bair
  SetVarAttackData -13.41 -1.38 9.53 6.72 4 3 37 15 0 0 100
  var22 = -361
  Return
// bair_weak; 20
label bair_weak
  SetVarAttackData -13.34 -1.15 9.54 6.8 8 11 37 9 0 0 100
  var22 = 361
  Return
// uair; 21
label uair
  SetVarAttackData -5.05 -4.33 5.88 8.25 11 3 35 13 0 40 116
  var22 = 85
  Return
// uair_weak; 22
label uair_weak
  SetVarAttackData -4.33 -5.6 5.11 7.12 8 1 35 4 1 30 120
  var22 = 92
  Return
// dair; 23
label dair
  SetVarAttackData -4.34 2.33 6.96 7.08 5 19 51 2 1 30 100
  var22 = 290
  Return
endif
Return
...
//   {RECOVERY_ADDITIONS}
  ...
  var22 = 0
if  Equal var20 8 || Equal var20 10 || var20 >= 16 && var20 <= 23
    var22 = 1
  endif
  ...
  // chr get_moveDir
if Equal var20 3 || Equal var20 7 || Equal var20 19 || Equal var20 20
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 4 || Equal var20 5 || Equal var20 6 || Equal var20 8 || Equal var20 11 || Equal var20 12 || Equal var20 13 || Equal var20 14 || Equal var20 15 || Equal var20 18
  var22 = 1
else
  var22 = 0
endif
