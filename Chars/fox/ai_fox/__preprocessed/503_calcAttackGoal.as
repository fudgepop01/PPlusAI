...
if !(Equal var22 2) && !(CalledAs FastAerial) && Equal var21 16 && OFramesHitstun <= 0 && Equal var23 0
  ...
  elif !(Equal var22 3) && Rnd < var17 && Rnd < 0.48 && SamePlane
    var21 = 16.3
  endif
endif
...
//   {SPACING_MOVES}
  ...
  if Rnd < 0.48 && OYDistBackEdge > -30 && OFramesHitstun <= 0 && Equal HitboxConnected 0 && SamePlane && OFramesHitstun <= 0
    var21 = 16.3
  endif
elif Equal var7 10
DynamicDiceAdd 11
...
elif Rnd < 0.4 && Equal var21 16 && SamePlane && OFramesHitstun <= 0
  var22 = TopNX
  var17 = OTopNX
  Abs var22
  Abs var17
