  ...
  if Equal var22 1
    ...
    if !(Equal var21 10.2) && !(Equal var21 10.5)
      ...
      if Equal var22 1 && Rnd < var23
        ...
        var22 = 1
        Return
      elif Equal var22 2 && Rnd < var23 && Rnd < 0.85
        var22 = 1
      else
        var22 = 0
      endif
      ...
      var22 += 45
      var23 = var22 - 20
      if XDistLE var22 && !(XDistLE var23) && Rnd < 0.1875 && Equal var3 0
        if Rnd < 0.425
          if Rnd < 0.30000000000000004
            var21 = 16.3
          else  
            var21 = 10.1
          endif
    ...
    if ODistLE var22 && !(Equal var1 -1)
      ...
      if Equal AirGroundState 1
        ...
        DynamicDiceAdd 7
        if Equal var23 -1
        elif Equal var1 1 && Rnd < 0.44999999999999996
          DynamicDiceAdd 6
          DynamicDiceAdd 6
          if Rnd < 0.3375
            var16 = 1
            var16 += 0.1
            if Rnd < 0.44999999999999996
              var21 = 16
            endif
            Call JumpScr
          endif
        ...
        if Equal var22 1
          ...
          Goto getDist
          if Rnd < 0.44999999999999996 && var22 <= 30
            var21 = 16
          endif
          Call JumpScr
        elif Equal var22 3
      ...
      elif NumJumps > 0 && Rnd < 0.1 && Rnd < 0.1 && OYDistBackEdge > -20
        var16 = 1
        if Rnd < 0.5
          var16 = 3
        endif
  ...
  if Equal var23 -1
    ...
    if !(Equal var21 16.3) && !(Equal var21 16.2)
      if Rnd < 0.30000000000000004
        ...
        var20 = -1
        Return
      elif Rnd < 0.22499999999999998 || Rnd < 0.105
        var21 = 10.5
        var20 = -1
        Return
      endif
...
LOGSTR 1145137408 1912602624 0 0 0
  ...
  elif Equal var2 1 && Equal var1 0 && Rnd > 0.425 && Equal AirGroundState 1 && !(Equal var21 16.5)
    var21 = 10.5
    Return
  endif
  ...
  var22 += 30
  if !(ODistLE var22) && Rnd < 0.35 && Rnd < 0.35 && OFramesHitstun <= 0 && !(Equal var21 16.5)
    var21 = 7
    Return
  endif
  ...
  // otherwise carry on as normal
    ...
    if OAnimFrame <= 9 || Equal CurrAction 10 || Equal OCurrAction 73 || OFramesHitstun > 1 || Equal HitboxConnected 1
      ...
      elif Equal var23 -1 && Rnd > 0.75 && Rnd > 0.75
        var21 = 10.5
        Return
      endif
...
var23 = var0 * 1.25
var22 += var23 + 10
if var0 >= 10 && ODistLE var22 && OFramesHitstun <= 0 && Rnd < 0.75
