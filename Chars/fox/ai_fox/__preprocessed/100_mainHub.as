...
if Equal var15 -1
  ...
  CallI ExecuteAttack
elif Equal var21 16.3 && Rnd < 0.5599999999999999 && Rnd > 0.2975 && OCurrAction <= 21
  label empty_1
  Goto PFC
  XReciever
  Seek empty_1
  ...
  var0 -= 1
  Return
elif Equal var21 7.1 && Rnd < 0.45499999999999996 && Rnd < 0.75
  label empty_2
  Goto PFC
  XReciever
  Seek empty_2
...
if Rnd < 0.75
  ...
  if var22 > 0.4 || Rnd < 0.26249999999999996
    DynamicDiceAdd 16
  endif
endif
