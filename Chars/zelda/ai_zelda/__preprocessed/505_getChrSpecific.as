...
// jab123; 0
label jab123
  SetVarAttackData 2 -5.13 9.02 6.17 9 4 21 3 0 35 110
  var22 = 361
  Return
// dashattack; 1
label dashattack
  SetVarAttackData 9.4 -4.17 12.63 5.92 6 11 35 13 0 70 70
  var22 = 88
  Return
// ftilt; 2
label ftilt
  SetVarAttackData -5.15 -6.23 14.18 4.81 10 6 31 13 0 50 80
  var22 = 110
  Return
// utilt; 3
label utilt
  SetVarAttackData 0.7 -4.42 6.66 9.25 8 3 39 15 0 40 110
  var22 = 75
  Return
// utilt_late; 4
label utilt_late
  SetVarAttackData -14.57 -0.06 13.57 13.04 12 16 39 13 0 30 120
  var22 = 85
  Return
// dtilt; 5
label dtilt
  SetVarAttackData -1.03 5.04 8.92 5.95 5 3 24 10 0 30 55
  var22 = 80
  Return
// fsmash; 6
label fsmash
  SetVarAttackData 1.76 -3.13 9.62 5.73 17 8 48 13 0 35 120
  var22 = 361
  Return
// usmash; 7
label usmash
  SetVarAttackData -9.57 -3.95 9.57 9.6 6 29 51 4 0 20 240
  var22 = 88
  Return
// dsmash; 8
label dsmash
  SetVarAttackData 4.03 2.42 5.55 5.44 5 1 32 12 0 20 90
  var22 = 30
  Return
// dsmash_hit2; 9
label dsmash_hit2
  SetVarAttackData -12.49 0.55 6.25 5.59 12 3 32 13 0 20 90
  var22 = 25
  Return
// nspecial; 10
label nspecial
  SetVarAttackData -19.05 0.77 19.05 8.15 9 15 57 4 0 50 130
  var22 = 361
  Return
// nspecialair; 11
label nspecialair
...
// sspecial; 12
label sspecial
  SetVarAttackData 20 40 80 40 50 0 50 -7 0 50 90
  var22 = 80
  Return
// sspecialair; 13
label sspecialair
...
// grab; 14
label grab
  SetVarAttackData 0 -4 7.25 5 7 0 32 0 0 0 0
  var22 = 0
  Return
// fthrow; 15
label fthrow
  SetVarAttackData 0 -4 7.25 5 7 17 49 10 0 60 50
  var22 = 60
  Return
// dthrow; 16
label dthrow
  SetVarAttackData 0 -4 7.25 5 7 48 64 2 0 80 42
  var22 = 120
  Return
// bthrow; 17
label bthrow
  SetVarAttackData 0 -4 7.25 5 7 27 51 11 0 80 87
  var22 = 135
  Return
// uthrow; 18
label uthrow
  SetVarAttackData 0 -4 7.25 5 7 28 51 8 0 80 66
  var22 = 90
  Return
// nair; 19
label nair
  SetVarAttackData -11 4.5 11 11 6 21 41 5 0 15 175
  var22 = 361
  Return
// fair; 20
label fair
  SetVarAttackData 5.59 1.11 5.69 5.16 8 3 35 19 0 25 100
  var22 = 40
  Return
// fair_weak; 21
label fair_weak
  SetVarAttackData -2.75 -0.59 6.37 4.03 8 3 35 8 0 0 95
  var22 = 361
  Return
// bair; 22
label bair
  SetVarAttackData -16.61 0.14 5.84 5.27 5 3 32 18 0 30 105
  var22 = -361
  Return
// bair_weak; 23
label bair_weak
  SetVarAttackData -9.85 -1.2 6.55 3.92 5 3 32 8 0 0 95
  var22 = -361
  Return
// uair; 24
label uair
  SetVarAttackData -6 -2.18 7.5 13.53 10 7 48 17 0 32 105
  var22 = 90
  Return
// dair; 25
label dair
  SetVarAttackData -2.85 10.4 4.73 4.71 14 1 39 16 0 50 117
  var22 = 275
  Return
// dair_weak; 26
label dair_weak
  SetVarAttackData -3.07 10.33 4.86 7.71 14 3 39 9 0 10 85
  var22 = 275
  Return
endif
Return
...
if  Equal var20 11 || Equal var20 13 || var20 >= 19 && var20 <= 26
  ...
  // chr get_moveDir
if Equal var20 4 || Equal var20 9 || Equal var20 22 || Equal var20 23
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 3 || Equal var20 5 || Equal var20 6 || Equal var20 8 || Equal var20 12 || Equal var20 13 || Equal var20 14 || Equal var20 15 || Equal var20 16 || Equal var20 17 || Equal var20 18 || Equal var20 20
  var22 = 1
else
  var22 = 0
endif
  ...
  // chr get_moveDirY
if Equal var20 13 || Equal var20 25 || Equal var20 26
  var22 = -1
elif !(True)
  var22 = 1
else
