...
// jab123; 0
label jab123
  SetVarAttackData 2.83 -0.28 8.13 6.48 5 1 19 0 0 0 0
  var22 = 0
  Return
// jab123_2; 1
label jab123_2
  SetVarAttackData 6.7 -4.41 7.13 3.54 5 1 20 3 1 70 40
  var22 = 60
  Return
// jab123_3; 2
label jab123_3
  SetVarAttackData -0.33 -2.68 9.3 10.58 3 4 31 5 0 50 70
  var22 = 361
  Return
// dashattack; 3
label dashattack
  SetVarAttackData 14.82 -2.33 5.8 4.18 7 2 33 12 0 20 100
  var22 = 70
  Return
// ftilt; 4
label ftilt
  SetVarAttackData 4 -0.33 9.63 7.22 10 3 30 13 0 45 70
  var22 = 361
  Return
// utilt; 5
label utilt
  SetVarAttackData -4.79 -5.82 5.86 11.65 5 9 26 7 0 40 100
  var22 = 90
  Return
// dtilt; 6
label dtilt
  SetVarAttackData 3.89 0.38 8 4.2 7 2 25 12 0 50 70
  var22 = 80
  Return
// fsmash; 7
label fsmash
  SetVarAttackData 0.05 -1.82 9.82 7.44 11 2 34 9 0 50 0
  var22 = 80
  Return
// fsmash2; 8
label fsmash2
  SetVarAttackData -3.41 -1.7 13.36 7.44 10 3 46 12 0 30 125
  var22 = 361
  Return
// usmash; 9
label usmash
  SetVarAttackData -13.05 -8.21 14.22 9.4 20 6 54 10 0 55 120
  var22 = 80
  Return
// dsmash; 10
label dsmash
  SetVarAttackData 0.3 1.36 9.32 5.4 7 2 42 13 0 40 94
  var22 = 361
  Return
// dsmash_hit2; 11
label dsmash_hit2
  SetVarAttackData -18.4 -0.5 9.29 5.03 20 2 42 13 0 20 94
  var22 = 361
  Return
// nspecial; 12
label nspecial
  SetVarAttackData -500 200 1000 1000 14 21 45 -3 0 5 65
  var22 = 361
  Return
// nspecialair; 13
label nspecialair
...
// uspecial; 14
label uspecial
  SetVarAttackData -4.72 -26.35 4.49 6.73 8 1 49 14 0 50 100
  var22 = 100
  Return
// uspecialair; 15
label uspecialair
  SetVarAttackData -7.9 -23.1 6.87 29.35 8 8 49 14 0 50 100
  var22 = 100
  Return
// sspecial; 16
label sspecial
  SetVarAttackData 3.381 13.795 17.708 16.18 20 5 17 0 0 0 0
  var22 = 0
  Return
// sspecialair; 17
label sspecialair
...
// grab; 18
label grab
  SetVarAttackData 1.63 -4.24 6.56 3.92 7 0 32 0 0 0 0
  var22 = 0
  Return
// fthrow; 19
label fthrow
  SetVarAttackData 1.63 -4.24 6.56 3.92 7 9.5 33 4 0 30 150
  var22 = 45
  Return
// dthrow; 20
label dthrow
  SetVarAttackData 1.63 -4.24 6.56 3.92 7 11 37 4 0 65 70
  var22 = 67
  Return
// bthrow; 21
label bthrow
  SetVarAttackData 1.63 -4.24 6.56 3.92 7 15 46 8 0 50 60
  var22 = 135
  Return
// uthrow; 22
label uthrow
  SetVarAttackData 1.63 -4.24 6.56 3.92 7 9.5 44 7 0 70 65
  var22 = 80
  Return
// nair; 23
label nair
  SetVarAttackData -5.97 0.96 9.87 10.09 4 17 41 3 0 40 100
  var22 = 361
  Return
// nair_strong; 24
label nair_strong
  SetVarAttackData -5.54 0.69 8.1 8.12 19 2 41 3 0 40 100
  var22 = 361
  Return
// fair; 25
label fair
  SetVarAttackData -3.65 -2.38 11.02 4.84 9 2 30 15 0 0 90
  var22 = 361
  Return
// bair; 26
label bair
  SetVarAttackData -17.92 -3.34 9.31 4.12 9 1 40 14 0 25 100
  var22 = 37
  Return
// bair_weak; 27
label bair_weak
  SetVarAttackData -17.92 -2.79 9.31 4.54 9 13 40 6 0 15 85
  var22 = 361
  Return
// uair; 28
label uair
  SetVarAttackData -8.86 -10.25 9.86 5.84 9 11 35 11 0 15 100
  var22 = 75
  Return
// dair; 29
label dair
  SetVarAttackData -13.03 9.21 12.96 10.17 9 4 38 12 0 35 99
  var22 = 75
  Return
// dair_spike; 30
label dair_spike
  SetVarAttackData 2.92 3.36 5.26 8.71 12 1 38 12 0 40 50
  var22 = 300
  Return
endif
Return
...
//   {RECOVERY_ADDITIONS}
  ...
  var22 = 0
if  Equal var20 13 || Equal var20 15 || Equal var20 17 || var20 >= 23 && var20 <= 30
    var22 = 1
  endif
...
if Equal var20 11 || Equal var20 26 || Equal var20 27
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 3 || Equal var20 4 || Equal var20 6 || Equal var20 7 || Equal var20 8 || Equal var20 10 || Equal var20 12 || Equal var20 13 || Equal var20 16 || Equal var20 17 || Equal var20 18 || Equal var20 19 || Equal var20 20 || Equal var20 21 || Equal var20 22 || Equal var20 25 || Equal var20 30
  var22 = 1
else
  var22 = 0
endif
...
if Equal var20 29
  var22 = -1
elif Equal var20 9 || Equal var20 14 || Equal var20 15 || Equal var20 28
  var22 = 1
else
  var22 = 0
endif
