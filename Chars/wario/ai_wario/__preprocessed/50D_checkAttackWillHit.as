  ...
  if OTopNY >= TopNY
    if Equal AirGroundState 1 || {YDistFloor < 2 && YDistFloor > 0}
      ...
      if var23 > var17 && NumJumps > 0 && OTopNY > TopNY
        var14 = var23 + 4
        // goalY += move_centerY
      elif var21 >= 16.7 && YDistBackEdge > 24
        var14 = var23 + 4
        // goalY += move_centerY
        var13 = TopNX
      endif
...
if  Equal var20 12 || Equal var20 15 || var20 >= 21 && var20 <= 28
  ...
  var23 = TopNX
if Equal var20 12 || Equal var20 13 || Equal var20 14 || Equal var20 15 || Equal var20 28
  elif True
...
if  var20 >= 0 && var20 <= 1 || var20 >= 4 && var20 <= 8 || Equal var20 10
    var23 = TopNX + 24 * OPos
    var22 = var17 - var23
    Abs var22
