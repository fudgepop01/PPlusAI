...
if Equal CanCancelAttack 1
  if {{Equal CurrAction 16} || {Equal CurrAction 276 || Equal CurrAction 302} || {Equal CurrAction 274} || {Equal CurrAction 275 || Equal CurrAction 289 || Equal CurrAction 290 || Equal CurrAction 294 || Equal CurrAction 300} || {Equal CurrAction 277}}
    Seek postMoveCheck
    Jump
  endif
endif
...
if CurrAction >= 98 && CurrAction <= 108 && AnimFrame < 8
  ...
  Goto handleSFall
  var17 = 1
elif Equal CurrAction 276 || Equal CurrAction 302
  Goto handleUSpecial
  var17 = 1
elif Equal CurrAction 274
  Goto handleNSpecial
  var17 = 1
elif Equal CurrAction 275 || Equal CurrAction 289 || Equal CurrAction 290 || Equal CurrAction 294 || Equal CurrAction 300
  Goto handleSSpecial
  var17 = 1
...
var22 = -42.5
DrawDebugRectOutline var17 -42.5 47 15 0 255 0 170
if var2 > 0 && var2 < 47 && var1 < 50 && var1 > 35
    DynamicDiceClear 0
...
var22 = 15
DrawDebugRectOutline var17 15 35 50 0 0 255 170
if var2 > 15 && var2 < 50 && var1 < 10 && var1 > -40
      DynamicDiceAdd 0 30 6
    endif
  endif
  
  DynamicDiceSize 0 var22
  if var22 < 2
    GetLaBasic var23 66 0
    if var23 >= 3
var23 = Width * -0.5
var23 += 50
var17 = var0 - var23 + CenterX
...
var22 = -115
DrawDebugRectOutline var17 -115 100 150 255 255 0 170
if var2 > 0 && var2 < 100 && var1 < 190 && var3 > 40
        DynamicDiceAdd 0 40 40
      endif
    elif var23 >= 2
var23 = Width * -0.5
var23 += 50
...
var22 = -105
DrawDebugRectOutline var17 -105 100 150 255 0 255 170
if var2 > 0 && var2 < 100 && var1 < 180 && var3 > 30
        DynamicDiceAdd 0 40 40
      endif
    endif
  endif
