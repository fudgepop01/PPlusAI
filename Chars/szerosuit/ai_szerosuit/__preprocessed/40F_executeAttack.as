...
Goto PFC
  if Equal CurrSubaction 72 && AnimFrame >= 8 && Rnd <= 0.8
    Button A
  elif Equal CurrSubaction 73 && AnimFrame >= 6 && Rnd <= 0.8
    Button A
  endif
Goto common_checks
Seek jab1233
...
if AnimFrame >= 2 && AnimFrame <= 7 && !(Equal Direction OPos)
  ...
  if Equal CurrSubaction 484 && AnimFrame >= 9
    Button A
  endif
Goto common_checks
Seek dspecial
...
label PFC
  XGoto PerFrameChecks
  //= XReciever
if !(True) || Equal var20 24|| Equal var20 25|| Equal var20 26|| Equal var20 27|| Equal var20 28|| Equal var20 29
