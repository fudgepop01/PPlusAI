...
if  Equal var20 11 || Equal var20 13 || Equal var20 15 || var20 >= 18 && var20 <= 19 || var20 >= 25 && var20 <= 30
  ...
  if OTopNY >= TopNY
    if YDistFloor < 2 && YDistFloor > 0
      ...
      var23 = TopNY + 30.72 //- var1
      var17 -= 15.36
      if var23 > var17 && NumJumps > 0 && OTopNY > TopNY
        var14 = var23 + 4
        // goalY += move_centerY
      elif var21 >= 16.7 && YDistBackEdge > 22.72
        var14 = var23 + 4
        // goalY += move_centerY
        var13 = TopNX
      endif
...
if  Equal var20 11 || Equal var20 13 || Equal var20 15 || var20 >= 18 && var20 <= 19 || var20 >= 25 && var20 <= 30
  ...
  var23 = TopNX
if Equal var20 11 || Equal var20 15
  elif True
...
if  var20 >= 0 && var20 <= 2 || var20 >= 4 && var20 <= 7 || var20 >= 9 && var20 <= 10 || Equal var20 14
    var23 = TopNX + 33 * OPos
    var22 = var17 - var23
    Abs var22
    ...
    if Equal CurrAction 3 && LevelValue >= 31
      ...
      var23 = TopNX + TotalXSpeed * (AnimFrame - 8 + 2)
      var22 = var17 - var23
      Abs var22
