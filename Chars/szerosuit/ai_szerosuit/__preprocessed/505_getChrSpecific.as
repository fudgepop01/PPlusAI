...
if Equal var22 19.1
  if var20 >= 0 && var20 < 31
    ...
    if !(True)
      ...
      Return
      label _sspecial_pullStr
      LOGSTR 1936945152 1701013760 1634492160 1886743552 1811939328
      Return
      label _sspecialairStr
      LOGSTR 1936945152 1701013760 1634492672 1769078784 0
      Return
      label _sspecialair_pullStr
      LOGSTR 1936945152 1701013760 1634492672 1769103104 1886743552
      Return
      label _grabStr
      ...
      Return
      label _nair_backStr
      LOGSTR 1851877632 1918853632 1633905408 0 0
      Return
      label _fairStr
...
// jab123; 0
label jab123
  SetVarAttackData 0.5 -5.5 6.5 4.15 2 1 16 3 0 0 100
  var22 = 70
  Return
// jab1232; 1
label jab1232
  SetVarAttackData 5.9 -6.15 5.35 3.85 10 1 26 3 0 0 100
  var22 = 70
  Return
// jab1233; 2
label jab1233
  SetVarAttackData 5.73 -6.25 5.61 4.8 17 1 33 5 0 50 70
  var22 = 361
  Return
// dashattack; 3
label dashattack
  SetVarAttackData 6.22 -4.94 12.74 4.31 6 9 35 10 0 50 64
  var22 = 361
  Return
// ftilt; 4
label ftilt
  SetVarAttackData 1.38 -5.47 7.8 4.48 6 2 28 9 0 18 100
  var22 = 35
  Return
// utilt; 5
label utilt
  SetVarAttackData -11.3 -5.77 11.3 10.12 3 9 38 8 0 50 100
  var22 = 90
  Return
// dtilt; 6
label dtilt
  SetVarAttackData 5.06 0.89 6.89 3.48 5 2 25 7 0 30 110
  var22 = 85
  Return
// fsmash; 7
label fsmash
  SetVarAttackData -4.8 -3.5 16.78 5.75 22 4 69 13 0 25 110
  var22 = 40
  Return
// usmash; 8
label usmash
  SetVarAttackData -7.017 -9.499 11.126 13.935 8 23 53 1 0 65 221
  var22 = 75
  Return
// dsmash; 9
label dsmash
  SetVarAttackData 3.65 1.35 9.85 5.35 21 4 39 11 0 75 20
  var22 = 70
  Return
// nspecial; 10
label nspecial
  SetVarAttackData 9 -2.85 45 15 21 69 58 -6 1 26 100
  var22 = 361
  Return
// nspecialair; 11
label nspecialair
...
// uspecial; 12
label uspecial
  SetVarAttackData -4.75 -3.5 9.774 29.759 7 17 41 6 0 60 45
  var22 = 281
  Return
// uspecialair; 13
label uspecialair
  SetVarAttackData -4.75 -32.5 9.774 15.216 16 8 41 6 0 60 45
  var22 = 281
  Return
// dspecial; 14
label dspecial
  SetVarAttackData -5 3.455 13.359 18.949 24 15 67 13 0 50 100
  var22 = 361
  Return
// dspecialair; 15
label dspecialair
  SetVarAttackData -5 41.3 27.466 37.872 24 15 95 13 0 50 100
  var22 = 361
  Return
// sspecial; 16
label sspecial
  SetVarAttackData 7.5 -5.5 9 2.5 24 1 52 4 0 69 0
  var22 = 20
  Return
// sspecial_pull; 17
label sspecial_pull
  SetVarAttackData 26.5 -3 5.5 5.5 30 3 52 9 0 80 50
  var22 = 110
  Return
// sspecialair; 18
label sspecialair
  SetVarAttackData 7.5 -5.5 9 2.5 24 1 45 4 0 69 0
  var22 = 20
  Return
// sspecialair_pull; 19
label sspecialair_pull
  SetVarAttackData 26.5 -3 5.5 5.5 30 3 45 9 0 80 50
  var22 = 110
  Return
// grab; 20
label grab
  SetVarAttackData 2.75 -6.25 5.88 3.75 7 0 29 0 0 0 0
  var22 = 0
  Return
// fthrow; 21
label fthrow
  SetVarAttackData 2.75 -6.25 5.88 3.75 7 15 36 7 0 63 50
  var22 = 40
  Return
// dthrow; 22
label dthrow
  SetVarAttackData 2.75 -6.25 5.88 3.75 7 31 55 2 0 68 78
  var22 = 65
  Return
// bthrow; 23
label bthrow
  SetVarAttackData 2.75 -6.25 5.88 3.75 7 11 33 4 0 70 60
  var22 = 135
  Return
// uthrow; 24
label uthrow
  SetVarAttackData 2.75 -6.25 5.88 3.75 7 7 39 4 0 65 115
  var22 = 85
  Return
// nair; 25
label nair
  SetVarAttackData -21.324 1.664 19.871 6.823 6 3 33 12 0 25 80
  var22 = 55
  Return
// nair_back; 26
label nair_back
  SetVarAttackData -21.324 -8.664 19.871 7.823 10 4 33 12 0 25 80
  var22 = 125
  Return
// fair; 27
label fair
  SetVarAttackData -2.86 -3.31 8.43 4.59 6 14 39 10 0 40 105
  var22 = 40
  Return
// bair; 28
label bair
  SetVarAttackData -16.81 -2.94 8.38 4.22 7 4 39 13 0 33 110
  var22 = -361
  Return
// uair; 29
label uair
  SetVarAttackData -12.98 -3.12 14.23 11.95 4 8 33 10 0 30 110
  var22 = 60
  Return
// dair; 30
label dair
  SetVarAttackData -4.94 5.61 4.35 6.79 12 5 31 12 0 70 35
  var22 = 90
  Return
endif
Return
...
//   {RECOVERY_ADDITIONS}
  ...
  var22 = 0
if  Equal var20 11 || Equal var20 13 || Equal var20 15 || var20 >= 18 && var20 <= 19 || var20 >= 25 && var20 <= 30
    var22 = 1
  endif
...
if Equal var20 28
  ...
  // chr get_moveDirY
if Equal var20 15 || Equal var20 30
  var22 = -1
elif Equal var20 13
  var22 = 1
else
