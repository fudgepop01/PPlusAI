...
if YDistFloor > -1 
  ...
  if var2 <= 13 && YDistBackEdge > 25 && Equal var16 0 && Equal var22 -1 
    Button B
    ClearStick
    AbsStick 0 (0.7)
    Return
  ...
  GetRaBit var23 18 0
  if Equal var23 1
    if YDistBackEdge < 80 && YDistBackEdge > -10 && var7 < 0.7
      Button B
      ClearStick
      Stick 1 0
      Return
    ...
    var22 = XSpeed
    Abs var22
    if YDistBackEdge < -20 && var2 > 15 && var10 < 0.8 && var22 > 1.5
      Button B
      ClearStick
      Stick 1 0
      Return
    endif
    if YDistBackEdge < 80 && YDistBackEdge > -10 && var2 > 15 && var7 < 0.7 && var22 > 1.5
      Button B
      ClearStick
      Stick 1 0
      Return
  ...
  if YDistBackEdge > -10 && var8 < 0.8 && Equal var23 0
    Button B
    ClearStick
    Stick 0 (-0.7)
    Return
  endif
  if var5 <= 0.6 && NumJumps > 0
    var22 = 21.84
    if !(NoOneHanging)
      var22 -= 20
    endif
  ...
  elif YDistBackEdge > 42.84 || var17 < 18
...
label handleSSpecial
  ...
  var1 += TopNY
    ...
    var2 = var0
    Abs var2
    if var9 < 0.6 && YDistBackEdge < -10 && YDistBackEdge > -45
