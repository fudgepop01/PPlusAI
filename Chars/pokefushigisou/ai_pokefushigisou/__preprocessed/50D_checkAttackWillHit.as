...
if  Equal var20 10 || Equal var20 12 || Equal var20 14 || Equal var20 16 || var20 >= 22 && var20 <= 30
  if OTopNY >= TopNY
    if Equal AirGroundState 1 || YDistFloor < 2 && YDistFloor > 0
      ...
      var23 = TopNY + 31.1 //- var1
      var17 -= 15.55
      if var23 > var17 && NumJumps > 0 && OTopNY > TopNY
        var14 = var23 + 4
        // goalY += move_centerY
      elif var21 >= 16.7 && YDistBackEdge > 23.1
        var14 = var23 + 4
        // goalY += move_centerY
        var13 = TopNX
      endif
...
if  var20 >= 0 && var20 <= 1 || var20 >= 3 && var20 <= 6 || var20 >= 8 && var20 <= 9 || Equal var20 13
    var23 = TopNX + 35 * OPos
    var22 = var10 - var23
    Abs var22
    ...
    if Equal CurrAction 3 && LevelValue >= 31
      ...
      var23 = TopNX + CharXSpeed * (AnimFrame - 9)
      var22 = var10 - var23
      Abs var22
