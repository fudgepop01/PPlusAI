...
var11 = var22
  ...
  GetLaFloat var23 27 0
  if var23 < 22 && !(XDistLE 65)
    Goto nspCheck
  elif NoOpponent && var23 >= 22
    Goto nspCheck
  endif
  if !(True)
    label nspCheck
...
label check_hub
  ...
  if YDistFloor < 20 && !(Equal YDistFloor -1) 
    var22 = 0
if Equal var20 22 || Equal var20 23
...
elif Equal var20 26 || Equal var20 27 || Equal var20 28
