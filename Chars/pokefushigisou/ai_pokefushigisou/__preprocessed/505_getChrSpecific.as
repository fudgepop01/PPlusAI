...
if Equal var22 19.1
  if var20 >= 0 && var20 < 31
    ...
    if !(True)
      ...
      Return
      label _uair_spikeStr
      LOGSTR 1969318144 1918857984 1885956864 1694498816 0
      Return
      label _uair_fallStr
      LOGSTR 1969318144 1918854656 1634495488 0 0
      Return
      label _dairStr
...
// jab123; 0
label jab123
  SetVarAttackData 2.66 3.23 9.53 7.44 2 2 15 3 1 20 100
  var22 = 97
  Return
// jab123_2; 1
label jab123_2
  SetVarAttackData 0.71 3.41 10.57 7.72 6 2 24 4 0 35 140
  var22 = 361
  Return
// dashattack; 2
label dashattack
  SetVarAttackData 3.94 1.26 13.83 7.42 4 16 34 12 0 80 70
  var22 = 70
  Return
// ftilt; 3
label ftilt
  SetVarAttackData 2.43 -0.48 14.68 5.18 5 9 35 5 0 20 130
  var22 = 361
  Return
// utilt; 4
label utilt
  SetVarAttackData -12.38 -1.2 14.19 14.6 9 6 28 9 0 40 105
  var22 = 90
  Return
// dtilt; 5
label dtilt
  SetVarAttackData 0.58 1.23 16.29 6.41 8 6 31 5 0 50 100
  var22 = 100
  Return
// fsmash; 6
label fsmash
  SetVarAttackData -6.69 0.75 20.66 6.8 16 4 60 15 0 30 100
  var22 = 361
  Return
// usmash; 7
label usmash
  SetVarAttackData -12 -1.25 12 13.63 14 6 49 12 0 50 100
  var22 = 70
  Return
// dsmash; 8
label dsmash
  SetVarAttackData -23.93 2.57 24.83 5.89 7 1 46 14 0 40 65
  var22 = 22
  Return
// nspecial; 9
label nspecial
  SetVarAttackData 5.263 -13.015 499.734 417.674 19 22 82 22 0 50 89
  var22 = 55
  Return
// nspecialair; 10
label nspecialair
...
// uspecial; 11
label uspecial
  SetVarAttackData 21.85 -28.24 5.97 6.98 21 4 49 15 0 80 80
  var22 = 50
  Return
// uspecialair; 12
label uspecialair
  SetVarAttackData 12.87 -22.37 12.62 9.27 21 4 49 15 0 80 80
  var22 = 50
  Return
// dspecial; 13
label dspecial
  SetVarAttackData -63.686 4 63.686 38.671 11 29 47 -10 0 75 75
  var22 = 77
  Return
// dspecialair; 14
label dspecialair
...
// sspecial; 15
label sspecial
  SetVarAttackData 4.51 -0.991 29.588 4.263 22 18 43 -3 0 0 100
  var22 = 60
  Return
// sspecialair; 16
label sspecialair
...
// grab; 17
label grab
  SetVarAttackData 1.5 -2.5 12.5 3.5 12 1 44 0 0 0 0
  var22 = 0
  Return
// fthrow; 18
label fthrow
  SetVarAttackData 1.5 -2.5 12.5 3.5 12 13.5 35 10 0 60 60
  var22 = 40
  Return
// dthrow; 19
label dthrow
  SetVarAttackData 1.5 -2.5 12.5 3.5 12 15 36 10 0 83 61
  var22 = 80
  Return
// bthrow; 20
label bthrow
  SetVarAttackData 1.5 -2.5 12.5 3.5 12 14.5 43 11 0 40 97
  var22 = 45
  Return
// uthrow; 21
label uthrow
  SetVarAttackData 1.5 -2.5 12.5 3.5 12 15 52 6 0 50 120
  var22 = 90
  Return
// nair; 22
label nair
  SetVarAttackData -6.96 4 7.67 7.99 28 1 43 4 0 10 190
  var22 = 361
  Return
// nair_weak; 23
label nair_weak
  SetVarAttackData -8 3.5 7.75 7.75 4 23 43 2 1 40 110
  var22 = 225
  Return
// fair; 24
label fair
  SetVarAttackData -7.9 15.57 15.5 19.72 15 4 35 13 0 60 50
  var22 = 80
  Return
// bair; 25
label bair
  SetVarAttackData -22.31 8.5 14.39 14.82 17 2 40 8 0 20 145
  var22 = 361
  Return
// uair; 26
label uair
  SetVarAttackData -9.25 0.25 9.25 9.25 10 0 38 10 0 32 110
  var22 = 70
  Return
// uair_spike; 27
label uair_spike
  SetVarAttackData -9.25 17 9.25 17.63 11 3 38 6 0 25 80
  var22 = 281
  Return
// uair_fall; 28
label uair_fall
  SetVarAttackData -8.5 58.25 8.25 25.63 15 13 38 6 0 25 80
  var22 = 270
  Return
// dair; 29
label dair
  SetVarAttackData -8.5 14.18 8.5 8.58 9 1 38 10 0 32 92
  var22 = 50
  Return
// dair_meteor; 30
label dair_meteor
  SetVarAttackData -3.5 7.34 3.5 3.5 8 0 38 7 0 50 149
  var22 = 270
  Return
endif
Return
...
//   {RECOVERY_ADDITIONS}
  ...
  var22 = 0
if  Equal var20 10 || Equal var20 12 || Equal var20 14 || Equal var20 16 || var20 >= 22 && var20 <= 30
    var22 = 1
  endif
...
if Equal var20 25
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 3 || Equal var20 5 || Equal var20 6 || Equal var20 9 || Equal var20 10 || Equal var20 11 || Equal var20 12 || Equal var20 15 || Equal var20 16 || Equal var20 17 || Equal var20 18 || Equal var20 19 || Equal var20 20 || Equal var20 21 || Equal var20 24
  var22 = 1
else
  var22 = 0
endif
  ...
  // chr get_moveDirY
if Equal var20 27 || Equal var20 28 || Equal var20 29 || Equal var20 30
  var22 = -1
elif Equal var20 9 || Equal var20 10 || Equal var20 11 || Equal var20 12
  var22 = 1
else
  var22 = 0
endif
