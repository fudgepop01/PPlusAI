...
if YDistBackEdge < 0
  ...
  if var3 < 80 && Equal var4 0 && Equal var16 0 && Equal var22 -1 
    var4 = 1
    Button B
    ClearStick
    AbsStick 0 (0.7)
  ...
  if var6 <= 0.75 && var3 < 80 && YDistBackEdge < 20 && Equal var4 0
    var4 = 1
    Button B
    ClearStick
    AbsStick 0 (0.7)
  ...
  if var3 > 70 && var3 < 80 && Equal var4 0
    var4 = 1
    Button B
    ClearStick
    AbsStick 0 (0.7)
...
label handleSSpecial
  ...
  var1 = var1 - (TopNY * -1)
    ...
    var2 = var0
    Abs var2
    if var9 < 0.55 && YDistBackEdge < -10 && YDistBackEdge > -45
...
label handleUSpecial
  ...
  if Equal CurrSubaction 476 || Equal CurrSubaction 475
    if !(NoOneHanging) && !(Equal var16 1)
      var1 -= 35
    endif
    var4 = var0
