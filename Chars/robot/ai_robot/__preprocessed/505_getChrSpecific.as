...
// jab123; 0
label jab123
  SetVarAttackData -0.73 -6.25 10.58 3.81 3 3 20 3 0 20 70
  var22 = 361
  Return
// jab123_2; 1
label jab123_2
  SetVarAttackData -0.82 -4.01 10.25 4.72 3 3 20 3 0 32 120
  var22 = 361
  Return
// dashattack; 2
label dashattack
  SetVarAttackData 9.01 1.16 13.56 6.06 7 7 35 8 0 41 81
  var22 = 50
  Return
// ftilt; 3
label ftilt
  SetVarAttackData 6.35 -4.99 11.07 4.16 7 2 34 8 0 30 100
  var22 = 361
  Return
// utilt; 4
label utilt
  SetVarAttackData -10.02 -3.28 10.01 16.79 4 4 26 5 0 55 120
  var22 = 90
  Return
// dtilt; 5
label dtilt
  SetVarAttackData 2.46 2.06 11.69 6.27 5 1 17 6 0 73 18
  var22 = 35
  Return
// fsmash; 6
label fsmash
  SetVarAttackData 5.08 -7.3 10.6 4.92 16 4 43 15 0 30 100
  var22 = 361
  Return
// usmash; 7
label usmash
  SetVarAttackData -7.48 -9.21 7.5 13.47 13 4 46 16 0 40 100
  var22 = 80
  Return
// dsmash; 8
label dsmash
  SetVarAttackData -15.5 -1.08 15.5 3.69 6 10 38 4 0 80 120
  var22 = 70
  Return
// uspecialair; 9
label uspecialair
  SetVarAttackData -17.338 1.96 17.374 29.523 10 10 4 0 0 0 0
  var22 = 0
  Return
// sspecial; 10
label sspecial
  SetVarAttackData -3.91 3.48 26.75 11.69 14 15 52 10 0 30 90
  var22 = 361
  Return
// sspecialair; 11
label sspecialair
  SetVarAttackData 32.594 34.152 28.315 21.145 10 10 4 0 0 0 0
  var22 = 0
  Return
// grab; 12
label grab
  SetVarAttackData 2.77 -3.83 6.1 4.22 7 0 32 0 0 0 0
  var22 = 0
  Return
// fthrow; 13
label fthrow
  SetVarAttackData 2.77 -3.83 6.1 4.22 7 9 35 10 0 60 65
  var22 = 45
  Return
// dthrow; 14
label dthrow
  SetVarAttackData 2.77 -3.83 6.1 4.22 7 28 69 1 0 56 213
  var22 = 80
  Return
// bthrow; 15
label bthrow
...
// uthrow; 16
label uthrow
  SetVarAttackData 2.77 -3.83 6.1 4.22 7 35.5 81 10 0 70 100
  var22 = 80
  Return
// nair; 17
label nair
  SetVarAttackData -17.3 9.41 17.36 17 15 14 46 14 0 50 90
  var22 = 80
  Return
// fair; 18
label fair
  SetVarAttackData 0.95 1.22 9.48 6.98 7 1 33 10 0 40 90
  var22 = 50
  Return
// fair_weak; 19
label fair_weak
  SetVarAttackData 0.84 1.22 9.53 7.36 7 12 33 6 0 30 60
  var22 = 361
  Return
// bair; 20
label bair
  SetVarAttackData -13.94 0.1 14.35 5.74 11 7 41 13 0 30 96
  var22 = 35
  Return
// uair; 21
label uair
  SetVarAttackData -16.76 -5.27 19.41 10.9 8 10 44 7 0 12 174
  var22 = 361
  Return
// dair; 22
label dair
  SetVarAttackData -6.97 8.99 7.16 9.89 13 4 38 11 0 40 100
  var22 = 280
  Return
endif
Return
...
//   {RECOVERY_ADDITIONS}
  ...
  var22 = 0
if  Equal var20 9 || Equal var20 11 || var20 >= 17 && var20 <= 22
    var22 = 1
  endif
...
if !(True)
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 3 || Equal var20 5 || Equal var20 6 || Equal var20 10 || Equal var20 11 || Equal var20 12 || Equal var20 13 || Equal var20 14 || Equal var20 15 || Equal var20 16 || Equal var20 18 || Equal var20 19
  var22 = 1
else
  var22 = 0
endif
  ...
  // chr get_moveDirY
if Equal var20 11 || Equal var20 22
  var22 = -1
elif Equal var20 7
  var22 = 1
else
    ...
    if !(True)
      label shuffle_AI
        ...
        if Rnd < var22
          ...
          ADJUST_PERSONALITY 0 3.5999999999999996 Rnd
          ADJUST_PERSONALITY 3 2.02 Rnd
          ADJUST_PERSONALITY 10 0.6 Rnd
