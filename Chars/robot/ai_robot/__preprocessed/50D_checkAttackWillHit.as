...
if  Equal var20 9 || Equal var20 11 || var20 >= 17 && var20 <= 22
  ...
  if OTopNY >= TopNY
    if YDistFloor < 2 && YDistFloor > 0
      ...
      var23 = TopNY + 39.01 //- var1
      var17 -= 19.505
      if var23 > var17 && NumJumps > 0 && OTopNY > TopNY
        var14 = var23 + 4
        // goalY += move_centerY
      elif var21 >= 16.7 && YDistBackEdge > 31.009999999999998
        var14 = var23 + 4
        // goalY += move_centerY
        var13 = TopNX
      endif
...
if  Equal var20 9 || Equal var20 11 || var20 >= 17 && var20 <= 22
  ...
  var23 = TopNX
if Equal var20 9 || Equal var20 11 || Equal var20 20
  elif True
...
if Equal var20 9 || Equal var20 11 || Equal var20 20 || Equal var20 22
  elif True
if  Equal var20 9 || Equal var20 11 || var20 >= 17 && var20 <= 22
