...
if !(Equal CurrSubaction JumpSquat)
  ...
  var2 = var5 //+ (XSpeed * (var13 + 5)) + TopNX
  // var17 -= TopNX
  // var2 -= TopNX
  Abs var17
  Abs var2
...
if Equal var16 3 && var20 < 24640
  ...
  if !(SamePlane) && var0 <= 15 && !(Equal CurrSubaction JumpSquat)
    Goto JumpIfInRange
  endif
...
label JumpIfInRange
  ...
  if var17 > 13 && var17 < 70 && Equal AirGroundState 1 && CurrAction <= 9
    Button X
  endif
  if var17 > 18 && var17 < 70 && Equal CurrSubaction JumpSquat
    Button X
  endif
