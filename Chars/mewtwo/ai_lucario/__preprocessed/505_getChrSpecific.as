...
if Equal var22 19.1
  if var20 >= 0 && var20 < 27
    ...
    if !(True)
      ...
      Return
      label _nair_multihitStr
      LOGSTR 1851877632 1918856448 1970041856 1768450304 1946157056
      Return
      label _fairStr
...
// hover; 0
label hover
  SetVarAttackData -50 50 100 75 10 30 4 0 0 0 0
  var22 = 0
  Return
// jab123; 1
label jab123
  SetVarAttackData 3.3 -5.29 6.78 5.1 8 1 17 6 1 35 100
  var22 = 83
  Return
// dashattack; 2
label dashattack
  SetVarAttackData 6.15 -3.82 11.44 4.68 10 4 37 9 0 80 60
  var22 = 80
  Return
// dashattack_weak; 3
label dashattack_weak
  SetVarAttackData 11.79 -3.76 13.15 4.75 15 14 37 6 0 40 60
  var22 = 80
  Return
// ftilt; 4
label ftilt
  SetVarAttackData 5.35 -2.93 6.89 4.71 6 2 28 8 0 10 100
  var22 = 361
  Return
// utilt; 5
label utilt
  SetVarAttackData -1.73 -0.72 10.93 7.9 6 0 27 8 0 25 134
  var22 = 85
  Return
// utilt_late; 6
label utilt_late
  SetVarAttackData -17.06 -0.72 19.16 17.31 7 6 27 8 0 25 134
  var22 = 78
  Return
// dtilt; 7
label dtilt
  SetVarAttackData 3.11 0.54 10.75 4.43 5 2 19 8 0 40 80
  var22 = 80
  Return
// fsmash; 8
label fsmash
  SetVarAttackData 19.43 -2.97 6 6 5 3 52 20 0 30 80
  var22 = 361
  Return
// fsmash_weak; 9
label fsmash_weak
  SetVarAttackData 6.27 -3.92 3.92 3.92 5 3 52 12 0 30 80
  var22 = 361
  Return
// usmash; 10
label usmash
  SetVarAttackData -13.53 -4.9 13.53 11.87 32 1 62 10 0 40 118
  var22 = 90
  Return
// dsmash; 11
label dsmash
...
// fthrow; 16
label fthrow
  SetVarAttackData 1.21 -2.92 6.63 6.16 7 38.5 97 8 0 70 80
  var22 = 45
  Return
// dthrow; 17
label dthrow
  SetVarAttackData 1.21 -2.92 6.63 6.16 7 15.5 51 6 0 65 50
  var22 = 69
  Return
// bthrow; 18
label bthrow
  SetVarAttackData 1.21 -2.92 6.63 6.16 7 17.5 51 11 0 70 80
  var22 = 135
  Return
// uthrow; 19
label uthrow
  SetVarAttackData 1.21 -2.92 6.63 6.16 7 24 71 12 0 100 67
  var22 = 90
  Return
// nair; 20
label nair
