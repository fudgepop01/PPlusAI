...
if  Equal var20 0 || Equal var20 13 || Equal var20 16 || var20 >= 22 && var20 <= 28
  ...
  if OTopNY >= TopNY
    if YDistFloor < 2 && YDistFloor > 0
      ...
      var23 = TopNY + 34.59 //- var1
      var17 -= 17.295
      if var23 > var17 && NumJumps > 0 && OTopNY > TopNY
        var14 = var23 + 4
        // goalY += move_centerY
      elif var21 >= 16.7 && YDistBackEdge > 26.590000000000003
        var14 = var23 + 4
        // goalY += move_centerY
        var13 = TopNX
      endif
...
if Equal var20 13 || Equal var20 16
elif Equal var20 0
  elif True
if  Equal var20 0 || Equal var20 13 || Equal var20 16 || var20 >= 22 && var20 <= 28
...
if  Equal var20 1 || var20 >= 4 && var20 <= 9 || var20 >= 11 && var20 <= 12 || Equal var20 14
    var23 = TopNX + 52 * OPos
    var22 = var17 - var23
    Abs var22
    ...
    if Equal CurrAction 3 && LevelValue >= 31
      ...
      var23 = TopNX + TotalXSpeed * (AnimFrame - 17 + 2)
      var22 = var17 - var23
      Abs var22
