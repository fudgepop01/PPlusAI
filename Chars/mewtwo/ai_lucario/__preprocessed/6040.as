...
if Equal var18 0
  ...
  var22 = 50 * OPos
  GetYDistFloorOffset var0 var22 5 0
  if var0 < 4 && !(Equal var0 -1)
    ...
    if Equal var0 0 && !(ODistLE 30) && ODistLE 100 && CanJump && !(Equal XDistBackEdge XDistFrontEdge) && Equal IsOnStage 1
      Call ChrSpecific4
    else 
      Call ApproachHub
    endif
...
if CalledAs NAir
  ...
  if Equal CurrAction 288
    ...
    if YDistBackEdge > -10
      if CalledAs NAir && Equal var19 1 && var4 <= 25
        AbsStick var5 (-1)
      elif CalledAs FAir && var4 <= 9
        AbsStick var5 (-1)
      elif CalledAs BAir && var4 <= 12
        AbsStick var5 (-1)
      elif CalledAs UAir && var4 <= 13
        AbsStick var5 (-1)
      elif CalledAs DAir && var4 <= 20
        AbsStick var5 (-1)
      endif
    endif
  endif
