...
if  Equal var20 18 || var20 >= 24 && var20 <= 31
  ...
  if OTopNY >= TopNY
    if Equal AirGroundState 1 || YDistFloor < 2 && YDistFloor > 0
      ...
      var23 = TopNY + 36.53 //- var1
      var17 -= 18.265
      if var23 > var17 && NumJumps > 0 && OTopNY > TopNY
        var14 = var23 + 4
        // goalY += move_centerY
      elif var21 >= 16.7 && YDistBackEdge > 28.53
        var14 = var23 + 4
        // goalY += move_centerY
        var13 = TopNX
      endif
...
// 2. where will defender be at end of frame
  if var16 < 0
    ...
    if OYDistBackEdge > 0
      GetYDistFloorAbsPos var22 var23 CenterY
      if var22 >= 0
        var23 = TopNX + DistToOEdge * OPos
      endif
    endif
    STACK_PUSH var23 0
...
STACK_PUSH 22 0
  ...
  var0 = STACK_POP
    ...
    if OYDistBackEdge > 0
      GetYDistFloorAbsPos var22 var22 CenterY
      if var22 >= 0
        var22 = TopNX + DistToOEdge * OPos
      endif
    endif
    STACK_PUSH var22 0
    Goto adjustPosIfInGround
...
if  var20 >= 0 && var20 <= 2 || var20 >= 4 && var20 <= 11 || var20 >= 13 && var20 <= 14 || var20 >= 16 && var20 <= 17
    var23 = TopNX + 35 * OPos
    var22 = var10 - var23
    Abs var22
    if var22 <= var4 && var11 <= var5 && var21 < 16.7 && LevelValue >= 60
      ...
      if Equal CurrAction 4 && var22 <= 0.6 && CHANCE_MUL_GE var22 1.35 
        ...
        if AnimFrame < 10 || Equal CurrAction 8 || Equal CurrAction 9 || !(Equal Direction OPos)
          var16 = 5
          var15 = -20
          CallI Wavedash 
        endif
    ...
    if Equal CurrAction 3 && LevelValue >= 31
      ...
      var23 = TopNX + CharXSpeed * (AnimFrame - 17)
      var22 = var10 - var23
      Abs var22
