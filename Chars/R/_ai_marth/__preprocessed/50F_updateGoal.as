...
var17 = var22
  ...
  if var22 <= 1 && OAnimFrame > var17
    ...
    if Equal var21 10.4
      Return
    elif Equal var21 10.5 && CHANCE_MUL_LE PT_BAITCHANCE 0.7
      Return
    else
      GetCommitPredictChance var22 LevelValue
      predictAverage var23 10 LevelValue
      var23 += 15
      if var22 > 0.65 && !(XDistLE var23) && Rnd < 0.5
        var21 = 10.4
    ...
    if !(Equal var21 10.2) && CHANCE_MUL_LE PT_BAITCHANCE 1 && Equal var3 0
      ...
      var22 += 100
      var23 = var22 - 70
      if XDistLE var22 && !(XDistLE var23) && CHANCE_MUL_LE PT_AGGRESSION 0.6
        if CHANCE_MUL_LE PT_BRAVECHANCE 0.75
          var21 = 10.1
          XGoto CalcAttackGoal
          XReciever
        ...
        GetCommitPredictChance var22 LevelValue
        if CHANCE_MUL_LE PT_BRAVECHANCE 0.75
          if CHANCE_MUL_LE PT_WALL_CHANCE 0.85 && var22 > 0.35
            var21 = 16.3
          else  
            var21 = 10.1
          endif
  ...
  if XDistLE var22 && !(Equal var1 -1)
    ...
    if Equal AirGroundState 1
      ...
      if CHANCE_MUL_GE PT_AGGRESSION 0.8
        var21 = 10.4
        if CHANCE_MUL_LE PT_BAIT_DASHAWAYCHANCE 0.5
          var21 = 10.5
        endif
      endif
