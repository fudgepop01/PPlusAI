...
if  Equal var20 11 || Equal var20 13 || Equal var20 15 || var20 >= 21 && var20 <= 27
  ...
  if OTopNY >= TopNY
    if Equal AirGroundState 1 || YDistFloor < 2 && YDistFloor > 0
      ...
      var23 = TopNY + 35.28 //- var1
      var17 -= 17.64
      if var23 > var17 && NumJumps > 0 && OTopNY > TopNY
        var14 = var23 + 4
        // goalY += move_centerY
      elif var21 >= 16.7 && YDistBackEdge > 27.28
        var14 = var23 + 4
        // goalY += move_centerY
        var13 = TopNX
      endif
...
if  Equal var20 11 || Equal var20 13 || Equal var20 15 || var20 >= 21 && var20 <= 27
  ...
  var23 = TopNX
if Equal var20 11 || Equal var20 14 || Equal var20 15
  elif True
...
if  Equal var20 0 || var20 >= 2 && var20 <= 5 || var20 >= 8 && var20 <= 10 || Equal var20 12
    var23 = TopNX + 25 * OPos
    var22 = var17 - var23
    Abs var22
