...
if Equal var2 2 && Equal var16 3
  ...
  if CanJump && YDistFrontEdge < -90
    ...
    var16 = 0
    Call AIHub
  elif CanJump && YDistFrontEdge > 90 || YDistFrontEdge > 25 && TopNY < var22
    var19 = 0
    var16 = 0
    Call RecoveryHub
  endif
...
if !(Equal var6 -9999.9999)
  ...
  // endif
  // var17 += OHurtboxSize
  // if MeteoChance && Equal IsOnStage 0 && YSpeed < 0.01 && var17 > 45 && var17 < 30
  //   Button X
  // endif
  if var17 > 7 && var17 < 80 && Equal AirGroundState 1 && CurrAction <= 9
    Button X
  endif
  if var17 > 20 && var17 < 80 && Equal CurrSubaction JumpSquat
    Button X
