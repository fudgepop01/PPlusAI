...
// jab123; 0
label jab123
  SetVarAttackData 5.44 -1.02 7.1 5.2 4 1 14 4 0 20 53
  var22 = 80
  Return
// dashattack; 1
label dashattack
  SetVarAttackData 22.13 2.1 7.77 11.07 11 4 39 9 0 35 100
  var22 = 106
  Return
// ftilt; 2
label ftilt
  SetVarAttackData 2 -0.5 10 6 7 3 31 6 0 25 150
  var22 = 50
  Return
// utilt; 3
label utilt
  SetVarAttackData -2.94 -0.02 7.72 13.37 6 4 26 10 0 30 105
  var22 = 85
  Return
// dtilt; 4
label dtilt
  SetVarAttackData 2.99 1.09 10.53 5.18 9 1 26 8 0 30 100
  var22 = 68
  Return
// fsmash; 5
label fsmash
  SetVarAttackData 0.68 0 19.56 5 11 6 48 15 0 45 86
  var22 = 361
  Return
// usmash; 6
label usmash
  SetVarAttackData -8.37 0.97 14.37 13.92 12 5 50 12 0 40 100
  var22 = 100
  Return
// usmash_late; 7
label usmash_late
  SetVarAttackData -23.36 0.61 12.18 13.74 18 7 50 11 0 25 100
  var22 = 40
  Return
// dsmash; 8
label dsmash
  SetVarAttackData 3.03 2.24 8.87 5.22 9 1 44 15 0 25 100
  var22 = 40
  Return
// dsmash_late; 9
label dsmash_late
  SetVarAttackData -18.24 2.25 8.5 5.35 15 1 44 13 0 25 100
  var22 = 40
  Return
// nspecial; 10
label nspecial
  SetVarAttackData 0 -2 200 20 20 10 40 -3 1 28 100
  var22 = 65
  Return
// nspecialair; 11
label nspecialair
  SetVarAttackData 0 -2 200 20 10 20 40 -3 1 28 100
  var22 = 65
  Return
// dspecial; 12
label dspecial
  SetVarAttackData -8 1.5 8 8 1 0 11 5 0 70 100
  var22 = 69
  Return
// dspecialair; 13
label dspecialair
...
// sspecial; 14
label sspecial
  SetVarAttackData 0 0 20 14 19 3 59 16 0 60 100
  var22 = 30
  Return
// sspecialair; 15
label sspecialair
...
// grab; 16
label grab
  SetVarAttackData 1.3 -1.5 6 4.5 7 0 32 0 0 0 0
  var22 = 0
  Return
// fthrow; 17
label fthrow
  SetVarAttackData 1.3 -1.5 6 4.5 7 10 30 2 0 54 135
  var22 = 45
  Return
// dthrow; 18
label dthrow
  SetVarAttackData 1.3 -1.5 6 4.5 7 25 48 3 0 70 50
  var22 = 55
  Return
// bthrow; 19
label bthrow
  SetVarAttackData 1.3 -1.5 6 4.5 7 21 43 5 0 70 58
  var22 = 120
  Return
// uthrow; 20
label uthrow
  SetVarAttackData 1.3 -1.5 6 4.5 7 16 44 2 0 70 110
  var22 = 77
  Return
// nair; 21
label nair
  SetVarAttackData -7.79 1.8 7.8 8.33 7 17 40 4 1 20 100
  var22 = 0
  Return
// fair; 22
label fair
  SetVarAttackData -0.91 1.35 8.97 7.32 11 3 29 15 0 25 100
  var22 = 70
  Return
// bair; 23
label bair
  SetVarAttackData -16.58 -1.86 8.84 4.86 7 3 28 14 0 22 102
  var22 = -361
  Return
// uair; 24
label uair
  SetVarAttackData -0.11 -3.93 8.18 5.5 7 0 29 11 0 20 100
  var22 = 57
  Return
// uair_late; 25
label uair_late
  SetVarAttackData -14.58 -0.49 15.41 12.97 8 3 29 11 0 20 100
  var22 = 50
  Return
// dair; 26
label dair
  SetVarAttackData -5.5 10.5 6 7.5 13 2 36 15 0 30 85
  var22 = 290
  Return
// dair_meteor; 27
label dair_meteor
  SetVarAttackData -5.5 10.5 6 7.5 13 2 36 14 0 15 100
  var22 = 270
  Return
endif
Return
...
//   {RECOVERY_ADDITIONS}
  ...
  var22 = 0
if  Equal var20 11 || Equal var20 13 || Equal var20 15 || var20 >= 21 && var20 <= 27
    var22 = 1
  endif
  ...
  // chr get_moveDir
if Equal var20 7 || Equal var20 9 || Equal var20 23
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 3 || Equal var20 4 || Equal var20 5 || Equal var20 6 || Equal var20 8 || Equal var20 10 || Equal var20 11 || Equal var20 14 || Equal var20 15 || Equal var20 16 || Equal var20 17 || Equal var20 18 || Equal var20 19 || Equal var20 20 || Equal var20 22 || Equal var20 24
  var22 = 1
else
  var22 = 0
endif
