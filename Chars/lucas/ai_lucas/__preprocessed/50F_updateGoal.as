...
var17 = var22
  ...
  if var22 <= 1 && OAnimFrame > var17
    ...
    var22 += 15
    if Equal var21 10 && ODistLE var22 && CHANCE_MUL_LE PT_AGGRESSION 0.9
    ...
    if !(Equal var21 10.2) && !(Equal var21 10.5) && !(Equal var21 10.6)
      ...
      var22 += 10
      var23 = var22 - 20
      if XDistLE var22 && !(XDistLE var23) && CHANCE_MUL_LE PT_AGGRESSION 0.85 && Equal var3 0
    ...
    elif CHANCE_MUL_LE PT_AGGRESSION 0.55 && Equal AirGroundState 1 && !(ODistLE var22)
      predictAverage var22 10 LevelValue
      var22 += 50
    ...
    if XDistLE var22 && !(Equal var1 -1)
      ...
      if Equal AirGroundState 1
        ...
        if CHANCE_MUL_GE PT_AGGRESSION 0.4
          var21 = 10.4
        endif
        ...
        if Equal var22 1
          ...
          var16 = 2
          if CHANCE_MUL_GE PT_AGGRESSION 0.95
            var16 = 3
          endif
          Goto getDist
  ...
  if var21 < 16.7
    ...
    LOGSTR 1212502528 1157627904 0 0 0
    LOGVAL AnimFrame
    PRINTLN
  ...
  if var21 < 16.7
    ...
    if OCurrAction >= 66 && OCurrAction <= 89 || OCurrAction >= 272
      ...
      if CHANCE_MUL_LE PT_BAITCHANCE 0.8
        var21 = 10.4 
      elif CHANCE_MUL_LE PT_CIRCLECAMPCHANCE 1.4
        var21 = 7
        if CHANCE_MUL_LE PT_AGGRESSION 0.05
          var21 = 7.1
        endif
      else
        var21 = 10.4
...
if Equal var21 16.4 || Equal var21 10.2
  ...
  if OCurrAction >= 74 && OCurrAction <= 101
    ...
    if CHANCE_MUL_LE PT_AGGRESSION 1
      var21 = 10.6
    elif CHANCE_MUL_GE PT_AGGRESSION 0.5
      var21 = 10.4
    endif
    var0 *= 3.5
    if XDistLE var0
