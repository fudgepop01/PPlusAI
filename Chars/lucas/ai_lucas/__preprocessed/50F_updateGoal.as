...
if var21 >= 7 && var21 < 8
  ...
  if var22 <= 13
    ...
    if Equal var22 1
      ...
      if Equal AirGroundState 1 && Rnd < 0.2
        ...
        if Rnd < 0.05 && Rnd < 0.05 && NumJumps > 0
          var9 += 23.514
        else
          var9 += 1
  ...
  if Equal var22 1
    ...
    if !(Equal var21 10.2) && !(Equal var21 10.5)
      ...
      var22 += 45
      var23 = var22 - 20
      if XDistLE var22 && !(XDistLE var23) && Rnd < 0.225 && Equal var3 0
        if Rnd < 0.425
          if Rnd < 0.3375
            var21 = 16.3
          else  
    ...
    if ODistLE var22 && !(Equal var1 -1)
      ...
      elif NumJumps > 0 && Rnd < 0.05 && Rnd < 0.05 && OYDistBackEdge > -20
        var16 = 1
        if Rnd < 0.5
          var16 = 3
        endif
...
LOGSTR 1684105472 1918857984 1885956864 1694498816 0
  ...
  // otherwise carry on as normal
    ...
    if OAnimFrame <= 9 || Equal CurrAction 10 || Equal OCurrAction 73 || OFramesHitstun > 1 || Equal HitboxConnected 1
      ...
      elif Equal var23 -1 && Rnd > 0.9 && Rnd > 0.9
        var21 = 10.5
        Return
      endif
...
var23 = var0 * 1.25
var22 += var23 + 10
if var0 >= 10 && ODistLE var22 && OFramesHitstun <= 0 && Rnd < 0.9
