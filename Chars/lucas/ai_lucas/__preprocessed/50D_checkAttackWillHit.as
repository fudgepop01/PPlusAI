...
if !(True) || Equal var20 17|| Equal var20 21|| Equal var20 27|| Equal var20 28|| Equal var20 29|| Equal var20 30|| Equal var20 31|| Equal var20 32
  ...
  if !(Equal var16 1)
if !(True)  || Equal var20 0 || Equal var20 1 || Equal var20 4 || Equal var20 5 || Equal var20 6 || Equal var20 7 || Equal var20 8 || Equal var20 9 || Equal var20 12 || Equal var20 13 || Equal var20 14 || Equal var20 15 || Equal var20 16 || Equal var20 18 || Equal var20 19
...
if !(True) || Equal var20 17|| Equal var20 21|| Equal var20 27|| Equal var20 28|| Equal var20 29|| Equal var20 30|| Equal var20 31|| Equal var20 32
  ...
  CalcYChange var18 var17 var22 Gravity MaxFallSpeed FastFallSpeed 1
      ...
      if var22 > 0
        ...
        Abs var17
        Abs var22
        if var17 <= var10 && var22 <= var9
          if !(Equal var16 1)
            var16 = 1
                LOGSTR_NL 1178686208 1413890304 1280049152 0 0
            CallI ExecuteAttack
            Finish
          else
            var16 = 1
        ...
        if Equal IsOnStage 1
          ...
          if var22 > 0
            ...
            if var17 <= var10 && var22 <= var9
              if !(Equal var16 1)
                var16 = -100
                LOGSTR_NL 1212240384 1145454848 1280049152 0 0
                CallI ExecuteAttack
              else
                var16 = -100
                LOGSTR_NL 1380275200 540016640 0 0 0
                Return
              endif
            endif
          endif
        ...
        if var22 > 15
          ...
          if var22 > 0
            ...
            if var17 <= var10 && var22 <= var9
              if !(Equal var16 1)
                var16 = -101
                LOGSTR_NL 1380537088 1229866752 0 0 0
                CallI ExecuteAttack
              else
                var16 = -101
                Return
...
if !(True) || Equal var20 17|| Equal var20 21|| Equal var20 27|| Equal var20 28|| Equal var20 29|| Equal var20 30|| Equal var20 31|| Equal var20 32
  ...
  EstYCoord var22 var6
          ...
          DrawDebugRectOutline TopNX -75.4 10 2 255 136 0 221
          if var22 >= -75.4 && Equal AirGroundState 2
            CallI ExecuteAttack
            Finish
          else
            var20 = -1
...
if LevelValue >= 48 && !(Equal var23 2) && Equal var22 0 && var21 < 16.7 && !(Equal var21 16.4)
  if ODistLE 45
