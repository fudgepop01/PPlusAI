...
if var21 >= 7 && var21 < 8
  ...
  if Equal var22 1
    ...
    if !(Equal var21 10.2) && !(Equal var21 10.5)
      ...
      var22 += 45
      var23 = var22 - 20
      if XDistLE var22 && !(XDistLE var23) && Rnd < 0.15 && Equal var3 0
        if Rnd < 0.325
          if Rnd < 0.3375
            var21 = 16.3
          else  
    ...
    if ODistLE var17 && Equal AirGroundState 1 && Equal var21 10.5
      if Rnd < 0.2975 || Rnd < 0.12249999999999998
        var15 = -1
        if Rnd < 0.175
          var16 = 2
          Call Wavedash
    ...
    elif ODistLE var17 && Rnd < 0.05 && Equal OAirGroundState 1 && Equal var1 1
...
LOGSTR 1684105472 1918856960 1970562304 1912602624 0
  ...
  // otherwise carry on as normal
    ...
    if OAnimFrame <= 9 || Equal CurrAction 10 || Equal OCurrAction 73 || OFramesHitstun > 1 || Equal HitboxConnected 1
      ...
      elif Equal var23 -1 && Rnd > 0.6 && Rnd > 0.6
        var21 = 10.5
        Return
      endif
...
var23 = var0 * 1.25
var22 += var23 + 10
if var0 >= 10 && ODistLE var22 && OFramesHitstun <= 0 && Rnd < 0.6
