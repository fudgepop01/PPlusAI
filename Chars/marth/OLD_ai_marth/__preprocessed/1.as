...
// elif OAttacking && Rnd < 0.6 && XDistLE 20
  ...
  if Equal CurrAction 10
    ...
    if Equal CurrAction 1 && !(Equal CurrAction 7)
      ...
      Goto _ddSubr
    elif AnimFrame >= 13 && Equal CurrAction 3
      Goto _ddSubr
...
if !(True)
  ...
  var17 = TopNY - var6
  // calculate Opponent change in 0.0.085 (used later)
  // if !(Equal OYSpeed 0) 
  ...
  if Equal var6 -9999.9999 
    ...
    if var17 <= var11 && var20 >= 24641 && var20 <= 25000 || XDistLE 15 && var20 >= 24641 && var20 <= 25000      
      if MeteoChance
        ...
        if !(Equal CurrSubaction JumpSquat) && var6 <= 70
          Button X
        elif var6 <= 70 && OAttacking
          Button X
        endif
        Goto JumpIfInRange
      else
    ...
    elif var6 <= 70 && OAttacking && OCurrActionFreq >= 3
      Button X
      Goto JumpIfInRange
    // elif Rnd < 0.3 && var6 <= 70 
    //   Button X
    //   Goto JumpIfInRange
    endif
...
if Equal var2 2 && Equal var16 3
  ...
  if CanJump && YDistFrontEdge < -85
    ...
    var16 = 0
    Call AIHub
  elif !CanJump && YDistFrontEdge < -66 && YSpeed < 0.1
    var19 = 0
    var16 = 0
    Call AIHub
  elif CanJump && YDistFrontEdge > 85 || YDistFrontEdge > 25 && TopNY < var22
    var19 = 0
    var16 = 0
    Call RecoveryHub
  endif
...
if !(Equal var6 -9999.9999)
  ...
  // endif
  // var17 += OHurtboxSize
  // if MeteoChance && Equal IsOnStage 0 && YSpeed < 0.01 && var17 > 15 && var17 < 35
  //   Button X
  // endif
  if var17 > 7 && var17 < 70 && Equal AirGroundState 1 && CurrAction <= 9
    Button X
  endif
  if var17 > 20 && var17 < 70 && Equal CurrSubaction JumpSquat
    Button X
  elif var17 > 7 && var17 < 70 && Equal CurrSubaction JumpSquat && OAttacking
    Button X
  endif
...
if var1 <= var17
  ...
  if var20 >= 24641 && var20 <= 24655 || Equal var3 1
    ...
    if Equal AirGroundState 1 && CurrAction <= 23
      ...
      var16 = 0
      Call AIHub
    elif !CanJump && Equal var2 2 && var4 < -66
      var19 = 0
      var16 = 0
      Call AIHub
