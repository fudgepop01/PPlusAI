...
if Equal var22 19.1
  if var20 >= 0 && var20 < 28
    ...
    if !(True)
      ...
      Return
      label _nspecial_fullStr
      LOGSTR 1853059072 1701013760 1634492160 1718971392 1811939328
      Return
...
// jab123; 0
label jab123
  SetVarAttackData 0.1 -6 10.05 4.3 3 1 17 3 0 0 100
  var22 = 361
  Return
// jab123_2; 1
label jab123_2
  SetVarAttackData 5.21 0.02 7.71 8.5 4 2 29 7 0 15 100
  var22 = 361
  Return
// dashattack; 2
label dashattack
  SetVarAttackData 6.32 -3.02 15.71 6.22 7 9 37 13 0 22 105
  var22 = 60
  Return
// ftilt; 3
label ftilt
  SetVarAttackData 5.03 -6.2 11.64 4.56 6 2 29 10 0 10 100
  var22 = 361
  Return
// utilt; 4
label utilt
  SetVarAttackData 0.92 4.09 11.87 16.09 14 3 34 12 0 40 100
  var22 = 361
  Return
// utilt_spike; 5
label utilt_spike
  SetVarAttackData 0.92 4.09 11.87 16.09 14 3 34 13 0 40 100
  var22 = 270
  Return
// dtilt; 6
label dtilt
  SetVarAttackData 5.03 4.48 8.66 6.03 6 2 41 14 0 80 60
  var22 = 100
  Return
// fsmash; 7
label fsmash
  SetVarAttackData 2.04 -5.78 10.02 4.77 10 3 43 14 0 30 104
  var22 = 361
  Return
// usmash; 8
label usmash
  SetVarAttackData -16.57 -7.91 17.79 12.03 13 18 51 6 0 45 145
  var22 = 83
  Return
// dsmash; 9
label dsmash
  SetVarAttackData -16.76 3.93 18.13 6.1 6 10 44 16 0 110 50
  var22 = 120
  Return
// nspecial; 10
label nspecial
  SetVarAttackData -2.972 -3.326 118.2 6 15 20 45 -8 0 20 50
  var22 = 361
  Return
// nspecial_full; 11
label nspecial_full
  SetVarAttackData -2.972 -3.326 118.2 6 15 20 45 -25 0 32 70
  var22 = 361
  Return
// nspecialair; 12
label nspecialair
...
// uspecial; 13
label uspecial
  SetVarAttackData -8.29 4.16 8.74 30.37 1 28 90 2 0 128 40
  var22 = 95
  Return
// dspecial; 14
label dspecial
  SetVarAttackData -7.38 4.292 7.38 10.186 11 14 54 -8 0 10 30
  var22 = 361
  Return
// dspecialair; 15
label dspecialair
  SetVarAttackData -7.38 37.764 7.38 25.99 11 14 54 -8 0 10 30
  var22 = 361
  Return
// sspecial; 16
label sspecial
  SetVarAttackData 8.554 -8.929 76.3 2.5 22 27 49 -15 0 40 110
  var22 = 80
  Return
// grab; 17
label grab
...
// dthrow; 19
label dthrow
  SetVarAttackData 2 -3.04 16 4 14 17 43 6 0 80 25
  var22 = 80
  Return
// bthrow; 20
label bthrow
  SetVarAttackData 2 -3.04 16 4 14 12.5 43 8 0 60 55
  var22 = 140
  Return
// uthrow; 21
label uthrow
  SetVarAttackData 2 -3.04 16 4 14 22 43 3 0 80 80
  var22 = 90
  Return
// nair; 22
label nair
    ...
    if !(True)
      label shuffle_AI
        ...
        if Rnd < var22
          ...
          ADJUST_PERSONALITY 0 2.25 Rnd
          ADJUST_PERSONALITY 3 3 Rnd
          ADJUST_PERSONALITY 10 1.4 Rnd
          ADJUST_PERSONALITY 4 0.6 Rnd
          ADJUST_PERSONALITY 5 1.8 Rnd
          if Rnd < 0.25
            ADJUST_PERSONALITY 1 -1 PT_BAIT_DASHAWAYCHANCE
            ADJUST_PERSONALITY 1 0.7 Rnd
          endif
          if Rnd < 0.25
          ...
          if Rnd < 0.25
            ...
            ADJUST_PERSONALITY 6 0.30000000000000004 Rnd
          endif
          if Rnd < 0.25
