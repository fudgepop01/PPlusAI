...
Goto PFC
  ...
  if Equal CurrAction 286
    ...
    CallI MainHub
  elif Equal AirGroundState 2 && var22 < 25 && Rnd < 0.5 && YDistFloor > 3
    ClearStick
    Button X
    AbsStick 0 (-1)
  else
...
label jab123_2
Goto PFC
  if Equal CurrSubaction 72 && AnimFrame >= 4 && Rnd <= 0.8
    Button A
  endif
Goto common_checks
Seek jab123_2
...
label PFC
  ...
  if !(Equal var21 7)
if  Equal var20 0 || var20 >= 20 && var20 <= 25
...
if Equal var20 16
  ...
  if Equal CurrAction 286 && Equal CurrSubaction 478
    Button X
    Seek finish
    Jump
