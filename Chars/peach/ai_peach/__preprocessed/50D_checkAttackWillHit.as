...
if  Equal var20 0 || Equal var20 12 || Equal var20 14 || var20 >= 20 && var20 <= 25
  ...
  if OTopNY >= TopNY
    if Equal AirGroundState 1 || YDistFloor < 2 && YDistFloor > 0
      ...
      var23 = TopNY + 33.00 //- var1
      var17 -= 16.5
      if var23 > var17 && NumJumps > 0 && OTopNY > TopNY
        var14 = var23 + 4
        // goalY += move_centerY
      elif var21 >= 16.7 && YDistBackEdge > 25
        var14 = var23 + 4
        // goalY += move_centerY
        var13 = TopNX
      endif
...
if  var20 >= 1 && var20 <= 2 || var20 >= 5 && var20 <= 8 || var20 >= 10 && var20 <= 11
    var23 = TopNX + 10 * OPos
    var22 = var17 - var23
    Abs var22
    if var22 <= var4 && var10 > var4 && var11 <= var5 && var21 < 16.7 && LevelValue >= 60
      ...
      if Equal CurrAction 4 && var22 <= 0.6 && CHANCE_MUL_GE var22 1.35 
        ...
        if AnimFrame < 5 || Equal CurrAction 8 || Equal CurrAction 9 || !(Equal Direction OPos)
          var16 = 5
          var15 = -20
          CallI Wavedash 
        endif
    ...
    if Equal CurrAction 3 && LevelValue >= 31
      ...
      var23 = TopNX + TotalXSpeed * (AnimFrame - 12 + 2)
      var22 = var17 - var23
      Abs var22
