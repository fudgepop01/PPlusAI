...
if Equal var22 19.1
  if var20 >= 0 && var20 < 26
    ...
    if !(True)
      label _hoverStr
      LOGSTR 1752135168 1701969920 0 0 0
      Return
      label _jab123Str
...
// hover; 0
label hover
  SetVarAttackData -50 50 100 50 10 30 4 0 0 0 0
  var22 = 0
  Return
// jab123; 1
label jab123
  SetVarAttackData 1.96 -5.07 7.79 4.16 2 1 15 3 1 20 100
  var22 = 78
  Return
// jab123_2; 2
label jab123_2
  SetVarAttackData 2.95 -5.44 8.06 3.99 2 1 16 2 0 30 100
  var22 = 361
  Return
// dashattack; 3
label dashattack
  SetVarAttackData 12.07 -4.29 7.22 4.69 6 2 35 9 0 50 70
  var22 = 361
  Return
// dashattack_late; 4
label dashattack_late
  SetVarAttackData 12.07 -4.29 12.64 4.69 6 14 35 7 0 20 70
  var22 = 361
  Return
// ftilt; 5
label ftilt
  SetVarAttackData -1.8 2.78 9.4 11.67 5 9 33 11 0 35 85
  var22 = 100
  Return
// utilt; 6
label utilt
  SetVarAttackData -8 -9.9 8 9.95 9 4 34 12 0 50 66
  var22 = 80
  Return
// dtilt; 7
label dtilt
  SetVarAttackData 1.94 3.14 7.95 6.61 12 1 25 12 0 60 100
  var22 = 270
  Return
// fsmash; 8
label fsmash
  SetVarAttackData -5 -2 12.5 16 15 5 40 13 0 50 60
  var22 = 29
  Return
// usmash; 9
label usmash
  SetVarAttackData -5.6 -11.54 5.02 7.01 14 9 47 15 0 40 100
  var22 = 90
  Return
// dsmash; 10
label dsmash
  SetVarAttackData -12.5 1.72 12.5 3.74 6 17 42 20 0 40 99
  var22 = 140
  Return
// dspecial; 11
label dspecial
  SetVarAttackData -4.52 3.22 4.11 4.25 2 2 23 0 0 0 0
  var22 = 0
  Return
// dspecialair; 12
label dspecialair
  SetVarAttackData -4.56 3.77 4.58 10.4 2 2 18 8 0 106 0
  var22 = 45
  Return
// sspecial; 13
label sspecial
  SetVarAttackData -4.77 2.38 17.77 8.08 33 2 52 16 0 25 83
  var22 = 32
  Return
// sspecialair; 14
label sspecialair
...
// grab; 15
label grab
  SetVarAttackData -1.33 -6.87 6.67 3.91 7 0 32 0 0 0 0
  var22 = 0
  Return
// fthrow; 16
label fthrow
  SetVarAttackData -1.33 -6.87 6.67 3.91 7 10.5 35 8 0 10 160
  var22 = 45
  Return
// dthrow; 17
label dthrow
  SetVarAttackData -1.33 -6.87 6.67 3.91 7 24.5 66 7 0 60 30
  var22 = 72
  Return
// bthrow; 18
label bthrow
  SetVarAttackData -1.33 -6.87 6.67 3.91 7 13.5 51 9 0 80 40
  var22 = 135
  Return
// uthrow; 19
label uthrow
  SetVarAttackData -1.33 -6.87 6.67 3.91 7 15.5 51 6 0 70 56
  var22 = 88
  Return
// nair; 20
label nair
  SetVarAttackData -5.1 -0.37 8.16 6.44 3 3 43 14 0 20 100
  var22 = 361
  Return
// nair_weak; 21
label nair_weak
  SetVarAttackData -5.1 -0.37 8.32 7.49 3 20 43 10 0 0 100
  var22 = 361
  Return
// fair; 22
label fair
  SetVarAttackData -3.96 3.32 9.09 9.89 16 4 53 16 0 60 70
  var22 = 361
  Return
// bair; 23
label bair
  SetVarAttackData -10.21 0.18 6.23 5.15 6 16 39 14 0 0 100
  var22 = 361
  Return
// uair; 24
label uair
  SetVarAttackData -2.14 -1.57 4.42 7.47 7 4 35 14 0 0 120
  var22 = 80
  Return
// dair; 25
label dair
  SetVarAttackData -3.69 8.28 6.59 7.54 12 19 37 6 0 16 50
  var22 = 90
  Return
endif
Return
...
//   {RECOVERY_ADDITIONS}
  ...
  var22 = 0
if  Equal var20 0 || Equal var20 12 || Equal var20 14 || var20 >= 20 && var20 <= 25
    var22 = 1
  endif
...
if Equal var20 23
  var22 = -1
elif Equal var20 0 || Equal var20 1 || Equal var20 2 || Equal var20 3 || Equal var20 4 || Equal var20 5 || Equal var20 7 || Equal var20 8 || Equal var20 13 || Equal var20 14 || Equal var20 15 || Equal var20 16 || Equal var20 17 || Equal var20 18 || Equal var20 19 || Equal var20 22
  var22 = 1
else
  var22 = 0
endif
  ...
  // chr get_moveDirY
if Equal var20 0 || Equal var20 25
  var22 = -1
elif !(True)
  var22 = 1
else
      ...
      label shuffle_AI
        ...
        if Rnd < var22
          ...
          if Rnd < 0.25
            ...
            ADJUST_PERSONALITY 1 0.3 Rnd
          endif
          if Rnd < 0.25
            ADJUST_PERSONALITY 2 -1 PT_BAIT_WDASHAWAYCHANCE
            ADJUST_PERSONALITY 2 1.5 Rnd
          endif
          if Rnd < 0.25
            ADJUST_PERSONALITY 7 -1 PT_JUMPINESS
            ADJUST_PERSONALITY 7 0.8999999999999999 Rnd
          endif
          if Rnd < 0.25
            ADJUST_PERSONALITY 6 -1 PT_DJUMPINESS
            ADJUST_PERSONALITY 6 0.24 Rnd
          endif
          if Rnd < 0.25
