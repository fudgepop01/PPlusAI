...
if var21 >= 7 && var21 < 8
  ...
  if var22 <= 13
    ...
    if Equal var22 1
      ...
      if Equal AirGroundState 1 && Rnd < 0.65
        var9 += 12 
        if Rnd < 0.65 && Rnd < 0.65
          var9 += 5
        endif
      elif Equal AirGroundState 2 && YDistBackEdge < -5
        if Rnd < 0.25 && Rnd < 0.25 && NumJumps > 0
          var9 += 28
        else
          var9 += 1
  ...
  if Equal var22 1
    ...
    if !(Equal var21 10.2) && !(Equal var21 10.5)
      ...
      if Equal var22 1 && Rnd < var23
        ...
        var22 = 1
        Return
      elif Equal var22 2 && Rnd < var23 && Rnd < 0.45
        var22 = 1
      else
        var22 = 0
      endif
      ...
      var22 += 45
      var23 = var22 - 20
      if XDistLE var22 && !(XDistLE var23) && Rnd < 0.175 && Equal var3 0
        if Rnd < 0.225
    ...
    if ODistLE var17 && Equal AirGroundState 1 && Equal var21 10.5
      if Rnd < 0.06999999999999999 || Rnd < 0.105
        var15 = -1
        if Rnd < 0.15
          var16 = 2
          Call Wavedash
    ...
    if ODistLE var22 && !(Equal var1 -1)
      ...
      if Equal AirGroundState 1
        ...
        if var17 > -40 && Rnd < 0.23
          Call BoardPlatform
        endif
      elif NumJumps > 0 && Rnd < 0.25 && Rnd < 0.25 && OYDistBackEdge > -20
        var16 = 1
        if Rnd < 0.5
          var16 = 3
        endif
    ...
    elif ODistLE var17 && Rnd < 0.65 && Equal OAirGroundState 1 && Equal var1 1
...
LOGSTR 1145137408 1912602624 0 0 0
  ...
  elif Equal var2 1 && Equal var1 0 && Rnd > 0.225 && Equal AirGroundState 1 && !(Equal var21 16.5)
    var21 = 10.5
    Return
  endif
  ...
  var22 += 30
  if !(ODistLE var22) && Rnd < 0.2 && Rnd < 0.2 && OFramesHitstun <= 0 && !(Equal var21 16.5)
    var21 = 7
    Return
  endif
  ...
  // otherwise carry on as normal
    ...
    if OAnimFrame <= 9 || Equal CurrAction 10 || Equal OCurrAction 73 || OFramesHitstun > 1 || Equal HitboxConnected 1
      ...
      elif Equal var23 -1 && Rnd > 0.7 && Rnd > 0.7
        var21 = 10.5
        Return
      endif
...
var23 = var0 * 1.25
var22 += var23 + 10
if var0 >= 10 && ODistLE var22 && OFramesHitstun <= 0 && Rnd < 0.7
