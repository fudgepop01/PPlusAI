...
if !(Equal var22 2) && !(CalledAs FastAerial) && Equal var21 16 && OFramesHitstun <= 0 && Equal var23 0
  ...
  var17 *= 2
  if !(Equal var22 3) && Rnd < var17 && Rnd < 0.6
    var21 = 16.3
  endif
endif

if var21 >= 16 && var21 <= 17
elif Equal var21 7.1 || Equal var21 10.1 || Equal var21 16.2
...
if YDistBackEdge < -45 || OYDistBackEdge < -20
var20 = 13
Goto dspecialair
Goto check_hub
var20 = 15
...
//   {SPACING_MOVES}
  ...
  if Rnd < 0.44999999999999996 && OYDistBackEdge > -30 && OFramesHitstun <= 0 && Equal HitboxConnected 0
    var21 = 16.3
  endif
elif Equal var7 10
var20 = 13
