...
if YDistFrontEdge > 11 && !(YDistFrontEdge > 16) && XDistFrontEdge <= 80 || YDistBackEdge > 11 && !(YDistBackEdge > 16) && XDistBackEdge <= 80
    AbsStick var15
    Button B
elif YDistFrontEdge > 40 && XDistFrontEdge <= 65 || YDistBackEdge > 40 && XDistBackEdge <= 65
    Stick 0 1
    Button B
    Seek _2
elif YDistFrontEdge > 15 && XDistFrontEdge > 65 && !(XDistFrontEdge >= 100) || YDistBackEdge > 15 && XDistBackEdge > 65 && !(XDistBackEdge >= 100)
    Stick 0 1
    Button B
    Seek _2
elif YDistFrontEdge > -5 && XDistFrontEdge > 100 || YDistBackEdge > -5 && XDistBackEdge > 100
    Stick 0 1
    Button B
    Seek _2
endif
