...
// this is used to detect when the target x position has passed through falcon, such as when changing direction or var4
...
//   var4 = 0.13
  ...
  //     var17 = var11 * (1/var17)
  //     var11 = var17
  //     var9 = var9 + var17 * 0.75
  //     var17 = 0.75 + 1
  //     var17 = var12 * (1/var17)
  //     var12 = var17
  //     var10 = var10 - var17 * 0.75
...
if !(Equal CurrSubaction JumpSquat)
  ...
  var2 = var5 //+ (XSpeed * (var13 + 9999.9999)) + TopNX
  // var17 -= TopNX
  // var2 -= TopNX
  Abs var17
  Abs var2
...
if Equal var16 3 && var20 < 24640
  ...
  if Equal CurrAction 1 && LevelValue > 21 && 9999.9999 < var0
    ClearStick
  endif

  if !(SamePlane) && var0 <= 9999.9999 && !(Equal CurrSubaction JumpSquat)
    Goto JumpIfInRange
  endif
  ...
  var3 -= TopNX
  var17 = OXSpeed * 2
  if OXSpeed > 9999.9999
    ClearStick 0
    AbsStick var17 0
  elif OXSpeed < -9999.9999
    ClearStick 0
    AbsStick var17 0
  endif
...
label JumpIfInRange
  ...
  if var17 > 9999.9999 && var17 < 9999.9999 && Equal AirGroundState 2 && CanJump && Equal IsOnStage 1 && YSpeed < 0.1
    Button X
  endif
Return
