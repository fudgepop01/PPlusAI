...
if Equal var22 19.1
  if var20 >= 0 && var20 < 27
    ...
    if !(True)
      ...
      Return
      label _usmash_hit2Str
      LOGSTR 1970498816 1634953216 1600678144 1949433856 0
      Return
      label _dsmashStr
...
// jab123; 0
label jab123
  SetVarAttackData -0.62 -8.11 8.38 4.46 3 2 18 8 0 30 100
  var22 = 361
  Return
// dashattack; 1
label dashattack
  SetVarAttackData 15.63 -3.14 7.92 5.86 7 2 37 15 0 60 80
  var22 = 105
  Return
// dashattack_late; 2
label dashattack_late
  SetVarAttackData 21.39 -3.14 9.92 5.86 10 8 37 10 0 45 60
  var22 = 100
  Return
// ftilt; 3
label ftilt
  SetVarAttackData 8.06 -6.03 10.42 5.22 9 2 29 13 0 20 100
  var22 = 40
  Return
// utilt; 4
label utilt
  SetVarAttackData 4.43 3.58 11.64 8 25 3 60 22 0 50 78
  var22 = 361
  Return
// dtilt; 5
label dtilt
  SetVarAttackData 4.53 0.86 12.09 4.68 9 2 32 12 0 30 100
  var22 = 70
  Return
// fsmash; 6
label fsmash
  SetVarAttackData 7.4 -3.18 10.79 5.56 21 5 60 22 0 40 90
  var22 = 65
  Return
// usmash; 7
label usmash
  SetVarAttackData -2.09 -9.89 7.54 11.55 22 2 45 22 0 50 80
  var22 = 80
  Return
// usmash_hit2; 8
label usmash_hit2
  SetVarAttackData -1.98 -10.69 6.49 11.58 27 3 45 19 0 40 80
  var22 = 80
  Return
// dsmash; 9
label dsmash
  SetVarAttackData 6.65 -3.46 8.65 6 20 3 47 8 0 115 0
  var22 = 160
  Return
// dsmash_hit2; 10
label dsmash_hit2
  SetVarAttackData -23.18 -6.81 12.56 4.87 30 3 47 14 0 60 110
  var22 = 120
  Return
// uspecial; 11
label uspecial
  SetVarAttackData -3.02 -4.38 11.2 35.99 10 23 63 10 0 40 115
  var22 = 361
  Return
// dspecial; 12
label dspecial
  SetVarAttackData 1.41 -2.7 31.43 5.49 14 20 41 17 0 60 76
  var22 = 361
  Return
// sspecial; 13
label sspecial
  SetVarAttackData 5.24 0.87 24.02 6.64 16 15 61 12 0 60 100
  var22 = 25
  Return
// grab; 14
label grab
  SetVarAttackData 0.05 -4.85 6.95 5.44 7 0 32 0 0 0 0
  var22 = 0
  Return
// fthrow; 15
label fthrow
  SetVarAttackData 0.05 -4.85 6.95 5.44 7 10.5 35 8 0 45 105
  var22 = 45
  Return
// dthrow; 16
label dthrow
  SetVarAttackData 0.05 -4.85 6.95 5.44 7 12.5 41 7 0 75 45
  var22 = 80
  Return
// bthrow; 17
label bthrow
  SetVarAttackData 0.05 -4.85 6.95 5.44 7 12 30 4 0 30 130
  var22 = 58
  Return
// uthrow; 18
label uthrow
  SetVarAttackData 0.05 -4.85 6.95 5.44 7 9 39 3 0 70 120
  var22 = 90
  Return
// nair; 19
label nair
  SetVarAttackData -1.56 -1.77 10.75 5.26 5 3 37 10 0 20 100
  var22 = 65
  Return
// nair_hit2; 20
label nair_hit2
  SetVarAttackData -3.75 -2.52 9.53 7.76 18 3 37 12 0 50 100
  var22 = 55
  Return
// fair; 21
label fair
  SetVarAttackData -2.04 5.77 11.88 15.03 14 5 34 17 0 60 80
  var22 = 361
  Return
// bair; 22
label bair
  SetVarAttackData -21.67 0.59 9.11 8.13 10 5 28 16 0 10 100
  var22 = -361
  Return
// uair; 23
label uair
  SetVarAttackData -6.57 -4.22 12.52 12.87 6 4 29 12 0 35 100
  var22 = 361
  Return
// uair_mid; 24
label uair_mid
  SetVarAttackData -19.48 -8.82 11.29 10.57 11 2 29 10 0 30 80
  var22 = 30
  Return
// uair_tipman; 25
label uair_tipman
  SetVarAttackData -19.57 2.77 8.96 10.81 14 2 29 6 0 20 70
  var22 = 360
  Return
// dair; 26
label dair
  SetVarAttackData -6.84 12.04 6.95 13.47 16 4 37 22 0 50 100
  var22 = 270
  Return
endif
Return
...
if  var20 >= 19 && var20 <= 26
  ...
  // chr get_moveDir
if Equal var20 10 || Equal var20 22 || Equal var20 24 || Equal var20 25
  var22 = -1
    ...
    if !(True)
      label shuffle_AI
        ...
        if Rnd < var22
          ...
          ADJUST_PERSONALITY 3 1.4 Rnd
          ADJUST_PERSONALITY 10 1.8 Rnd
