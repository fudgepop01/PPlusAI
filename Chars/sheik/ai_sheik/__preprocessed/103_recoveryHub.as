...
if Equal CanCancelAttack 1
  if {{Equal CurrAction 16} || {Equal CurrAction 276 || Equal CurrAction 297 || Equal CurrAction 299} || {Equal CurrAction 274 || Equal CurrAction 279 || Equal CurrAction 280} || {Equal CurrAction 275 || Equal CurrAction 297} || {Equal CurrAction 277 || Equal CurrAction 300}}
    Seek postMoveCheck
    Jump
  endif
endif
...
if YDistFloor > -1
  ...
  //   tolerence += 25
  // endif
  if YDistBackEdge < 35.52 && var2 <= 15 && NumJumps > 0
    Button X
    Goto handleJumpToStage
    Seek begin
    Return
  ...
  if var6 <= 0.4 && YDistBackEdge > 30 && Equal var4 0
    var4 = 1
    Button B
    ClearStick
    AbsStick 0 (0.7)
  ...
  var22 = 70 - 6 + HurtboxSize
  if var2 <= 73 && YDistBackEdge < var22 && YSpeed < 0 && Equal var4 0
    var4 = 1
    Button B
    ClearStick
    AbsStick 0 (0.7)
