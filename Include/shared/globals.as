...
#const chr_trait_NOT_IMPLEMENTED = -123456789
...
#const acat_none = hex(0x0)	
#const acat_idle_ground = hex(0x1)	
#const acat_idle_air = hex(0x2)	
#const acat_dash_run = hex(0x3)	
#const acat_tech_option = hex(0x4)	
#const acat_hurt = hex(0x5)	
#const acat_idle_ledge = hex(0x6)	
#const acat_ledge_option = hex(0x7)	
#const acat_ladder = hex(0x8)	
#const acat_stunned = hex(0x9)	
#const acat_idle_grabbing = hex(0xa)	
#const acat_throwing = hex(0xb)	
#const acat_water = hex(0xc)	
#const acat_wallcling = hex(0xd)	
#const acat_special_fall = hex(0xe)	
#const acat_using_dragoon = hex(0xf)	
#const acat_glide_control = hex(0x10)	
#const acat_warpstar_ride = hex(0x11)	
#const acat_attacking = hex(0x12)	
#const acat_smash_start = hex(0x13)	
#const acat_grabbing = hex(0x14)	
#const acat_shielding = hex(0x15)	
#const acat_jumpsquat = hex(0x16)	
#const acat_useless_caught = hex(0x17)	
#const acat_rolling = hex(0x18)
...
#const mainInitSkip = -10
#const sm_execAttack = -20
