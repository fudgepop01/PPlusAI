...
if FramesHitstun > 0 || FramesHitlag > 0
  ...
  if TechWindow > 1 && !(Equal techDir noTechDir) && Equal AirGroundState 2 && !(Equal DistBackEdge DistFrontEdge)
    AbsStick techDir
    TechWindow -= 1
    Return
  endif

  if FramesHitlag > 1 && LevelValue >= LV8
...
if CurrAction < hex(0xB) || hex(0x10) < CurrAction
