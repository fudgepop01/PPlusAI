...
if Equal chr_trait_select chr_cs_moveData || Equal chr_trait_select chr_cs_moveName
  ...
  if XDistLE 60 || OFramesHitstun > 0
    ...
    if {OCurrAction >= hex(0x42) && OCurrAction <= hex(0x59) && !(Equal OCurrAction hex(0x49))} || {Equal OCurrAction hex(0x49) && OYDistFloor > 15} || {Equal HitboxConnected 1 || Equal PrevAction hex(0x3C)}
    else
  ...
  // evt checkDefend
  {EVT_CHECK_DEFEND}
elif Equal chr_trait_select evt_itemCheck
  // evt checkDefend
  {EVT_ITEM_CHECK}
