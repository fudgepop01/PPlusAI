...
if {Equal HitboxConnected 0 && CHANCE_MUL_LE PT_AGGRESSION 0.2} || CHANCE_MUL_LE PT_AGGRESSION anotherTempVar
...
if Equal CanCancelAttack 1 || {HasCurry && Equal HitboxConnected 1} || {CurrAction >= hex(0x67) && CurrAction <= hex(0x6D)}
