...
if Equal CurrAction hex(0x1B) && Equal globTempVar 0 
  ...
  if globTempVar < 35 || timer >= patience || OEndLag > 8 || Rnd <= immediateTempVar || !(ODistLE 45)
    Seek pickOption
    Jump
...
immediateTempVar += 35
if Rnd < 0.4 && XDistLE immediateTempVar
  Button X
  Call FastAerial
...
if OEndLag > 24 && Rnd < 0.4
  scriptVariant = sv_wavedash_in
  CallI Wavedash
elif OEndLag > 18 && Rnd < 0.4
  scriptVariant = sv_wavedash_out
  CallI Wavedash
elif OEndLag > 6 && Rnd < 0.5 && Equal OPos Direction && ODistLE immediateTempVar
  Button A
  Call Grab
endif
