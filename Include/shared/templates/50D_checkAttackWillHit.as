...
$ifAerialAttack()
  ...
  immediateTempVar = move_yOffset + move_yRange * 2 
...
if LevelValue >= LV6 && !(Equal anotherTempVar op_baitdir_overshoot) && Equal immediateTempVar 0 && currGoal < cg_edgeguard && !(Equal currGoal cg_attack_reversal)
  if ODistLE 45
