...
if !(True)
  ...
  if Equal var8 0 || Equal var8 1
    ...
    var3 = var5 + (var5 - TopNX) * -1
    var4 = var6 + (var6 - TopNY) * -1
    DrawDebugLine var5 var6 var3 var4 0 0 255 136
  endif
...
Seek BEGIN_MAIN
ClearStick 1
// without this it will fastfall automatically, which we don't want
Stick 0 0.5
Return
